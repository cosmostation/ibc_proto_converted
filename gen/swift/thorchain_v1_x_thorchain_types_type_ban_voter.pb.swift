...
extension Types_BanVoter: @unchecked Sendable {}
...
extension Types_BanVoter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".BanVoter"
  ...
  static func ==(lhs: Types_BanVoter, rhs: Types_BanVoter) -> Bool {
