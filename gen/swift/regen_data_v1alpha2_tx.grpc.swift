...
extension Regen_Data_V1alpha2_MsgClientProtocol {
  ...
  internal func anchorData(
    ...
    return self.makeUnaryCall(
      path: Regen_Data_V1alpha2_MsgClientMetadata.Methods.anchorData.path,
      request: request,
  ...
  internal func signData(
    ...
    return self.makeUnaryCall(
      path: Regen_Data_V1alpha2_MsgClientMetadata.Methods.signData.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
extension Regen_Data_V1alpha2_MsgClient: @unchecked Sendable {}

@available(*, deprecated, renamed: "Regen_Data_V1alpha2_MsgNIOClient")
internal final class Regen_Data_V1alpha2_MsgClient: Regen_Data_V1alpha2_MsgClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  private var _interceptors: Regen_Data_V1alpha2_MsgClientInterceptorFactoryProtocol?
...
internal struct Regen_Data_V1alpha2_MsgNIOClient: Regen_Data_V1alpha2_MsgClientProtocol {
...
internal protocol Regen_Data_V1alpha2_MsgAsyncClientProtocol: GRPCClient {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Regen_Data_V1alpha2_MsgClientInterceptorFactoryProtocol? { get }

  func makeAnchorDataCall(
    _ request: Regen_Data_V1alpha2_MsgAnchorData,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Regen_Data_V1alpha2_MsgAnchorData, Regen_Data_V1alpha2_MsgAnchorDataResponse>

  func makeSignDataCall(
    _ request: Regen_Data_V1alpha2_MsgSignData,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Regen_Data_V1alpha2_MsgSignData, Regen_Data_V1alpha2_MsgSignDataResponse>
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Regen_Data_V1alpha2_MsgAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Regen_Data_V1alpha2_MsgClientMetadata.serviceDescriptor
  }
  ...
  internal func makeAnchorDataCall(
    _ request: Regen_Data_V1alpha2_MsgAnchorData,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Regen_Data_V1alpha2_MsgAnchorData, Regen_Data_V1alpha2_MsgAnchorDataResponse> {
  ...
  internal func makeSignDataCall(
    _ request: Regen_Data_V1alpha2_MsgSignData,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Regen_Data_V1alpha2_MsgSignData, Regen_Data_V1alpha2_MsgSignDataResponse> {
    return self.makeAsyncUnaryCall(
...
extension Regen_Data_V1alpha2_MsgAsyncClientProtocol {
  internal func anchorData(
    _ request: Regen_Data_V1alpha2_MsgAnchorData,
    callOptions: CallOptions? = nil
  ) async throws -> Regen_Data_V1alpha2_MsgAnchorDataResponse {
  ...
  internal func signData(
    _ request: Regen_Data_V1alpha2_MsgSignData,
    callOptions: CallOptions? = nil
  ) async throws -> Regen_Data_V1alpha2_MsgSignDataResponse {
    return try await self.performAsyncUnaryCall(
      path: Regen_Data_V1alpha2_MsgClientMetadata.Methods.signData.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Regen_Data_V1alpha2_MsgAsyncClient: Regen_Data_V1alpha2_MsgAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Regen_Data_V1alpha2_MsgClientInterceptorFactoryProtocol?
...
internal protocol Regen_Data_V1alpha2_MsgClientInterceptorFactoryProtocol: Sendable {
...
internal enum Regen_Data_V1alpha2_MsgClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Msg",
    fullName: "regen.data.v1alpha2.Msg",
    methods: [
      Regen_Data_V1alpha2_MsgClientMetadata.Methods.anchorData,
      Regen_Data_V1alpha2_MsgClientMetadata.Methods.signData,
    ]
  )

  internal enum Methods {
    internal static let anchorData = GRPCMethodDescriptor(
      name: "AnchorData",
      path: "/regen.data.v1alpha2.Msg/AnchorData",
      type: GRPCCallType.unary
    )

    internal static let signData = GRPCMethodDescriptor(
      name: "SignData",
...
extension Regen_Data_V1alpha2_MsgProvider {
  internal var serviceName: Substring {
    return Regen_Data_V1alpha2_MsgServerMetadata.serviceDescriptor.fullName[...]
  }
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Regen_Data_V1alpha2_MsgAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Regen_Data_V1alpha2_MsgServerInterceptorFactoryProtocol? { get }
  ...
  /// SignData should be used to create a digital signature attesting to the
  /// veracity of some piece of data.
  @Sendable func anchorData(
    request: Regen_Data_V1alpha2_MsgAnchorData,
  ...
  /// SignData can be called multiple times for the same content hash with different
  /// signers and those signers will be appended to the list of signers.
  @Sendable func signData(
    request: Regen_Data_V1alpha2_MsgSignData,
    context: GRPCAsyncServerCallContext
  ) async throws -> Regen_Data_V1alpha2_MsgSignDataResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Regen_Data_V1alpha2_MsgAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Regen_Data_V1alpha2_MsgServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Regen_Data_V1alpha2_MsgServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "AnchorData":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Regen_Data_V1alpha2_MsgAnchorDataResponse>(),
        interceptors: self.interceptors?.makeAnchorDataInterceptors() ?? [],
        wrapping: self.anchorData(request:context:)
      )
    ...
    case "SignData":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Regen_Data_V1alpha2_MsgSignDataResponse>(),
        interceptors: self.interceptors?.makeSignDataInterceptors() ?? [],
        wrapping: self.signData(request:context:)
      )
...
internal enum Regen_Data_V1alpha2_MsgServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Msg",
    fullName: "regen.data.v1alpha2.Msg",
    methods: [
      Regen_Data_V1alpha2_MsgServerMetadata.Methods.anchorData,
      Regen_Data_V1alpha2_MsgServerMetadata.Methods.signData,
    ]
  )
