...
from shentu.gov.v1alpha1 import query_pb2 as shentu_dot_gov_dot_v1alpha1_dot_query__pb2
...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Proposal = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Proposal',
        ...
        self.Proposals = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Proposals',
        ...
        self.Vote = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Vote',
        ...
        self.Votes = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Votes',
        ...
        self.Params = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Params',
                request_serializer=cosmos_dot_gov_dot_v1beta1_dot_query__pb2.QueryParamsRequest.SerializeToString,
                response_deserializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryParamsResponse.FromString,
                )
        self.Deposit = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Deposit',
        ...
        self.Deposits = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/Deposits',
        ...
        self.TallyResult = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/TallyResult',
        ...
        self.CertVoted = channel.unary_unary(
                '/shentu.gov.v1alpha1.Query/CertVoted',
                request_serializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedRequest.SerializeToString,
                response_deserializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedResponse.FromString,
                )
...
class QueryServicer(object):
    ...
    def CertVoted(self, request, context):
        """Proposal queries proposal details based on ProposalID.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Params': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryParamsResponse.SerializeToString,
            ),
            ...
            'CertVoted': grpc.unary_unary_rpc_method_handler(
                    servicer.CertVoted,
                    request_deserializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedRequest.FromString,
                    response_serializer=shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'shentu.gov.v1alpha1.Query', rpc_method_handlers)
...
class Query(object):
    ...
    def Proposal(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Proposal',
    ...
    def Proposals(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Proposals',
    ...
    def Vote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Vote',
    ...
    def Votes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Votes',
    ...
    def Params(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Params',
            cosmos_dot_gov_dot_v1beta1_dot_query__pb2.QueryParamsRequest.SerializeToString,
            shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryParamsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Deposit(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Deposit',
    ...
    def Deposits(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/Deposits',
    ...
    def TallyResult(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/TallyResult',
    ...
    def CertVoted(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/shentu.gov.v1alpha1.Query/CertVoted',
            shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedRequest.SerializeToString,
            shentu_dot_gov_dot_v1alpha1_dot_query__pb2.QueryCertVotedResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
