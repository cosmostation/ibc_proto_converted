...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CURRENCY'].fields_by_name['denom']._options = None
  _globals['_CURRENCY'].fields_by_name['denom']._serialized_options = b'\362\336\037\014yaml:\"denom\"'
  _globals['_CURRENCY'].fields_by_name['desc']._options = None
  _globals['_CURRENCY'].fields_by_name['desc']._serialized_options = b'\362\336\037\013yaml:\"desc\"'
  _globals['_CURRENCY'].fields_by_name['owner']._options = None
  _globals['_CURRENCY'].fields_by_name['owner']._serialized_options = b'\362\336\037\014yaml:\"owner\"'
  _globals['_CURRENCY'].fields_by_name['mintable']._options = None
  _globals['_CURRENCY'].fields_by_name['mintable']._serialized_options = b'\362\336\037\017yaml:\"mintable\"'
  _globals['_CURRENCIES'].fields_by_name['denoms']._options = None
  _globals['_CURRENCIES'].fields_by_name['denoms']._serialized_options = b'\362\336\037\ryaml:\"denoms\"'
  _globals['_MAXATOLOSUPPLY'].fields_by_name['amount']._options = None
  _globals['_MAXATOLOSUPPLY'].fields_by_name['amount']._serialized_options = b'\362\336\037\ryaml:\"amount\"'
  _globals['_SEQUENCE'].fields_by_name['number']._options = None
  _globals['_SEQUENCE'].fields_by_name['number']._serialized_options = b'\362\336\037\ryaml:\"number\"'
