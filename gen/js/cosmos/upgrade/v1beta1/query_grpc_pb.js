...
function serialize_cosmos_upgrade_v1beta1_QueryAuthorityRequest(arg) {
  if (!(arg instanceof cosmos_upgrade_v1beta1_query_pb.QueryAuthorityRequest)) {
    throw new Error('Expected argument of type cosmos.upgrade.v1beta1.QueryAuthorityRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_upgrade_v1beta1_QueryAuthorityRequest(buffer_arg) {
  return cosmos_upgrade_v1beta1_query_pb.QueryAuthorityRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_upgrade_v1beta1_QueryAuthorityResponse(arg) {
  if (!(arg instanceof cosmos_upgrade_v1beta1_query_pb.QueryAuthorityResponse)) {
    throw new Error('Expected argument of type cosmos.upgrade.v1beta1.QueryAuthorityResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_upgrade_v1beta1_QueryAuthorityResponse(buffer_arg) {
  return cosmos_upgrade_v1beta1_query_pb.QueryAuthorityResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest(arg) {
  if (!(arg instanceof cosmos_upgrade_v1beta1_query_pb.QueryModuleVersionsRequest)) {
    throw new Error('Expected argument of type cosmos.upgrade.v1beta1.QueryModuleVersionsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest(buffer_arg) {
  return cosmos_upgrade_v1beta1_query_pb.QueryModuleVersionsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_upgrade_v1beta1_QueryModuleVersionsResponse(arg) {
  if (!(arg instanceof cosmos_upgrade_v1beta1_query_pb.QueryModuleVersionsResponse)) {
    throw new Error('Expected argument of type cosmos.upgrade.v1beta1.QueryModuleVersionsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_upgrade_v1beta1_QueryModuleVersionsResponse(buffer_arg) {
  return cosmos_upgrade_v1beta1_query_pb.QueryModuleVersionsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
moduleVersions: {
    ...
    requestSerialize: serialize_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest,
    requestDeserialize: deserialize_cosmos_upgrade_v1beta1_QueryModuleVersionsRequest,
    responseSerialize: serialize_cosmos_upgrade_v1beta1_QueryModuleVersionsResponse,
    responseDeserialize: deserialize_cosmos_upgrade_v1beta1_QueryModuleVersionsResponse,
  },
...
authority: {
    ...
    requestSerialize: serialize_cosmos_upgrade_v1beta1_QueryAuthorityRequest,
    requestDeserialize: deserialize_cosmos_upgrade_v1beta1_QueryAuthorityRequest,
    responseSerialize: serialize_cosmos_upgrade_v1beta1_QueryAuthorityResponse,
    responseDeserialize: deserialize_cosmos_upgrade_v1beta1_QueryAuthorityResponse,
  },
};
