...
goog.provide('proto.cosmos.auth.v1beta1.QueryParamsResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.auth.v1beta1.Params');
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && proto.cosmos.auth.v1beta1.Params.toObject(includeInstance, f)
  };
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.auth.v1beta1.Params;
      reader.readMessage(value,proto.cosmos.auth.v1beta1.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    default:
      reader.skipField();
...
proto.cosmos.auth.v1beta1.QueryParamsResponse.prototype.getParams = function() {
  return /** @type{?proto.cosmos.auth.v1beta1.Params} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.auth.v1beta1.Params, 1));
};
