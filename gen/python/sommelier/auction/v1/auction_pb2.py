...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\016com.auction.v1B\014AuctionProtoP\001Z/github.com/peggyjv/sommelier/v4/x/auction/types\242\002\003AXX\252\002\nAuction.V1\312\002\nAuction\\V1\342\002\026Auction\\V1\\GPBMetadata\352\002\013Auction::V1'
  _AUCTION.fields_by_name['starting_tokens_for_sale']._options = None
  _AUCTION.fields_by_name['starting_tokens_for_sale']._serialized_options = b'\310\336\037\000'
  _AUCTION.fields_by_name['initial_price_decrease_rate']._options = None
  _AUCTION.fields_by_name['initial_price_decrease_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _AUCTION.fields_by_name['current_price_decrease_rate']._options = None
  _AUCTION.fields_by_name['current_price_decrease_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _AUCTION.fields_by_name['initial_unit_price_in_usomm']._options = None
  _AUCTION.fields_by_name['initial_unit_price_in_usomm']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _AUCTION.fields_by_name['current_unit_price_in_usomm']._options = None
  _AUCTION.fields_by_name['current_unit_price_in_usomm']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _AUCTION.fields_by_name['remaining_tokens_for_sale']._options = None
  _AUCTION.fields_by_name['remaining_tokens_for_sale']._serialized_options = b'\310\336\037\000'
  _BID.fields_by_name['max_bid_in_usomm']._options = None
  _BID.fields_by_name['max_bid_in_usomm']._serialized_options = b'\310\336\037\000'
  _BID.fields_by_name['sale_token_minimum_amount']._options = None
  _BID.fields_by_name['sale_token_minimum_amount']._serialized_options = b'\310\336\037\000'
  _BID.fields_by_name['total_fulfilled_sale_tokens']._options = None
  _BID.fields_by_name['total_fulfilled_sale_tokens']._serialized_options = b'\310\336\037\000'
  _BID.fields_by_name['sale_token_unit_price_in_usomm']._options = None
  _BID.fields_by_name['sale_token_unit_price_in_usomm']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _BID.fields_by_name['total_usomm_paid']._options = None
  _BID.fields_by_name['total_usomm_paid']._serialized_options = b'\310\336\037\000'
  _TOKENPRICE.fields_by_name['usd_price']._options = None
  _TOKENPRICE.fields_by_name['usd_price']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _PROPOSEDTOKENPRICE.fields_by_name['usd_price']._options = None
  _PROPOSEDTOKENPRICE.fields_by_name['usd_price']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
