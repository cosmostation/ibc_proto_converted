...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.kyve.pool.v1beta1.GenesisProto.internal_static_kyve_pool_v1beta1_GenesisState_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.kyve.pool.v1beta1.GenesisState.class, com.kyve.pool.v1beta1.GenesisState.Builder.class);
  }

  public static final int POOL_LIST_FIELD_NUMBER = 2;
  @SuppressWarnings("serial")
  private java.util.List<com.kyve.pool.v1beta1.Pool> poolList_;
  /**
   * <pre>
   * pool_list ...
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.kyve.pool.v1beta1.Pool> getPoolListList() {
    return poolList_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.kyve.pool.v1beta1.PoolOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.kyve.pool.v1beta1.Pool getPoolList(int index) {
   ...
   */
  @java.lang.Override
  public com.kyve.pool.v1beta1.PoolOrBuilder getPoolListOrBuilder(
      int index) {
    return poolList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.kyve.pool.v1beta1.GenesisState)) {
      return super.equals(obj);
    }
    com.kyve.pool.v1beta1.GenesisState other = (com.kyve.pool.v1beta1.GenesisState) obj;
  ...
  public static com.kyve.pool.v1beta1.GenesisState parseFrom(
  ...
  public static com.kyve.pool.v1beta1.GenesisState parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.kyve.pool.v1beta1.GenesisState parseFrom(
  ...
  public static com.kyve.pool.v1beta1.GenesisState parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.kyve.pool.v1beta1.GenesisState parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.kyve.pool.v1beta1.GenesisState parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.kyve.pool.v1beta1.GenesisState prototype) {
  ...
  public static final class Builder extends
      ...
      com.kyve.pool.v1beta1.GenesisStateOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.kyve.pool.v1beta1.GenesisProto.internal_static_kyve_pool_v1beta1_GenesisState_descriptor;
    }
    ...
    // Construct using com.kyve.pool.v1beta1.GenesisState.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.kyve.pool.v1beta1.GenesisState getDefaultInstanceForType() {
      return com.kyve.pool.v1beta1.GenesisState.getDefaultInstance();
    }

    @java.lang.Override
    public com.kyve.pool.v1beta1.GenesisState build() {
      com.kyve.pool.v1beta1.GenesisState result = buildPartial();
    ...
    @java.lang.Override
    public com.kyve.pool.v1beta1.GenesisState buildPartial() {
      com.kyve.pool.v1beta1.GenesisState result = new com.kyve.pool.v1beta1.GenesisState(this);
    ...
    private void buildPartialRepeatedFields(com.kyve.pool.v1beta1.GenesisState result) {
      if (poolListBuilder_ == null) {
    ...
    private void buildPartial0(com.kyve.pool.v1beta1.GenesisState result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.kyve.pool.v1beta1.GenesisState) {
        return mergeFrom((com.kyve.pool.v1beta1.GenesisState)other);
      } else {
    ...
    public Builder mergeFrom(com.kyve.pool.v1beta1.GenesisState other) {
      if (other == com.kyve.pool.v1beta1.GenesisState.getDefaultInstance()) return this;
      if (poolListBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 18: {
              com.kyve.pool.v1beta1.Pool m =
                  input.readMessage(
                      com.kyve.pool.v1beta1.Pool.parser(),
                      extensionRegistry);
              if (poolListBuilder_ == null) {
                ensurePoolListIsMutable();
                poolList_.add(m);
    ...
    private void ensurePoolListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        poolList_ = new java.util.ArrayList<com.kyve.pool.v1beta1.Pool>(poolList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.kyve.pool.v1beta1.Pool, com.kyve.pool.v1beta1.Pool.Builder, com.kyve.pool.v1beta1.PoolOrBuilder> poolListBuilder_;
    ...
    public Builder setPoolList(
        int index, com.kyve.pool.v1beta1.Pool value) {
      if (poolListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setPoolList(
        int index, com.kyve.pool.v1beta1.Pool.Builder builderForValue) {
      if (poolListBuilder_ == null) {
        ensurePoolListIsMutable();
     ...
     * <code>repeated .kyve.pool.v1beta1.Pool pool_list = 2 [json_name = "poolList", (.gogoproto.nullable) = false];</code>
     */
    public Builder addPoolList(com.kyve.pool.v1beta1.Pool value) {
      if (poolListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllPoolList(
        java.lang.Iterable<? extends com.kyve.pool.v1beta1.Pool> values) {
      if (poolListBuilder_ == null) {
        ensurePoolListIsMutable();
     ...
     * <code>repeated .kyve.pool.v1beta1.Pool pool_list = 2 [json_name = "poolList", (.gogoproto.nullable) = false];</code>
     */
    public com.kyve.pool.v1beta1.Pool.Builder getPoolListBuilder(
        int index) {
     ...
     * <code>repeated .kyve.pool.v1beta1.Pool pool_list = 2 [json_name = "poolList", (.gogoproto.nullable) = false];</code>
     */
    public com.kyve.pool.v1beta1.Pool.Builder addPoolListBuilder() {
      return getPoolListFieldBuilder().addBuilder(
          com.kyve.pool.v1beta1.Pool.getDefaultInstance());
    }
    /**
     * <pre>
     * pool_list ...
    ...
    public com.kyve.pool.v1beta1.Pool.Builder addPoolListBuilder(
        int index) {
      return getPoolListFieldBuilder().addBuilder(
          index, com.kyve.pool.v1beta1.Pool.getDefaultInstance());
    }
    /**
     * <pre>
     * pool_list ...
     ...
     * <code>repeated .kyve.pool.v1beta1.Pool pool_list = 2 [json_name = "poolList", (.gogoproto.nullable) = false];</code>
     */
    public java.util.List<com.kyve.pool.v1beta1.Pool.Builder> 
  ...
  private static final com.kyve.pool.v1beta1.GenesisState DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.kyve.pool.v1beta1.GenesisState();
  }

  public static com.kyve.pool.v1beta1.GenesisState getDefaultInstance() {
