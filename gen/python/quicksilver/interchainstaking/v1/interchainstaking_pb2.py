...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n$com.quicksilver.interchainstaking.v1B\026InterchainstakingProtoZ@github.com/ingenuity-build/quicksilver/x/interchainstaking/types\242\002\003QIX\252\002 Quicksilver.Interchainstaking.V1\312\002 Quicksilver\\Interchainstaking\\V1\342\002,Quicksilver\\Interchainstaking\\V1\\GPBMetadata\352\002\"Quicksilver::Interchainstaking::V1'
  _globals['_ZONE'].fields_by_name['redemption_rate']._options = None
  _globals['_ZONE'].fields_by_name['redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_ZONE'].fields_by_name['last_redemption_rate']._options = None
  _globals['_ZONE'].fields_by_name['last_redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_ZONE'].fields_by_name['aggregate_intent']._options = None
  _globals['_ZONE'].fields_by_name['aggregate_intent']._serialized_options = b'\252\337\037\020ValidatorIntents'
  _globals['_ZONE'].fields_by_name['tvl']._options = None
  _globals['_ZONE'].fields_by_name['tvl']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  ...
  _globals['_ICAACCOUNT'].fields_by_name['balance']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_WITHDRAWALRECORD'].fields_by_name['delegator']._options = None
  _globals['_WITHDRAWALRECORD'].fields_by_name['delegator']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_WITHDRAWALRECORD'].fields_by_name['recipient']._options = None
  _globals['_WITHDRAWALRECORD'].fields_by_name['recipient']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_WITHDRAWALRECORD'].fields_by_name['amount']._options = None
  _globals['_WITHDRAWALRECORD'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_WITHDRAWALRECORD'].fields_by_name['burn_amount']._options = None
  _globals['_WITHDRAWALRECORD'].fields_by_name['burn_amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin\322\264-\013cosmos.Coin'
  _globals['_WITHDRAWALRECORD'].fields_by_name['completion_time']._options = None
  _globals['_WITHDRAWALRECORD'].fields_by_name['completion_time']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_UNBONDINGRECORD'].fields_by_name['validator']._options = None
  _globals['_UNBONDINGRECORD'].fields_by_name['validator']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_REDELEGATIONRECORD'].fields_by_name['source']._options = None
  _globals['_REDELEGATIONRECORD'].fields_by_name['source']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_REDELEGATIONRECORD'].fields_by_name['destination']._options = None
  _globals['_REDELEGATIONRECORD'].fields_by_name['destination']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_REDELEGATIONRECORD'].fields_by_name['completion_time']._options = None
  _globals['_REDELEGATIONRECORD'].fields_by_name['completion_time']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_TRANSFERRECORD'].fields_by_name['sender']._options = None
  _globals['_TRANSFERRECORD'].fields_by_name['sender']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_TRANSFERRECORD'].fields_by_name['recipient']._options = None
  _globals['_TRANSFERRECORD'].fields_by_name['recipient']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_TRANSFERRECORD'].fields_by_name['amount']._options = None
  _globals['_TRANSFERRECORD'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin\322\264-\013cosmos.Coin'
  _globals['_VALIDATOR'].fields_by_name['valoper_address']._options = None
  _globals['_VALIDATOR'].fields_by_name['valoper_address']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_VALIDATOR'].fields_by_name['commission_rate']._options = None
  _globals['_VALIDATOR'].fields_by_name['commission_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  ...
  _globals['_VALIDATOR'].fields_by_name['voting_power']._options = None
  _globals['_VALIDATOR'].fields_by_name['voting_power']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int\322\264-\ncosmos.Int'
  _globals['_VALIDATOR'].fields_by_name['score']._options = None
  _globals['_VALIDATOR'].fields_by_name['score']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_VALIDATOR'].fields_by_name['jailed_since']._options = None
  _globals['_VALIDATOR'].fields_by_name['jailed_since']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_DELEGATORINTENT'].fields_by_name['delegator']._options = None
  _globals['_DELEGATORINTENT'].fields_by_name['delegator']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_DELEGATORINTENT'].fields_by_name['intents']._options = None
  _globals['_DELEGATORINTENT'].fields_by_name['intents']._serialized_options = b'\252\337\037\020ValidatorIntents'
  _globals['_VALIDATORINTENT'].fields_by_name['valoper_address']._options = None
  _globals['_VALIDATORINTENT'].fields_by_name['valoper_address']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_VALIDATORINTENT'].fields_by_name['weight']._options = None
  _globals['_VALIDATORINTENT'].fields_by_name['weight']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\362\336\037\ryaml:\"weight\"\322\264-\ncosmos.Dec'
  _globals['_DELEGATION'].fields_by_name['delegation_address']._options = None
  _globals['_DELEGATION'].fields_by_name['delegation_address']._serialized_options = b'\322\264-\024cosmos.AddressString'
  ...
  _globals['_DELEGATION'].fields_by_name['amount']._options = None
  _globals['_DELEGATION'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin\322\264-\013cosmos.Coin'
  _globals['_RECEIPT'].fields_by_name['sender']._options = None
  _globals['_RECEIPT'].fields_by_name['sender']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_RECEIPT'].fields_by_name['amount']._options = None
  _globals['_RECEIPT'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_RECEIPT'].fields_by_name['first_seen']._options = None
  _globals['_RECEIPT'].fields_by_name['first_seen']._serialized_options = b'\310\336\037\001\220\337\037\001'
  _globals['_RECEIPT'].fields_by_name['completed']._options = None
  _globals['_RECEIPT'].fields_by_name['completed']._serialized_options = b'\310\336\037\001\220\337\037\001'
