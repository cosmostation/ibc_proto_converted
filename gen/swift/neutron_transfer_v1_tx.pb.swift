...
struct Neutron_Transfer_MsgUpdateParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Neutron_Transfer_MsgUpdateParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Neutron_Transfer_MsgUpdateParams: @unchecked Sendable {}
extension Neutron_Transfer_MsgUpdateParamsResponse: @unchecked Sendable {}
...
extension Neutron_Transfer_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Neutron_Transfer_MsgUpdateParams, rhs: Neutron_Transfer_MsgUpdateParams) -> Bool {
...
extension Neutron_Transfer_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Neutron_Transfer_MsgUpdateParamsResponse, rhs: Neutron_Transfer_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
