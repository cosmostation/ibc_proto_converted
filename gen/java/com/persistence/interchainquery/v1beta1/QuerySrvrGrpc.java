...
public final class QuerySrvrGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest,
      com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> getQueriesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Queries",
      requestType = com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest.class,
      responseType = com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest,
      com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> getQueriesMethod() {
    io.grpc.MethodDescriptor<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest, com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> getQueriesMethod;
      ...
      synchronized (QuerySrvrGrpc.class) {
        if ((getQueriesMethod = QuerySrvrGrpc.getQueriesMethod) == null) {
          QuerySrvrGrpc.getQueriesMethod = getQueriesMethod =
              io.grpc.MethodDescriptor.<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest, com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Queries"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void queries(com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest request,
        io.grpc.stub.StreamObserver<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> responseObserver) {
  ...
  public static final class QuerySrvrStub
     ...
     * </pre>
     */
    public void queries(com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest request,
        io.grpc.stub.StreamObserver<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> responseObserver) {
  ...
  public static final class QuerySrvrBlockingStub
     ...
     * </pre>
     */
    public com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse queries(com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest request) {
  ...
  public static final class QuerySrvrFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse> queries(
        com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERIES:
          serviceImpl.queries((com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest) request,
              (io.grpc.stub.StreamObserver<com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsRequest,
              com.persistence.interchainquery.v1beta1.QueryProto.QueryRequestsResponse>(
  ...
  private static abstract class QuerySrvrBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.persistence.interchainquery.v1beta1.QueryProto.getDescriptor();
    }
