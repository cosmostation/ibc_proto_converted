...
goog.provide('proto.irismod.service.QueryResponseResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.irismod.service.Response');
...
proto.irismod.service.QueryResponseResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    response: (f = msg.getResponse()) && proto.irismod.service.Response.toObject(includeInstance, f)
  };
...
proto.irismod.service.QueryResponseResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.irismod.service.Response;
      reader.readMessage(value,proto.irismod.service.Response.deserializeBinaryFromReader);
...
proto.irismod.service.QueryResponseResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.irismod.service.Response.serializeBinaryToWriter
    );
  }
};
...
proto.irismod.service.QueryResponseResponse.prototype.getResponse = function() {
  return /** @type{?proto.irismod.service.Response} */ (
    jspb.Message.getWrapperField(this, proto.irismod.service.Response, 1));
};
