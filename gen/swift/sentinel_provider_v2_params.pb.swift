...
struct Sentinel_Provider_V2_Params {
...
extension Sentinel_Provider_V2_Params: @unchecked Sendable {}
...
extension Sentinel_Provider_V2_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Params"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "deposit"),
    2: .standard(proto: "revenue_share"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.revenueShare) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.revenueShare.isEmpty {
      try visitor.visitSingularStringField(value: self.revenueShare, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Sentinel_Provider_V2_Params, rhs: Sentinel_Provider_V2_Params) -> Bool {
