...
extension Types_MsgRagnarok: @unchecked Sendable {}
...
extension Types_MsgRagnarok: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgRagnarok"
  ...
  static func ==(lhs: Types_MsgRagnarok, rhs: Types_MsgRagnarok) -> Bool {
