...
struct Akash_Deployment_V1beta3_DepositDeploymentAuthorization {
...
extension Akash_Deployment_V1beta3_DepositDeploymentAuthorization: @unchecked Sendable {}
...
extension Akash_Deployment_V1beta3_DepositDeploymentAuthorization: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._spendLimit {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Akash_Deployment_V1beta3_DepositDeploymentAuthorization, rhs: Akash_Deployment_V1beta3_DepositDeploymentAuthorization) -> Bool {
