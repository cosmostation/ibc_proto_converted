...
/// query.
struct Osmosis_Poolmanager_V2_SpotPriceRequest {
...
/// query.
struct Osmosis_Poolmanager_V2_SpotPriceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Poolmanager_V2_SpotPriceRequest: @unchecked Sendable {}
extension Osmosis_Poolmanager_V2_SpotPriceResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "osmosis.poolmanager.v2"

extension Osmosis_Poolmanager_V2_SpotPriceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Osmosis_Poolmanager_V2_SpotPriceRequest, rhs: Osmosis_Poolmanager_V2_SpotPriceRequest) -> Bool {
...
extension Osmosis_Poolmanager_V2_SpotPriceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Osmosis_Poolmanager_V2_SpotPriceResponse, rhs: Osmosis_Poolmanager_V2_SpotPriceResponse) -> Bool {
