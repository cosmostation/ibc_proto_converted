...
function serialize_ibc_core_connection_v1_QueryConnectionParamsRequest(arg) {
  if (!(arg instanceof ibc_core_connection_v1_query_pb.QueryConnectionParamsRequest)) {
    throw new Error('Expected argument of type ibc.core.connection.v1.QueryConnectionParamsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_connection_v1_QueryConnectionParamsRequest(buffer_arg) {
  return ibc_core_connection_v1_query_pb.QueryConnectionParamsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ibc_core_connection_v1_QueryConnectionParamsResponse(arg) {
  if (!(arg instanceof ibc_core_connection_v1_query_pb.QueryConnectionParamsResponse)) {
    throw new Error('Expected argument of type ibc.core.connection.v1.QueryConnectionParamsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_connection_v1_QueryConnectionParamsResponse(buffer_arg) {
  return ibc_core_connection_v1_query_pb.QueryConnectionParamsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
connectionParams: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ibc_core_connection_v1_query_pb.QueryConnectionParamsRequest,
    responseType: ibc_core_connection_v1_query_pb.QueryConnectionParamsResponse,
    requestSerialize: serialize_ibc_core_connection_v1_QueryConnectionParamsRequest,
    requestDeserialize: deserialize_ibc_core_connection_v1_QueryConnectionParamsRequest,
    responseSerialize: serialize_ibc_core_connection_v1_QueryConnectionParamsResponse,
    responseDeserialize: deserialize_ibc_core_connection_v1_QueryConnectionParamsResponse,
  },
};
