...
struct Akash_Market_V1beta3_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var params: Akash_Market_V1beta3_Params {
    get {return _params ?? Akash_Market_V1beta3_Params()}
  ...
  var leases: [Akash_Market_V1beta3_Lease] = []

  var bids: [Akash_Market_V1beta3_Bid] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _params: Akash_Market_V1beta3_Params? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Akash_Market_V1beta3_GenesisState: @unchecked Sendable {}
...
extension Akash_Market_V1beta3_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Market_V1beta3_GenesisState, rhs: Akash_Market_V1beta3_GenesisState) -> Bool {
