...
struct Akash_Base_V1beta3_Endpoint {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var kind: Akash_Base_V1beta3_Endpoint.Kind = .sharedHTTP
...
extension Akash_Base_V1beta3_Endpoint.Kind: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Akash_Base_V1beta3_Endpoint.Kind] = [
    .sharedHTTP,
    .randomPort,
    .leasedIp,
  ]
...
extension Akash_Base_V1beta3_Endpoint: @unchecked Sendable {}
extension Akash_Base_V1beta3_Endpoint.Kind: @unchecked Sendable {}
...
extension Akash_Base_V1beta3_Endpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Base_V1beta3_Endpoint, rhs: Akash_Base_V1beta3_Endpoint) -> Bool {
...
extension Akash_Base_V1beta3_Endpoint.Kind: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
