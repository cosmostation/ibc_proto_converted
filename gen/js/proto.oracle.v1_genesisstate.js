...
goog.provide('proto.oracle.v1.GenesisState');
...
goog.require('proto.oracle.v1.Params');
...
proto.oracle.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && proto.oracle.v1.Params.toObject(includeInstance, f),
    dataSourcesList: jspb.Message.toObjectList(msg.getDataSourcesList(),
    proto.oracle.v1.DataSource.toObject, includeInstance),
    oracleScriptsList: jspb.Message.toObjectList(msg.getOracleScriptsList(),
    proto.oracle.v1.OracleScript.toObject, includeInstance)
  };
...
proto.oracle.v1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.oracle.v1.Params;
      reader.readMessage(value,proto.oracle.v1.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    case 2:
...
proto.oracle.v1.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.oracle.v1.Params} */ (
    jspb.Message.getWrapperField(this, proto.oracle.v1.Params, 1));
};
...
proto.oracle.v1.GenesisState.prototype.getDataSourcesList = function() {
  return /** @type{!Array<!proto.oracle.v1.DataSource>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.oracle.v1.DataSource, 2));
};
...
proto.oracle.v1.GenesisState.prototype.getOracleScriptsList = function() {
  return /** @type{!Array<!proto.oracle.v1.OracleScript>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.oracle.v1.OracleScript, 3));
};
