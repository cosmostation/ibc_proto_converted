...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.InflationRateRequest,
      com.axelar.reward.v1beta1.InflationRateResponse> getInflationRateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "InflationRate",
      requestType = com.axelar.reward.v1beta1.InflationRateRequest.class,
      responseType = com.axelar.reward.v1beta1.InflationRateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.InflationRateRequest,
      com.axelar.reward.v1beta1.InflationRateResponse> getInflationRateMethod() {
    io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.InflationRateRequest, com.axelar.reward.v1beta1.InflationRateResponse> getInflationRateMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getInflationRateMethod = QueryServiceGrpc.getInflationRateMethod) == null) {
          QueryServiceGrpc.getInflationRateMethod = getInflationRateMethod =
              io.grpc.MethodDescriptor.<com.axelar.reward.v1beta1.InflationRateRequest, com.axelar.reward.v1beta1.InflationRateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "InflationRate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.InflationRateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.InflationRateResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.ParamsRequest,
      com.axelar.reward.v1beta1.ParamsResponse> getParamsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Params",
      requestType = com.axelar.reward.v1beta1.ParamsRequest.class,
      responseType = com.axelar.reward.v1beta1.ParamsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.ParamsRequest,
      com.axelar.reward.v1beta1.ParamsResponse> getParamsMethod() {
    io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.ParamsRequest, com.axelar.reward.v1beta1.ParamsResponse> getParamsMethod;
    if ((getParamsMethod = QueryServiceGrpc.getParamsMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getParamsMethod = QueryServiceGrpc.getParamsMethod) == null) {
          QueryServiceGrpc.getParamsMethod = getParamsMethod =
              io.grpc.MethodDescriptor.<com.axelar.reward.v1beta1.ParamsRequest, com.axelar.reward.v1beta1.ParamsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Params"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.ParamsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.ParamsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void inflationRate(com.axelar.reward.v1beta1.InflationRateRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.InflationRateResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getInflationRateMethod(), responseObserver);
    }

    /**
     */
    default void params(com.axelar.reward.v1beta1.ParamsRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.ParamsResponse> responseObserver) {
  ...
  public static final class QueryServiceStub
    ...
    /**
     */
    public void inflationRate(com.axelar.reward.v1beta1.InflationRateRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.InflationRateResponse> responseObserver) {
    ...
    /**
     */
    public void params(com.axelar.reward.v1beta1.ParamsRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.ParamsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class QueryServiceBlockingStub
    ...
    /**
     */
    public com.axelar.reward.v1beta1.InflationRateResponse inflationRate(com.axelar.reward.v1beta1.InflationRateRequest request) {
    ...
    /**
     */
    public com.axelar.reward.v1beta1.ParamsResponse params(com.axelar.reward.v1beta1.ParamsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class QueryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.reward.v1beta1.InflationRateResponse> inflationRate(
        com.axelar.reward.v1beta1.InflationRateRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.reward.v1beta1.ParamsResponse> params(
        com.axelar.reward.v1beta1.ParamsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INFLATION_RATE:
          serviceImpl.inflationRate((com.axelar.reward.v1beta1.InflationRateRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.InflationRateResponse>) responseObserver);
          break;
        case METHODID_PARAMS:
          serviceImpl.params((com.axelar.reward.v1beta1.ParamsRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.ParamsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.reward.v1beta1.InflationRateRequest,
              com.axelar.reward.v1beta1.InflationRateResponse>(
                service, METHODID_INFLATION_RATE)))
        .addMethod(
          getParamsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.reward.v1beta1.ParamsRequest,
              com.axelar.reward.v1beta1.ParamsResponse>(
