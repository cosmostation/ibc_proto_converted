...
extension Cork_V1_Cork: @unchecked Sendable {}
extension Cork_V1_ValidatorCork: @unchecked Sendable {}
extension Cork_V1_ScheduledCork: @unchecked Sendable {}
extension Cork_V1_CellarIDSet: @unchecked Sendable {}
...
extension Cork_V1_Cork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cork_V1_Cork, rhs: Cork_V1_Cork) -> Bool {
...
extension Cork_V1_ValidatorCork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ValidatorCork"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "cork"),
  ...
  static func ==(lhs: Cork_V1_ValidatorCork, rhs: Cork_V1_ValidatorCork) -> Bool {
...
extension Cork_V1_ScheduledCork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cork_V1_ScheduledCork, rhs: Cork_V1_ScheduledCork) -> Bool {
    if lhs._cork != rhs._cork {return false}
...
extension Cork_V1_CellarIDSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cork_V1_CellarIDSet, rhs: Cork_V1_CellarIDSet) -> Bool {
