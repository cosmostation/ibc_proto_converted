...
struct Provenance_Metadata_V1_MsgUpdateValueOwnersRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_MsgUpdateValueOwnersResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_MsgMigrateValueOwnerRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_MsgMigrateValueOwnerResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_MsgSetAccountDataRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_MsgSetAccountDataResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Provenance_Metadata_V1_MsgWriteScopeRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteScopeResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddScopeDataAccessRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddScopeDataAccessResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeDataAccessRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeDataAccessResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddScopeOwnerRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddScopeOwnerResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeOwnerRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeOwnerResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgUpdateValueOwnersRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgUpdateValueOwnersResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgMigrateValueOwnerRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgMigrateValueOwnerResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteSessionRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionIdComponents: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionIdComponents.OneOf_ScopeIdentifier: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteSessionResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteRecordRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteRecordResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteRecordRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteRecordResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteScopeSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteScopeSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteScopeSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteContractSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteContractSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddContractSpecToScopeSpecRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgAddContractSpecToScopeSpecResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteContractSpecFromScopeSpecRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteContractSpecFromScopeSpecResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteContractSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteContractSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteRecordSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteRecordSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteRecordSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteRecordSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgBindOSLocatorRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgBindOSLocatorResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteOSLocatorRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgDeleteOSLocatorResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgModifyOSLocatorRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgModifyOSLocatorResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgSetAccountDataRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgSetAccountDataResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteP8eContractSpecRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgWriteP8eContractSpecResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgP8eMemorializeContractRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_MsgP8eMemorializeContractResponse: @unchecked Sendable {}
...
extension Provenance_Metadata_V1_MsgWriteScopeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._scopeIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgUpdateValueOwnersRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUpdateValueOwnersRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "scope_ids"),
    2: .standard(proto: "value_owner_address"),
    3: .same(proto: "signers"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedBytesField(value: &self.scopeIds) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.valueOwnerAddress) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.signers) }()
      default: break
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.scopeIds.isEmpty {
      try visitor.visitRepeatedBytesField(value: self.scopeIds, fieldNumber: 1)
    }
    if !self.valueOwnerAddress.isEmpty {
      try visitor.visitSingularStringField(value: self.valueOwnerAddress, fieldNumber: 2)
    }
    if !self.signers.isEmpty {
      try visitor.visitRepeatedStringField(value: self.signers, fieldNumber: 3)
    }
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgUpdateValueOwnersRequest, rhs: Provenance_Metadata_V1_MsgUpdateValueOwnersRequest) -> Bool {
    if lhs.scopeIds != rhs.scopeIds {return false}
...
extension Provenance_Metadata_V1_MsgUpdateValueOwnersResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUpdateValueOwnersResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgUpdateValueOwnersResponse, rhs: Provenance_Metadata_V1_MsgUpdateValueOwnersResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Provenance_Metadata_V1_MsgMigrateValueOwnerRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgMigrateValueOwnerRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "existing"),
    2: .same(proto: "proposed"),
    3: .same(proto: "signers"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.existing) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.proposed) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.signers) }()
      default: break
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.existing.isEmpty {
      try visitor.visitSingularStringField(value: self.existing, fieldNumber: 1)
    }
    if !self.proposed.isEmpty {
      try visitor.visitSingularStringField(value: self.proposed, fieldNumber: 2)
    }
    if !self.signers.isEmpty {
      try visitor.visitRepeatedStringField(value: self.signers, fieldNumber: 3)
    }
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgMigrateValueOwnerRequest, rhs: Provenance_Metadata_V1_MsgMigrateValueOwnerRequest) -> Bool {
...
extension Provenance_Metadata_V1_MsgMigrateValueOwnerResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgMigrateValueOwnerResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgMigrateValueOwnerResponse, rhs: Provenance_Metadata_V1_MsgMigrateValueOwnerResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Provenance_Metadata_V1_MsgWriteSessionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._sessionIDComponents {
...
extension Provenance_Metadata_V1_MsgWriteSessionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._sessionIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgWriteRecordRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._sessionIDComponents {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
...
extension Provenance_Metadata_V1_MsgWriteRecordResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._recordIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgWriteScopeSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._scopeSpecIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgWriteContractSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._contractSpecIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgWriteRecordSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._recordSpecIDInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Metadata_V1_MsgSetAccountDataRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgSetAccountDataRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "metadata_addr"),
    2: .same(proto: "value"),
    3: .same(proto: "signers"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.metadataAddr) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.metadataAddr.isEmpty {
      try visitor.visitSingularBytesField(value: self.metadataAddr, fieldNumber: 1)
    }
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgSetAccountDataRequest, rhs: Provenance_Metadata_V1_MsgSetAccountDataRequest) -> Bool {
    if lhs.metadataAddr != rhs.metadataAddr {return false}
...
extension Provenance_Metadata_V1_MsgSetAccountDataResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Provenance_Metadata_V1_MsgSetAccountDataResponse, rhs: Provenance_Metadata_V1_MsgSetAccountDataResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Provenance_Metadata_V1_MsgWriteP8eContractSpecRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._contractspec {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    if !self.signers.isEmpty {
      try visitor.visitRepeatedStringField(value: self.signers, fieldNumber: 2)
...
extension Provenance_Metadata_V1_MsgP8eMemorializeContractResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      try { if let v = _storage._scopeIDInfo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      } }()
      try { if let v = _storage._sessionIDInfo {
