...
struct Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet: @unchecked Sendable {}
extension Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse: @unchecked Sendable {}
...
extension Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUndelegateFromRebalancedValidatorSet"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "delegator"),
    2: .same(proto: "coin"),
  ]
  ...
  static func ==(lhs: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, rhs: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet) -> Bool {
    if lhs.delegator != rhs.delegator {return false}
    if lhs._coin != rhs._coin {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUndelegateFromRebalancedValidatorSetResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse, rhs: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
