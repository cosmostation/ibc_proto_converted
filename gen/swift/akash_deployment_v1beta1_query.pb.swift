...
extension Akash_Deployment_V1beta1_QueryDeploymentsRequest: @unchecked Sendable {}
extension Akash_Deployment_V1beta1_QueryDeploymentsResponse: @unchecked Sendable {}
extension Akash_Deployment_V1beta1_QueryDeploymentRequest: @unchecked Sendable {}
extension Akash_Deployment_V1beta1_QueryDeploymentResponse: @unchecked Sendable {}
extension Akash_Deployment_V1beta1_QueryGroupRequest: @unchecked Sendable {}
extension Akash_Deployment_V1beta1_QueryGroupResponse: @unchecked Sendable {}
...
extension Akash_Deployment_V1beta1_QueryDeploymentResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._escrowAccount) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._escrowAccount {
