...
struct Provenance_Name_V1_EventNameUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Provenance_Name_V1_Params: @unchecked Sendable {}
extension Provenance_Name_V1_NameRecord: @unchecked Sendable {}
extension Provenance_Name_V1_CreateRootNameProposal: @unchecked Sendable {}
extension Provenance_Name_V1_EventNameBound: @unchecked Sendable {}
extension Provenance_Name_V1_EventNameUnbound: @unchecked Sendable {}
extension Provenance_Name_V1_EventNameUpdate: @unchecked Sendable {}
...
extension Provenance_Name_V1_EventNameUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventNameUpdate"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
    2: .same(proto: "name"),
    3: .same(proto: "restricted"),
  ...
  static func ==(lhs: Provenance_Name_V1_EventNameUpdate, rhs: Provenance_Name_V1_EventNameUpdate) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.name != rhs.name {return false}
    if lhs.restricted != rhs.restricted {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
