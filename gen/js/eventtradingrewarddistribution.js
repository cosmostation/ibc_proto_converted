...
goog.provide('proto.injective.exchange.v1beta1.EventTradingRewardDistribution');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.exchange.v1beta1.AccountRewards');
...
proto.injective.exchange.v1beta1.EventTradingRewardDistribution.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.injective.exchange.v1beta1.AccountRewards.toObject, includeInstance)
  };
...
proto.injective.exchange.v1beta1.EventTradingRewardDistribution.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.injective.exchange.v1beta1.AccountRewards;
      reader.readMessage(value,proto.injective.exchange.v1beta1.AccountRewards.deserializeBinaryFromReader);
...
proto.injective.exchange.v1beta1.EventTradingRewardDistribution.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.injective.exchange.v1beta1.AccountRewards.serializeBinaryToWriter
    );
  }
};
...
proto.injective.exchange.v1beta1.EventTradingRewardDistribution.prototype.getAccountRewardsList = function() {
  return /** @type{!Array<!proto.injective.exchange.v1beta1.AccountRewards>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.injective.exchange.v1beta1.AccountRewards, 1));
};
