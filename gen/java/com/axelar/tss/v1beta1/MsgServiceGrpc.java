...
public final class MsgServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.tss.v1beta1.HeartBeatRequest,
      com.axelar.tss.v1beta1.HeartBeatResponse> getHeartBeatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HeartBeat",
      requestType = com.axelar.tss.v1beta1.HeartBeatRequest.class,
      responseType = com.axelar.tss.v1beta1.HeartBeatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.tss.v1beta1.HeartBeatRequest,
      com.axelar.tss.v1beta1.HeartBeatResponse> getHeartBeatMethod() {
    io.grpc.MethodDescriptor<com.axelar.tss.v1beta1.HeartBeatRequest, com.axelar.tss.v1beta1.HeartBeatResponse> getHeartBeatMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getHeartBeatMethod = MsgServiceGrpc.getHeartBeatMethod) == null) {
          MsgServiceGrpc.getHeartBeatMethod = getHeartBeatMethod =
              io.grpc.MethodDescriptor.<com.axelar.tss.v1beta1.HeartBeatRequest, com.axelar.tss.v1beta1.HeartBeatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "HeartBeat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.tss.v1beta1.HeartBeatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.tss.v1beta1.HeartBeatResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void heartBeat(com.axelar.tss.v1beta1.HeartBeatRequest request,
        io.grpc.stub.StreamObserver<com.axelar.tss.v1beta1.HeartBeatResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void heartBeat(com.axelar.tss.v1beta1.HeartBeatRequest request,
        io.grpc.stub.StreamObserver<com.axelar.tss.v1beta1.HeartBeatResponse> responseObserver) {
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.axelar.tss.v1beta1.HeartBeatResponse heartBeat(com.axelar.tss.v1beta1.HeartBeatRequest request) {
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.tss.v1beta1.HeartBeatResponse> heartBeat(
        com.axelar.tss.v1beta1.HeartBeatRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HEART_BEAT:
          serviceImpl.heartBeat((com.axelar.tss.v1beta1.HeartBeatRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.tss.v1beta1.HeartBeatResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.tss.v1beta1.HeartBeatRequest,
              com.axelar.tss.v1beta1.HeartBeatResponse>(
