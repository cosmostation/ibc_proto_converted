...
var cosmos_base_tendermint_v1beta1_query_pb = require('../../../../cosmos/base/tendermint/v1beta1/query_pb.js');
...
function serialize_cosmos_base_tendermint_v1beta1_ABCIQueryRequest(arg) {
  if (!(arg instanceof cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest)) {
    throw new Error('Expected argument of type cosmos.base.tendermint.v1beta1.ABCIQueryRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_base_tendermint_v1beta1_ABCIQueryRequest(buffer_arg) {
  return cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_base_tendermint_v1beta1_ABCIQueryResponse(arg) {
  if (!(arg instanceof cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse)) {
    throw new Error('Expected argument of type cosmos.base.tendermint.v1beta1.ABCIQueryResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_base_tendermint_v1beta1_ABCIQueryResponse(buffer_arg) {
  return cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
aBCIQuery: {
    ...
    requestSerialize: serialize_cosmos_base_tendermint_v1beta1_ABCIQueryRequest,
    requestDeserialize: deserialize_cosmos_base_tendermint_v1beta1_ABCIQueryRequest,
    responseSerialize: serialize_cosmos_base_tendermint_v1beta1_ABCIQueryResponse,
    responseDeserialize: deserialize_cosmos_base_tendermint_v1beta1_ABCIQueryResponse,
  },
};
