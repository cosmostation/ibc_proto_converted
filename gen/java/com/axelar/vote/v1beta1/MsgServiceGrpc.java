...
public final class MsgServiceGrpc {
  ...
  public static final String SERVICE_NAME = "axelar.vote.v1beta1.MsgService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.axelar.vote.v1beta1.VoteRequest,
      com.axelar.vote.v1beta1.VoteResponse> getVoteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Vote",
      requestType = com.axelar.vote.v1beta1.VoteRequest.class,
      responseType = com.axelar.vote.v1beta1.VoteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.vote.v1beta1.VoteRequest,
      com.axelar.vote.v1beta1.VoteResponse> getVoteMethod() {
    io.grpc.MethodDescriptor<com.axelar.vote.v1beta1.VoteRequest, com.axelar.vote.v1beta1.VoteResponse> getVoteMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getVoteMethod = MsgServiceGrpc.getVoteMethod) == null) {
          MsgServiceGrpc.getVoteMethod = getVoteMethod =
              io.grpc.MethodDescriptor.<com.axelar.vote.v1beta1.VoteRequest, com.axelar.vote.v1beta1.VoteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Vote"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.vote.v1beta1.VoteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.vote.v1beta1.VoteResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void vote(com.axelar.vote.v1beta1.VoteRequest request,
        io.grpc.stub.StreamObserver<com.axelar.vote.v1beta1.VoteResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void vote(com.axelar.vote.v1beta1.VoteRequest request,
        io.grpc.stub.StreamObserver<com.axelar.vote.v1beta1.VoteResponse> responseObserver) {
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.axelar.vote.v1beta1.VoteResponse vote(com.axelar.vote.v1beta1.VoteRequest request) {
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.vote.v1beta1.VoteResponse> vote(
        com.axelar.vote.v1beta1.VoteRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VOTE:
          serviceImpl.vote((com.axelar.vote.v1beta1.VoteRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.vote.v1beta1.VoteResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.vote.v1beta1.VoteRequest,
              com.axelar.vote.v1beta1.VoteResponse>(
