...
extension Types_MsgOutboundTx: @unchecked Sendable {}
...
extension Types_MsgOutboundTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgOutboundTx"
  ...
  static func ==(lhs: Types_MsgOutboundTx, rhs: Types_MsgOutboundTx) -> Bool {
