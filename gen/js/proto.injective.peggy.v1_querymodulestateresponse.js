...
goog.provide('proto.injective.peggy.v1.QueryModuleStateResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.peggy.v1.GenesisState');
...
proto.injective.peggy.v1.QueryModuleStateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    state: (f = msg.getState()) && proto.injective.peggy.v1.GenesisState.toObject(includeInstance, f)
  };
...
proto.injective.peggy.v1.QueryModuleStateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.injective.peggy.v1.GenesisState;
      reader.readMessage(value,proto.injective.peggy.v1.GenesisState.deserializeBinaryFromReader);
      msg.setState(value);
      break;
    default:
      reader.skipField();
...
proto.injective.peggy.v1.QueryModuleStateResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.injective.peggy.v1.GenesisState.serializeBinaryToWriter
    );
  }
};
...
proto.injective.peggy.v1.QueryModuleStateResponse.prototype.getState = function() {
  return /** @type{?proto.injective.peggy.v1.GenesisState} */ (
    jspb.Message.getWrapperField(this, proto.injective.peggy.v1.GenesisState, 1));
};
