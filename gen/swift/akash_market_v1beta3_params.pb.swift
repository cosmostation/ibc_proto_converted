...
struct Akash_Market_V1beta3_Params {
...
extension Akash_Market_V1beta3_Params: @unchecked Sendable {}
...
extension Akash_Market_V1beta3_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._bidMinDeposit) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.orderMaxBids) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._bidMinDeposit {
  ...
  static func ==(lhs: Akash_Market_V1beta3_Params, rhs: Akash_Market_V1beta3_Params) -> Bool {
