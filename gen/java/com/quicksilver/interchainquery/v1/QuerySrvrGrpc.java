...
public final class QuerySrvrGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "quicksilver.interchainquery.v1.QuerySrvr";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest,
      com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> getQueriesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Queries",
      requestType = com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest.class,
      responseType = com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest,
      com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> getQueriesMethod() {
    io.grpc.MethodDescriptor<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest, com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> getQueriesMethod;
      ...
      synchronized (QuerySrvrGrpc.class) {
        if ((getQueriesMethod = QuerySrvrGrpc.getQueriesMethod) == null) {
          QuerySrvrGrpc.getQueriesMethod = getQueriesMethod =
              io.grpc.MethodDescriptor.<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest, com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Queries"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void queries(com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest request,
        io.grpc.stub.StreamObserver<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> responseObserver) {
  ...
  public static final class QuerySrvrStub
     ...
     * </pre>
     */
    public void queries(com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest request,
        io.grpc.stub.StreamObserver<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> responseObserver) {
  ...
  public static final class QuerySrvrBlockingStub
     ...
     * </pre>
     */
    public com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse queries(com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest request) {
  ...
  public static final class QuerySrvrFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse> queries(
        com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERIES:
          serviceImpl.queries((com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest) request,
              (io.grpc.stub.StreamObserver<com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsRequest,
              com.quicksilver.interchainquery.v1.QueryProto.QueryRequestsResponse>(
