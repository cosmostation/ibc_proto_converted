...
extension Em_Market_V1_TimeInForce: @unchecked Sendable {}
extension Em_Market_V1_Instrument: @unchecked Sendable {}
extension Em_Market_V1_Order: @unchecked Sendable {}
extension Em_Market_V1_ExecutionPlan: @unchecked Sendable {}
extension Em_Market_V1_MarketData: @unchecked Sendable {}
...
extension Em_Market_V1_ExecutionPlan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._firstOrder {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      try { if let v = _storage._secondOrder {
