...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_NODEIDENTITY'].fields_by_name['TendermintNodeID']._options = None
  _globals['_NODEIDENTITY'].fields_by_name['TendermintNodeID']._serialized_options = b'\310\336\037\000\332\336\037,github.com/hyperledger/burrow/crypto.Address'
  _globals['_NODEIDENTITY'].fields_by_name['ValidatorPublicKey']._options = None
  _globals['_NODEIDENTITY'].fields_by_name['ValidatorPublicKey']._serialized_options = b'\310\336\037\000\332\336\037.github.com/hyperledger/burrow/crypto.PublicKey'
  _globals['_NODEIDENTITY']._options = None
  _globals['_NODEIDENTITY']._serialized_options = b'\230\240\037\000'
