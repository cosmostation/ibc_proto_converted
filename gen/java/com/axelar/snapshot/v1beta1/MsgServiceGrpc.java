...
public final class MsgServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.RegisterProxyRequest,
      com.axelar.snapshot.v1beta1.RegisterProxyResponse> getRegisterProxyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RegisterProxy",
      requestType = com.axelar.snapshot.v1beta1.RegisterProxyRequest.class,
      responseType = com.axelar.snapshot.v1beta1.RegisterProxyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.RegisterProxyRequest,
      com.axelar.snapshot.v1beta1.RegisterProxyResponse> getRegisterProxyMethod() {
    io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.RegisterProxyRequest, com.axelar.snapshot.v1beta1.RegisterProxyResponse> getRegisterProxyMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getRegisterProxyMethod = MsgServiceGrpc.getRegisterProxyMethod) == null) {
          MsgServiceGrpc.getRegisterProxyMethod = getRegisterProxyMethod =
              io.grpc.MethodDescriptor.<com.axelar.snapshot.v1beta1.RegisterProxyRequest, com.axelar.snapshot.v1beta1.RegisterProxyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RegisterProxy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.snapshot.v1beta1.RegisterProxyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.snapshot.v1beta1.RegisterProxyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.DeactivateProxyRequest,
      com.axelar.snapshot.v1beta1.DeactivateProxyResponse> getDeactivateProxyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DeactivateProxy",
      requestType = com.axelar.snapshot.v1beta1.DeactivateProxyRequest.class,
      responseType = com.axelar.snapshot.v1beta1.DeactivateProxyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.DeactivateProxyRequest,
      com.axelar.snapshot.v1beta1.DeactivateProxyResponse> getDeactivateProxyMethod() {
    io.grpc.MethodDescriptor<com.axelar.snapshot.v1beta1.DeactivateProxyRequest, com.axelar.snapshot.v1beta1.DeactivateProxyResponse> getDeactivateProxyMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getDeactivateProxyMethod = MsgServiceGrpc.getDeactivateProxyMethod) == null) {
          MsgServiceGrpc.getDeactivateProxyMethod = getDeactivateProxyMethod =
              io.grpc.MethodDescriptor.<com.axelar.snapshot.v1beta1.DeactivateProxyRequest, com.axelar.snapshot.v1beta1.DeactivateProxyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DeactivateProxy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.snapshot.v1beta1.DeactivateProxyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.snapshot.v1beta1.DeactivateProxyResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void registerProxy(com.axelar.snapshot.v1beta1.RegisterProxyRequest request,
        io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.RegisterProxyResponse> responseObserver) {
     ...
     * </pre>
     */
    default void deactivateProxy(com.axelar.snapshot.v1beta1.DeactivateProxyRequest request,
        io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.DeactivateProxyResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
     ...
     * </pre>
     */
    public void registerProxy(com.axelar.snapshot.v1beta1.RegisterProxyRequest request,
        io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.RegisterProxyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void deactivateProxy(com.axelar.snapshot.v1beta1.DeactivateProxyRequest request,
        io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.DeactivateProxyResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgServiceBlockingStub
     ...
     * </pre>
     */
    public com.axelar.snapshot.v1beta1.RegisterProxyResponse registerProxy(com.axelar.snapshot.v1beta1.RegisterProxyRequest request) {
     ...
     * </pre>
     */
    public com.axelar.snapshot.v1beta1.DeactivateProxyResponse deactivateProxy(com.axelar.snapshot.v1beta1.DeactivateProxyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.snapshot.v1beta1.RegisterProxyResponse> registerProxy(
        com.axelar.snapshot.v1beta1.RegisterProxyRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.snapshot.v1beta1.DeactivateProxyResponse> deactivateProxy(
        com.axelar.snapshot.v1beta1.DeactivateProxyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_PROXY:
          serviceImpl.registerProxy((com.axelar.snapshot.v1beta1.RegisterProxyRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.RegisterProxyResponse>) responseObserver);
          break;
        case METHODID_DEACTIVATE_PROXY:
          serviceImpl.deactivateProxy((com.axelar.snapshot.v1beta1.DeactivateProxyRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.snapshot.v1beta1.DeactivateProxyResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.snapshot.v1beta1.RegisterProxyRequest,
              com.axelar.snapshot.v1beta1.RegisterProxyResponse>(
                service, METHODID_REGISTER_PROXY)))
        .addMethod(
          getDeactivateProxyMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.snapshot.v1beta1.DeactivateProxyRequest,
              com.axelar.snapshot.v1beta1.DeactivateProxyResponse>(
