...
extension Bitsong_Fantoken_V1beta1_Params: @unchecked Sendable {}
...
extension Bitsong_Fantoken_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "mint_fee"),
    3: .standard(proto: "burn_fee"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._mintFee) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._burnFee) }()
      default: break
      }
    }
  }
