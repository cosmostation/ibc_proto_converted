...
struct Lum_Network_Icqueries_Query {
...
struct Lum_Network_Icqueries_DataPoint {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Lum_Network_Icqueries_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Lum_Network_Icqueries_Query: @unchecked Sendable {}
extension Lum_Network_Icqueries_DataPoint: @unchecked Sendable {}
extension Lum_Network_Icqueries_GenesisState: @unchecked Sendable {}
...
extension Lum_Network_Icqueries_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 12: try { try decoder.decodeSingularStringField(value: &self.extraID) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.extraID.isEmpty {
      try visitor.visitSingularStringField(value: self.extraID, fieldNumber: 12)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Lum_Network_Icqueries_Query, rhs: Lum_Network_Icqueries_Query) -> Bool {
    ...
    if lhs.extraID != rhs.extraID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Lum_Network_Icqueries_DataPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Lum_Network_Icqueries_DataPoint, rhs: Lum_Network_Icqueries_DataPoint) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Lum_Network_Icqueries_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Lum_Network_Icqueries_GenesisState, rhs: Lum_Network_Icqueries_GenesisState) -> Bool {
