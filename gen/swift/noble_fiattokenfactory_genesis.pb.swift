...
struct Noble_Fiattokenfactory_GenesisState {
  ...
  var blacklistedList: [Noble_Fiattokenfactory_Blacklisted] = []
  ...
  var mintersList: [Noble_Fiattokenfactory_Minters] = []
  ...
  var minterControllerList: [Noble_Fiattokenfactory_MinterController] = []
...
extension Noble_Fiattokenfactory_GenesisState: @unchecked Sendable {}
...
extension Noble_Fiattokenfactory_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Noble_Fiattokenfactory_GenesisState, rhs: Noble_Fiattokenfactory_GenesisState) -> Bool {
