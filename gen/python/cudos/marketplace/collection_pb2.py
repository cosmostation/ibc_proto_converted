...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_COLLECTION'].fields_by_name['mintRoyalties']._options = None
  _globals['_COLLECTION'].fields_by_name['mintRoyalties']._serialized_options = b'\310\336\037\000'
  _globals['_COLLECTION'].fields_by_name['resaleRoyalties']._options = None
  _globals['_COLLECTION'].fields_by_name['resaleRoyalties']._serialized_options = b'\310\336\037\000'
