...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MSGPOSTPRICE'].fields_by_name['market_id']._options = None
  _globals['_MSGPOSTPRICE'].fields_by_name['market_id']._serialized_options = b'\342\336\037\010MarketID'
  _globals['_MSGPOSTPRICE'].fields_by_name['price']._options = None
  _globals['_MSGPOSTPRICE'].fields_by_name['price']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _globals['_MSGPOSTPRICE'].fields_by_name['expiry']._options = None
  _globals['_MSGPOSTPRICE'].fields_by_name['expiry']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_MSGPOSTPRICE']._options = None
  _globals['_MSGPOSTPRICE']._serialized_options = b'\210\240\037\000'
