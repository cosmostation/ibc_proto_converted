...
public final class ServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.assetmantle.modules.splits.transactions.unwrap.Message,
      com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> getHandleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Handle",
      requestType = com.assetmantle.modules.splits.transactions.unwrap.Message.class,
      responseType = com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.assetmantle.modules.splits.transactions.unwrap.Message,
      com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> getHandleMethod() {
    io.grpc.MethodDescriptor<com.assetmantle.modules.splits.transactions.unwrap.Message, com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> getHandleMethod;
    if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
          ServiceGrpc.getHandleMethod = getHandleMethod =
              io.grpc.MethodDescriptor.<com.assetmantle.modules.splits.transactions.unwrap.Message, com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Handle"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.splits.transactions.unwrap.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void handle(com.assetmantle.modules.splits.transactions.unwrap.Message request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> responseObserver) {
  ...
  public static final class ServiceStub
    ...
    /**
     */
    public void handle(com.assetmantle.modules.splits.transactions.unwrap.Message request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> responseObserver) {
  ...
  public static final class ServiceBlockingStub
    ...
    /**
     */
    public com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse handle(com.assetmantle.modules.splits.transactions.unwrap.Message request) {
  ...
  public static final class ServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse> handle(
        com.assetmantle.modules.splits.transactions.unwrap.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HANDLE:
          serviceImpl.handle((com.assetmantle.modules.splits.transactions.unwrap.Message) request,
              (io.grpc.stub.StreamObserver<com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.assetmantle.modules.splits.transactions.unwrap.Message,
              com.assetmantle.modules.splits.transactions.unwrap.TransactionResponse>(
