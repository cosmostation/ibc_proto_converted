...
public interface EvaluateClaimAuthorizationOrBuilder extends
   ...
   */
  java.util.List<com.ixo.claims.v1beta1.EvaluateClaimConstraints> 
      getConstraintsList();
  /**
   * <code>repeated .ixo.claims.v1beta1.EvaluateClaimConstraints constraints = 2 [json_name = "constraints"];</code>
   */
  com.ixo.claims.v1beta1.EvaluateClaimConstraints getConstraints(int index);
  /**
   * <code>repeated .ixo.claims.v1beta1.EvaluateClaimConstraints constraints = 2 [json_name = "constraints"];</code>
   */
   ...
   * <code>repeated .ixo.claims.v1beta1.EvaluateClaimConstraints constraints = 2 [json_name = "constraints"];</code>
   */
  java.util.List<? extends com.ixo.claims.v1beta1.EvaluateClaimConstraintsOrBuilder> 
      getConstraintsOrBuilderList();
  /**
   * <code>repeated .ixo.claims.v1beta1.EvaluateClaimConstraints constraints = 2 [json_name = "constraints"];</code>
   */
  com.ixo.claims.v1beta1.EvaluateClaimConstraintsOrBuilder getConstraintsOrBuilder(
      int index);
}
