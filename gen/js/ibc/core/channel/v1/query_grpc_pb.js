...
function serialize_ibc_core_channel_v1_QueryNextSequenceSendRequest(arg) {
  if (!(arg instanceof ibc_core_channel_v1_query_pb.QueryNextSequenceSendRequest)) {
    throw new Error('Expected argument of type ibc.core.channel.v1.QueryNextSequenceSendRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_channel_v1_QueryNextSequenceSendRequest(buffer_arg) {
  return ibc_core_channel_v1_query_pb.QueryNextSequenceSendRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ibc_core_channel_v1_QueryNextSequenceSendResponse(arg) {
  if (!(arg instanceof ibc_core_channel_v1_query_pb.QueryNextSequenceSendResponse)) {
    throw new Error('Expected argument of type ibc.core.channel.v1.QueryNextSequenceSendResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_channel_v1_QueryNextSequenceSendResponse(buffer_arg) {
  return ibc_core_channel_v1_query_pb.QueryNextSequenceSendResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
nextSequenceSend: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ibc_core_channel_v1_query_pb.QueryNextSequenceSendRequest,
    responseType: ibc_core_channel_v1_query_pb.QueryNextSequenceSendResponse,
    requestSerialize: serialize_ibc_core_channel_v1_QueryNextSequenceSendRequest,
    requestDeserialize: deserialize_ibc_core_channel_v1_QueryNextSequenceSendRequest,
    responseSerialize: serialize_ibc_core_channel_v1_QueryNextSequenceSendResponse,
    responseDeserialize: deserialize_ibc_core_channel_v1_QueryNextSequenceSendResponse,
  },
};
