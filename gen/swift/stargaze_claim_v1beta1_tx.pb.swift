...
struct Publicawesome_Stargaze_Claim_V1beta1_MsgClaimFor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publicawesome_Stargaze_Claim_V1beta1_MsgClaimForResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Publicawesome_Stargaze_Claim_V1beta1_MsgInitialClaim: @unchecked Sendable {}
extension Publicawesome_Stargaze_Claim_V1beta1_MsgInitialClaimResponse: @unchecked Sendable {}
extension Publicawesome_Stargaze_Claim_V1beta1_MsgClaimFor: @unchecked Sendable {}
extension Publicawesome_Stargaze_Claim_V1beta1_MsgClaimForResponse: @unchecked Sendable {}
...
extension Publicawesome_Stargaze_Claim_V1beta1_MsgClaimFor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgClaimFor"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "sender"),
  ...
  static func ==(lhs: Publicawesome_Stargaze_Claim_V1beta1_MsgClaimFor, rhs: Publicawesome_Stargaze_Claim_V1beta1_MsgClaimFor) -> Bool {
    if lhs.sender != rhs.sender {return false}
...
extension Publicawesome_Stargaze_Claim_V1beta1_MsgClaimForResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgClaimForResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Publicawesome_Stargaze_Claim_V1beta1_MsgClaimForResponse, rhs: Publicawesome_Stargaze_Claim_V1beta1_MsgClaimForResponse) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.claimedAmount != rhs.claimedAmount {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
