...
extension Rizonworld_Rizon_Treasury_QueryCurrenciesRequest: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryCurrenciesResponse: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryCurrencyRequest: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryCurrencyResponse: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryMaxRequest: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryMaxResponse: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryParamsRequest: @unchecked Sendable {}
extension Rizonworld_Rizon_Treasury_QueryParamsResponse: @unchecked Sendable {}
...
extension Rizonworld_Rizon_Treasury_QueryMaxResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._maxAtoloSupply {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
