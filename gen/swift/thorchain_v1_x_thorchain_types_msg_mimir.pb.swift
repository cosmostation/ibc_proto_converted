...
extension Types_MsgMimir: @unchecked Sendable {}
...
extension Types_MsgMimir: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgMimir"
  ...
  static func ==(lhs: Types_MsgMimir, rhs: Types_MsgMimir) -> Bool {
