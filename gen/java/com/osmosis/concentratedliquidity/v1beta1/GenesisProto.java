...
public final class GenesisProto {
  ...
  public interface PositionDataOrBuilder extends
    ...
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record> 
        getUptimeAccumRecordsList();
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    com.osmosis.accum.v1beta1.AccumProto.Record getUptimeAccumRecords(int index);
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    int getUptimeAccumRecordsCount();
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    java.util.List<? extends com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder> 
        getUptimeAccumRecordsOrBuilderList();
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder getUptimeAccumRecordsOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private PositionData() {
      uptimeAccumRecords_ = java.util.Collections.emptyList();
    }
    ...
    public static final int UPTIME_ACCUM_RECORDS_FIELD_NUMBER = 4;
    @SuppressWarnings("serial")
    private java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record> uptimeAccumRecords_;
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    @java.lang.Override
    public java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record> getUptimeAccumRecordsList() {
      return uptimeAccumRecords_;
    }
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    @java.lang.Override
    public java.util.List<? extends com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder> 
        getUptimeAccumRecordsOrBuilderList() {
      return uptimeAccumRecords_;
    }
    /**
     ...
     */
    @java.lang.Override
    public int getUptimeAccumRecordsCount() {
      return uptimeAccumRecords_.size();
    }
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    @java.lang.Override
    public com.osmosis.accum.v1beta1.AccumProto.Record getUptimeAccumRecords(int index) {
      return uptimeAccumRecords_.get(index);
    }
    /**
     * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
     */
    @java.lang.Override
    public com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder getUptimeAccumRecordsOrBuilder(
        int index) {
      return uptimeAccumRecords_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < uptimeAccumRecords_.size(); i++) {
        output.writeMessage(4, uptimeAccumRecords_.get(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < uptimeAccumRecords_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, uptimeAccumRecords_.get(i));
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUptimeAccumRecordsList()
          .equals(other.getUptimeAccumRecordsList())) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      if (getUptimeAccumRecordsCount() > 0) {
        hash = (37 * hash) + UPTIME_ACCUM_RECORDS_FIELD_NUMBER;
        hash = (53 * hash) + getUptimeAccumRecordsList().hashCode();
      }
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        if (uptimeAccumRecordsBuilder_ == null) {
          uptimeAccumRecords_ = java.util.Collections.emptyList();
        } else {
          uptimeAccumRecords_ = null;
          uptimeAccumRecordsBuilder_.clear();
        }
        bitField0_ = (bitField0_ & ~0x00000008);
        return this;
      }
      ...
      private void buildPartialRepeatedFields(com.osmosis.concentratedliquidity.v1beta1.GenesisProto.PositionData result) {
        if (uptimeAccumRecordsBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0)) {
            uptimeAccumRecords_ = java.util.Collections.unmodifiableList(uptimeAccumRecords_);
            bitField0_ = (bitField0_ & ~0x00000008);
          }
          result.uptimeAccumRecords_ = uptimeAccumRecords_;
        } else {
          result.uptimeAccumRecords_ = uptimeAccumRecordsBuilder_.build();
        }
      }
      ...
      public Builder mergeFrom(com.osmosis.concentratedliquidity.v1beta1.GenesisProto.PositionData other) {
        ...
        if (uptimeAccumRecordsBuilder_ == null) {
          if (!other.uptimeAccumRecords_.isEmpty()) {
            if (uptimeAccumRecords_.isEmpty()) {
              uptimeAccumRecords_ = other.uptimeAccumRecords_;
              bitField0_ = (bitField0_ & ~0x00000008);
            } else {
              ensureUptimeAccumRecordsIsMutable();
              uptimeAccumRecords_.addAll(other.uptimeAccumRecords_);
            }
            onChanged();
          }
        } else {
          if (!other.uptimeAccumRecords_.isEmpty()) {
            if (uptimeAccumRecordsBuilder_.isEmpty()) {
              uptimeAccumRecordsBuilder_.dispose();
              uptimeAccumRecordsBuilder_ = null;
              uptimeAccumRecords_ = other.uptimeAccumRecords_;
              bitField0_ = (bitField0_ & ~0x00000008);
              uptimeAccumRecordsBuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getUptimeAccumRecordsFieldBuilder() : null;
            } else {
              uptimeAccumRecordsBuilder_.addAllMessages(other.uptimeAccumRecords_);
            }
          }
        }
        this.mergeUnknownFields(other.getUnknownFields());
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                com.osmosis.accum.v1beta1.AccumProto.Record m =
                    input.readMessage(
                        com.osmosis.accum.v1beta1.AccumProto.Record.parser(),
                        extensionRegistry);
                if (uptimeAccumRecordsBuilder_ == null) {
                  ensureUptimeAccumRecordsIsMutable();
                  uptimeAccumRecords_.add(m);
                } else {
                  uptimeAccumRecordsBuilder_.addMessage(m);
                }
                break;
              } // case 34
              default: {
      ...
      private java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record> uptimeAccumRecords_ =
        java.util.Collections.emptyList();
      private void ensureUptimeAccumRecordsIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          uptimeAccumRecords_ = new java.util.ArrayList<com.osmosis.accum.v1beta1.AccumProto.Record>(uptimeAccumRecords_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          com.osmosis.accum.v1beta1.AccumProto.Record, com.osmosis.accum.v1beta1.AccumProto.Record.Builder, com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder> uptimeAccumRecordsBuilder_;
      ...
      public java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record> getUptimeAccumRecordsList() {
        if (uptimeAccumRecordsBuilder_ == null) {
          return java.util.Collections.unmodifiableList(uptimeAccumRecords_);
        } else {
          return uptimeAccumRecordsBuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
      ...
      public int getUptimeAccumRecordsCount() {
        if (uptimeAccumRecordsBuilder_ == null) {
          ...
          return uptimeAccumRecordsBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
      ...
      public com.osmosis.accum.v1beta1.AccumProto.Record getUptimeAccumRecords(int index) {
        if (uptimeAccumRecordsBuilder_ == null) {
          ...
          return uptimeAccumRecordsBuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder setUptimeAccumRecords(
          int index, com.osmosis.accum.v1beta1.AccumProto.Record value) {
        if (uptimeAccumRecordsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.set(index, value);
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
       ...
       */
      public Builder setUptimeAccumRecords(
          int index, com.osmosis.accum.v1beta1.AccumProto.Record.Builder builderForValue) {
        if (uptimeAccumRecordsBuilder_ == null) {
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.set(index, builderForValue.build());
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder addUptimeAccumRecords(com.osmosis.accum.v1beta1.AccumProto.Record value) {
        if (uptimeAccumRecordsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.add(value);
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.addMessage(value);
        }
        return this;
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder addUptimeAccumRecords(
          int index, com.osmosis.accum.v1beta1.AccumProto.Record value) {
        if (uptimeAccumRecordsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.add(index, value);
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder addUptimeAccumRecords(
        ...
        if (uptimeAccumRecordsBuilder_ == null) {
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.add(builderForValue.build());
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addUptimeAccumRecords(
        ...
        if (uptimeAccumRecordsBuilder_ == null) {
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.add(index, builderForValue.build());
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder addAllUptimeAccumRecords(
          java.lang.Iterable<? extends com.osmosis.accum.v1beta1.AccumProto.Record> values) {
        if (uptimeAccumRecordsBuilder_ == null) {
          ensureUptimeAccumRecordsIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, uptimeAccumRecords_);
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder clearUptimeAccumRecords() {
        if (uptimeAccumRecordsBuilder_ == null) {
          uptimeAccumRecords_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000008);
          onChanged();
       ...
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public Builder removeUptimeAccumRecords(int index) {
        if (uptimeAccumRecordsBuilder_ == null) {
          ensureUptimeAccumRecordsIsMutable();
          uptimeAccumRecords_.remove(index);
          onChanged();
        } else {
          uptimeAccumRecordsBuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public com.osmosis.accum.v1beta1.AccumProto.Record.Builder getUptimeAccumRecordsBuilder(
          int index) {
        return getUptimeAccumRecordsFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder getUptimeAccumRecordsOrBuilder(
          int index) {
        if (uptimeAccumRecordsBuilder_ == null) {
          return uptimeAccumRecords_.get(index);  } else {
          return uptimeAccumRecordsBuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
      ...
      public java.util.List<? extends com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder> 
           getUptimeAccumRecordsOrBuilderList() {
        if (uptimeAccumRecordsBuilder_ != null) {
          return uptimeAccumRecordsBuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(uptimeAccumRecords_);
        }
      }
       ...
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public com.osmosis.accum.v1beta1.AccumProto.Record.Builder addUptimeAccumRecordsBuilder() {
        return getUptimeAccumRecordsFieldBuilder().addBuilder(
            com.osmosis.accum.v1beta1.AccumProto.Record.getDefaultInstance());
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public com.osmosis.accum.v1beta1.AccumProto.Record.Builder addUptimeAccumRecordsBuilder(
          int index) {
        return getUptimeAccumRecordsFieldBuilder().addBuilder(
            index, com.osmosis.accum.v1beta1.AccumProto.Record.getDefaultInstance());
      }
      /**
       * <code>repeated .osmosis.accum.v1beta1.Record uptime_accum_records = 4 [json_name = "uptimeAccumRecords", (.gogoproto.nullable) = false];</code>
       */
      public java.util.List<com.osmosis.accum.v1beta1.AccumProto.Record.Builder> 
           getUptimeAccumRecordsBuilderList() {
        return getUptimeAccumRecordsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          com.osmosis.accum.v1beta1.AccumProto.Record, com.osmosis.accum.v1beta1.AccumProto.Record.Builder, com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder> 
          getUptimeAccumRecordsFieldBuilder() {
        if (uptimeAccumRecordsBuilder_ == null) {
          uptimeAccumRecordsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              com.osmosis.accum.v1beta1.AccumProto.Record, com.osmosis.accum.v1beta1.AccumProto.Record.Builder, com.osmosis.accum.v1beta1.AccumProto.RecordOrBuilder>(
                  uptimeAccumRecords_,
                  ((bitField0_ & 0x00000008) != 0),
                  getParentForChildren(),
        ...
        return uptimeAccumRecordsBuilder_;
      }
      @java.lang.Override
      public final Builder setUnknownFields(
          final com.google.protobuf.UnknownFieldSet unknownFields) {
  ...
  public interface GenesisStateOrBuilder extends
    ...
    /**
     * <code>uint64 next_incentive_record_id = 5 [json_name = "nextIncentiveRecordId", (.gogoproto.moretags) = "yaml:&#92;"next_incentive_record_id&#92;""];</code>
     * @return The nextIncentiveRecordId.
     */
    long getNextIncentiveRecordId();

    /**
     * <code>uint64 incentives_accumulator_pool_id_migration_threshold = 6 [json_name = "incentivesAccumulatorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"incentives_accumulator_pool_id_migration_threshold&#92;""];</code>
     * @return The incentivesAccumulatorPoolIdMigrationThreshold.
     */
    long getIncentivesAccumulatorPoolIdMigrationThreshold();

    /**
     * <code>uint64 spread_factor_pool_id_migration_threshold = 7 [json_name = "spreadFactorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"spread_factor_pool_id_migration_threshold&#92;""];</code>
     * @return The spreadFactorPoolIdMigrationThreshold.
     */
    long getSpreadFactorPoolIdMigrationThreshold();
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NEXT_INCENTIVE_RECORD_ID_FIELD_NUMBER = 5;
    private long nextIncentiveRecordId_ = 0L;
    /**
     * <code>uint64 next_incentive_record_id = 5 [json_name = "nextIncentiveRecordId", (.gogoproto.moretags) = "yaml:&#92;"next_incentive_record_id&#92;""];</code>
     * @return The nextIncentiveRecordId.
     */
    @java.lang.Override
    public long getNextIncentiveRecordId() {
      return nextIncentiveRecordId_;
    }

    public static final int INCENTIVES_ACCUMULATOR_POOL_ID_MIGRATION_THRESHOLD_FIELD_NUMBER = 6;
    private long incentivesAccumulatorPoolIdMigrationThreshold_ = 0L;
    /**
     * <code>uint64 incentives_accumulator_pool_id_migration_threshold = 6 [json_name = "incentivesAccumulatorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"incentives_accumulator_pool_id_migration_threshold&#92;""];</code>
     * @return The incentivesAccumulatorPoolIdMigrationThreshold.
     */
    @java.lang.Override
    public long getIncentivesAccumulatorPoolIdMigrationThreshold() {
      return incentivesAccumulatorPoolIdMigrationThreshold_;
    }

    public static final int SPREAD_FACTOR_POOL_ID_MIGRATION_THRESHOLD_FIELD_NUMBER = 7;
    private long spreadFactorPoolIdMigrationThreshold_ = 0L;
    /**
     * <code>uint64 spread_factor_pool_id_migration_threshold = 7 [json_name = "spreadFactorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"spread_factor_pool_id_migration_threshold&#92;""];</code>
     * @return The spreadFactorPoolIdMigrationThreshold.
     */
    @java.lang.Override
    public long getSpreadFactorPoolIdMigrationThreshold() {
      return spreadFactorPoolIdMigrationThreshold_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nextIncentiveRecordId_ != 0L) {
        output.writeUInt64(5, nextIncentiveRecordId_);
      }
      if (incentivesAccumulatorPoolIdMigrationThreshold_ != 0L) {
        output.writeUInt64(6, incentivesAccumulatorPoolIdMigrationThreshold_);
      }
      if (spreadFactorPoolIdMigrationThreshold_ != 0L) {
        output.writeUInt64(7, spreadFactorPoolIdMigrationThreshold_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (nextIncentiveRecordId_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(5, nextIncentiveRecordId_);
      }
      if (incentivesAccumulatorPoolIdMigrationThreshold_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(6, incentivesAccumulatorPoolIdMigrationThreshold_);
      }
      if (spreadFactorPoolIdMigrationThreshold_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(7, spreadFactorPoolIdMigrationThreshold_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNextIncentiveRecordId()
          != other.getNextIncentiveRecordId()) return false;
      if (getIncentivesAccumulatorPoolIdMigrationThreshold()
          != other.getIncentivesAccumulatorPoolIdMigrationThreshold()) return false;
      if (getSpreadFactorPoolIdMigrationThreshold()
          != other.getSpreadFactorPoolIdMigrationThreshold()) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getNextPositionId());
      hash = (37 * hash) + NEXT_INCENTIVE_RECORD_ID_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getNextIncentiveRecordId());
      hash = (37 * hash) + INCENTIVES_ACCUMULATOR_POOL_ID_MIGRATION_THRESHOLD_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getIncentivesAccumulatorPoolIdMigrationThreshold());
      hash = (37 * hash) + SPREAD_FACTOR_POOL_ID_MIGRATION_THRESHOLD_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getSpreadFactorPoolIdMigrationThreshold());
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        bitField0_ = (bitField0_ & ~0x00000004);
        nextPositionId_ = 0L;
        nextIncentiveRecordId_ = 0L;
        incentivesAccumulatorPoolIdMigrationThreshold_ = 0L;
        spreadFactorPoolIdMigrationThreshold_ = 0L;
        return this;
      }
      ...
      private void buildPartial0(com.osmosis.concentratedliquidity.v1beta1.GenesisProto.GenesisState result) {
        ...
        if (((from_bitField0_ & 0x00000010) != 0)) {
          result.nextIncentiveRecordId_ = nextIncentiveRecordId_;
        }
        if (((from_bitField0_ & 0x00000020) != 0)) {
          result.incentivesAccumulatorPoolIdMigrationThreshold_ = incentivesAccumulatorPoolIdMigrationThreshold_;
        }
        if (((from_bitField0_ & 0x00000040) != 0)) {
          result.spreadFactorPoolIdMigrationThreshold_ = spreadFactorPoolIdMigrationThreshold_;
        }
      }
      ...
      public Builder mergeFrom(com.osmosis.concentratedliquidity.v1beta1.GenesisProto.GenesisState other) {
        ...
        if (other.getNextIncentiveRecordId() != 0L) {
          setNextIncentiveRecordId(other.getNextIncentiveRecordId());
        }
        if (other.getIncentivesAccumulatorPoolIdMigrationThreshold() != 0L) {
          setIncentivesAccumulatorPoolIdMigrationThreshold(other.getIncentivesAccumulatorPoolIdMigrationThreshold());
        }
        if (other.getSpreadFactorPoolIdMigrationThreshold() != 0L) {
          setSpreadFactorPoolIdMigrationThreshold(other.getSpreadFactorPoolIdMigrationThreshold());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 40: {
                nextIncentiveRecordId_ = input.readUInt64();
                bitField0_ |= 0x00000010;
                break;
              } // case 40
              case 48: {
                incentivesAccumulatorPoolIdMigrationThreshold_ = input.readUInt64();
                bitField0_ |= 0x00000020;
                break;
              } // case 48
              case 56: {
                spreadFactorPoolIdMigrationThreshold_ = input.readUInt64();
      ...
      private long nextIncentiveRecordId_ ;
      /**
       * <code>uint64 next_incentive_record_id = 5 [json_name = "nextIncentiveRecordId", (.gogoproto.moretags) = "yaml:&#92;"next_incentive_record_id&#92;""];</code>
       * @return The nextIncentiveRecordId.
       */
      ...
      /**
       * <code>uint64 next_incentive_record_id = 5 [json_name = "nextIncentiveRecordId", (.gogoproto.moretags) = "yaml:&#92;"next_incentive_record_id&#92;""];</code>
       * @param value The nextIncentiveRecordId to set.
       * @return This builder for chaining.
       */
      public Builder setNextIncentiveRecordId(long value) {

        nextIncentiveRecordId_ = value;
        bitField0_ |= 0x00000010;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearNextIncentiveRecordId() {
        bitField0_ = (bitField0_ & ~0x00000010);
        nextIncentiveRecordId_ = 0L;
        onChanged();
        return this;
      ...
      private long incentivesAccumulatorPoolIdMigrationThreshold_ ;
      /**
       * <code>uint64 incentives_accumulator_pool_id_migration_threshold = 6 [json_name = "incentivesAccumulatorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"incentives_accumulator_pool_id_migration_threshold&#92;""];</code>
       * @return The incentivesAccumulatorPoolIdMigrationThreshold.
       */
      ...
      /**
       * <code>uint64 incentives_accumulator_pool_id_migration_threshold = 6 [json_name = "incentivesAccumulatorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"incentives_accumulator_pool_id_migration_threshold&#92;""];</code>
       * @param value The incentivesAccumulatorPoolIdMigrationThreshold to set.
       * @return This builder for chaining.
       */
      public Builder setIncentivesAccumulatorPoolIdMigrationThreshold(long value) {

        incentivesAccumulatorPoolIdMigrationThreshold_ = value;
        bitField0_ |= 0x00000020;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearIncentivesAccumulatorPoolIdMigrationThreshold() {
      ...
      private long spreadFactorPoolIdMigrationThreshold_ ;
      /**
       * <code>uint64 spread_factor_pool_id_migration_threshold = 7 [json_name = "spreadFactorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"spread_factor_pool_id_migration_threshold&#92;""];</code>
       * @return The spreadFactorPoolIdMigrationThreshold.
       */
      ...
      /**
       * <code>uint64 spread_factor_pool_id_migration_threshold = 7 [json_name = "spreadFactorPoolIdMigrationThreshold", (.gogoproto.moretags) = "yaml:&#92;"spread_factor_pool_id_migration_threshold&#92;""];</code>
       * @param value The spreadFactorPoolIdMigrationThreshold to set.
       * @return This builder for chaining.
       */
      public Builder setSpreadFactorPoolIdMigrationThreshold(long value) {

        spreadFactorPoolIdMigrationThreshold_ = value;
        bitField0_ |= 0x00000040;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearSpreadFactorPoolIdMigrationThreshold() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3osmosis/concentratedliquidity/v1beta1/" +
      "genesis.proto\022%osmosis.concentratedliqui" +
      "dity.v1beta1\032\024gogoproto/gogo.proto\032\031cosm" +
      "os_proto/cosmos.proto\032\031google/protobuf/a" +
      "ny.proto\032!osmosis/accum/v1beta1/accum.pr" +
      "oto\032*osmosis/concentratedliquidity/param" +
      "s.proto\0324osmosis/concentratedliquidity/v" +
      "1beta1/position.proto\0325osmosis/concentra" +
      "tedliquidity/v1beta1/tick_info.proto\032<os" +
      "mosis/concentratedliquidity/v1beta1/ince" +
      "ntive_record.proto\"\314\001\n\010FullTick\022+\n\007pool_" +
      "id\030\001 \001(\004B\022\362\336\037\016yaml:\"pool_id\"R\006poolId\0224\n\n" +
      "tick_index\030\002 \001(\003B\025\362\336\037\021yaml:\"tick_index\"R" +
      "\ttickIndex\022]\n\004info\030\003 \001(\0132/.osmosis.conce" +
      "ntratedliquidity.v1beta1.TickInfoB\030\310\336\037\000\362" +
      "\336\037\020yaml:\"tick_info\"R\004info\"\267\004\n\010PoolData\0223" +
      "\n\004pool\030\001 \001(\0132\024.google.protobuf.AnyB\t\312\264-\005" +
      "PoolIR\004pool\022[\n\005ticks\030\002 \003(\0132/.osmosis.con" +
      "centratedliquidity.v1beta1.FullTickB\024\310\336\037" +
      "\000\362\336\037\014yaml:\"ticks\"R\005ticks\022\230\001\n\031spread_rewa" +
      "rd_accumulator\030\003 \001(\01322.osmosis.concentra" +
      "tedliquidity.v1beta1.AccumObjectB(\310\336\037\000\362\336" +
      "\037 yaml:\"spread_reward_accumulator\"R\027spre" +
      "adRewardAccumulator\022\222\001\n\027incentives_accum" +
      "ulators\030\004 \003(\01322.osmosis.concentratedliqu" +
      "idity.v1beta1.AccumObjectB%\310\336\037\000\362\336\037\035yaml:" +
      "\"incentives_accumulator\"R\026incentivesAccu" +
      "mulators\022i\n\021incentive_records\030\005 \003(\01326.os" +
      "mosis.concentratedliquidity.v1beta1.Ince" +
      "ntiveRecordB\004\310\336\037\000R\020incentiveRecords\"\301\002\n\014" +
      "PositionData\022K\n\010position\030\001 \001(\0132/.osmosis" +
      ".concentratedliquidity.v1beta1.PositionR" +
      "\010position\022+\n\007lock_id\030\002 \001(\004B\022\362\336\037\016yaml:\"lo" +
      "ck_id\"R\006lockId\022`\n\032spread_reward_accum_re" +
      "cord\030\003 \001(\0132\035.osmosis.accum.v1beta1.Recor" +
      "dB\004\310\336\037\000R\027spreadRewardAccumRecord\022U\n\024upti" +
      "me_accum_records\030\004 \003(\0132\035.osmosis.accum.v" +
      "1beta1.RecordB\004\310\336\037\000R\022uptimeAccumRecords\"" +
      "\347\005\n\014GenesisState\022C\n\006params\030\001 \001(\0132%.osmos" +
      "is.concentratedliquidity.ParamsB\004\310\336\037\000R\006p" +
      "arams\022R\n\tpool_data\030\002 \003(\0132/.osmosis.conce" +
      "ntratedliquidity.v1beta1.PoolDataB\004\310\336\037\000R" +
      "\010poolData\022^\n\rposition_data\030\003 \003(\01323.osmos" +
      "is.concentratedliquidity.v1beta1.Positio" +
      "nDataB\004\310\336\037\000R\014positionData\022E\n\020next_positi" +
      "on_id\030\004 \001(\004B\033\362\336\037\027yaml:\"next_position_id\"" +
      "R\016nextPositionId\022\\\n\030next_incentive_recor" +
      "d_id\030\005 \001(\004B#\362\336\037\037yaml:\"next_incentive_rec" +
      "ord_id\"R\025nextIncentiveRecordId\022\250\001\n2incen" +
      "tives_accumulator_pool_id_migration_thre" +
      "shold\030\006 \001(\004B=\362\336\0379yaml:\"incentives_accumu" +
      "lator_pool_id_migration_threshold\"R-ince" +
      "ntivesAccumulatorPoolIdMigrationThreshol" +
      "d\022\215\001\n)spread_factor_pool_id_migration_th" +
      "reshold\030\007 \001(\004B4\362\336\0370yaml:\"spread_factor_p" +
      "ool_id_migration_threshold\"R$spreadFacto" +
      "rPoolIdMigrationThreshold\"\202\001\n\013AccumObjec" +
      "t\022#\n\004name\030\001 \001(\tB\017\362\336\037\013yaml:\"name\"R\004name\022N" +
      "\n\raccum_content\030\002 \001(\0132).osmosis.accum.v1" +
      "beta1.AccumulatorContentR\014accumContentB\271" +
      "\002\n)com.osmosis.concentratedliquidity.v1b" +
      "eta1B\014GenesisProtoZJgithub.com/osmosis-l" +
      "abs/osmosis/v26/x/concentrated-liquidity" +
      "/types/genesis\242\002\003OCX\252\002%Osmosis.Concentra" +
      "tedliquidity.V1beta1\312\002%Osmosis\\Concentra" +
      "tedliquidity\\V1beta1\342\0021Osmosis\\Concentra" +
      "tedliquidity\\V1beta1\\GPBMetadata\352\002\'Osmos" +
      "is::Concentratedliquidity::V1beta1b\006prot" +
      "o3"
    };
    ...
    internal_static_osmosis_concentratedliquidity_v1beta1_PositionData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_osmosis_concentratedliquidity_v1beta1_PositionData_descriptor,
        new java.lang.String[] { "Position", "LockId", "SpreadRewardAccumRecord", "UptimeAccumRecords", });
    internal_static_osmosis_concentratedliquidity_v1beta1_GenesisState_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_osmosis_concentratedliquidity_v1beta1_GenesisState_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_osmosis_concentratedliquidity_v1beta1_GenesisState_descriptor,
        new java.lang.String[] { "Params", "PoolData", "PositionData", "NextPositionId", "NextIncentiveRecordId", "IncentivesAccumulatorPoolIdMigrationThreshold", "SpreadFactorPoolIdMigrationThreshold", });
    internal_static_osmosis_concentratedliquidity_v1beta1_AccumObject_descriptor =
