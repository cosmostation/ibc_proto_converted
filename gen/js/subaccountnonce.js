...
goog.provide('proto.injective.exchange.v1beta1.SubaccountNonce');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.exchange.v1beta1.SubaccountTradeNonce');
...
proto.injective.exchange.v1beta1.SubaccountNonce.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    subaccountTradeNonce: (f = msg.getSubaccountTradeNonce()) && proto.injective.exchange.v1beta1.SubaccountTradeNonce.toObject(includeInstance, f)
  };
...
proto.injective.exchange.v1beta1.SubaccountNonce.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.injective.exchange.v1beta1.SubaccountTradeNonce;
      reader.readMessage(value,proto.injective.exchange.v1beta1.SubaccountTradeNonce.deserializeBinaryFromReader);
...
proto.injective.exchange.v1beta1.SubaccountNonce.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.injective.exchange.v1beta1.SubaccountTradeNonce.serializeBinaryToWriter
    );
  }
};
...
proto.injective.exchange.v1beta1.SubaccountNonce.prototype.getSubaccountTradeNonce = function() {
  return /** @type{?proto.injective.exchange.v1beta1.SubaccountTradeNonce} */ (
    jspb.Message.getWrapperField(this, proto.injective.exchange.v1beta1.SubaccountTradeNonce, 2));
};
