...
struct Akash_Market_V1beta2_GenesisState {
  ...
  var leases: [Akash_Market_V1beta2_Lease] = []

  var params: Akash_Market_V1beta2_Params {
    get {return _params ?? Akash_Market_V1beta2_Params()}
  ...
  fileprivate var _params: Akash_Market_V1beta2_Params? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Akash_Market_V1beta2_GenesisState: @unchecked Sendable {}
...
extension Akash_Market_V1beta2_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Market_V1beta2_GenesisState, rhs: Akash_Market_V1beta2_GenesisState) -> Bool {
