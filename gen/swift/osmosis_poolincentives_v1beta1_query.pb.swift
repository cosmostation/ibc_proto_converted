...
struct Osmosis_Poolincentives_V1beta1_QueryGaugeIdsResponse {
  ...
  struct GaugeIdWithDuration {
    ...
    var gaugeIncentivePercentage: String = String()
...
struct Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryExternalIncentiveGaugesRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesRequest, rhs: Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryExternalIncentiveGaugesResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "data"),
  ]
  ...
  static func ==(lhs: Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesResponse, rhs: Osmosis_Poolincentives_V1beta1_QueryExternalIncentiveGaugesResponse) -> Bool {
