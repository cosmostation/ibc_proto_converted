...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUERYDEALSRESPONSE'].fields_by_name['deals']._options = None
  _globals['_QUERYDEALSRESPONSE'].fields_by_name['deals']._serialized_options = b'\310\336\037\000'
  ...
  _globals['_QUERY'].methods_by_name['Deal']._serialized_options = b'\202\323\344\223\002,\022*/panacea/datadeal/v2alpha1/deals/{deal_id}'
  _globals['_QUERY'].methods_by_name['Deals']._options = None
  _globals['_QUERY'].methods_by_name['Deals']._serialized_options = b'\202\323\344\223\002\"\022 /panacea/datadeal/v2alpha1/deals'
  _globals['_QUERY'].methods_by_name['DataCert']._options = None
  _globals['_QUERY'].methods_by_name['DataCert']._serialized_options = b'\202\323\344\223\002C\022A/panacea/datadeal/v2alpha1/deals/{deal_id}/data_certs/{data_hash}'
  _globals['_QUERY'].methods_by_name['DataCerts']._options = None
  _globals['_QUERY'].methods_by_name['DataCerts']._serialized_options = b'\202\323\344\223\0027\0225/panacea/datadeal/v2alpha1/deals/{deal_id}/data_certs'
