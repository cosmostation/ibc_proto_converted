...
struct Likechain_Likenft_V1_Offer {
...
struct Likechain_Likenft_V1_OfferStoreRecord {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Likechain_Likenft_V1_Offer: @unchecked Sendable {}
extension Likechain_Likenft_V1_OfferStoreRecord: @unchecked Sendable {}
...
extension Likechain_Likenft_V1_Offer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Likechain_Likenft_V1_Offer, rhs: Likechain_Likenft_V1_Offer) -> Bool {
...
extension Likechain_Likenft_V1_OfferStoreRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OfferStoreRecord"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "class_id"),
    2: .standard(proto: "nft_id"),
    3: .same(proto: "buyer"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularStringField(value: &self.classID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.nftID) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.buyer) }()
      case 4: try { try decoder.decodeSingularUInt64Field(value: &self.price) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._expiration) }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.buyer.isEmpty {
      try visitor.visitSingularBytesField(value: self.buyer, fieldNumber: 3)
    }
    if self.price != 0 {
      try visitor.visitSingularUInt64Field(value: self.price, fieldNumber: 4)
    }
  ...
  static func ==(lhs: Likechain_Likenft_V1_OfferStoreRecord, rhs: Likechain_Likenft_V1_OfferStoreRecord) -> Bool {
    if lhs.classID != rhs.classID {return false}
    if lhs.nftID != rhs.nftID {return false}
    if lhs.buyer != rhs.buyer {return false}
    if lhs.price != rhs.price {return false}
