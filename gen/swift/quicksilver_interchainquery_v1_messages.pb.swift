...
struct Quicksilver_Interchainquery_V1_MsgSubmitQueryResponse {
...
/// type.
struct Quicksilver_Interchainquery_V1_MsgSubmitQueryResponseResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Quicksilver_Interchainquery_V1_MsgSubmitQueryResponse: @unchecked Sendable {}
extension Quicksilver_Interchainquery_V1_MsgSubmitQueryResponseResponse: @unchecked Sendable {}
...
extension Quicksilver_Interchainquery_V1_MsgSubmitQueryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_MsgSubmitQueryResponse, rhs: Quicksilver_Interchainquery_V1_MsgSubmitQueryResponse) -> Bool {
...
extension Quicksilver_Interchainquery_V1_MsgSubmitQueryResponseResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_MsgSubmitQueryResponseResponse, rhs: Quicksilver_Interchainquery_V1_MsgSubmitQueryResponseResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
