...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\024com.kava.cdp.v1beta1B\007TxProtoP\001Z%github.com/kava-labs/kava/x/cdp/types\242\002\003KCX\252\002\020Kava.Cdp.V1beta1\312\002\020Kava\\Cdp\\V1beta1\342\002\034Kava\\Cdp\\V1beta1\\GPBMetadata\352\002\022Kava::Cdp::V1beta1'
  _MSGCREATECDP.fields_by_name['sender']._options = None
  _MSGCREATECDP.fields_by_name['sender']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _MSGCREATECDP.fields_by_name['collateral']._options = None
  _MSGCREATECDP.fields_by_name['collateral']._serialized_options = b'\310\336\037\000'
  _MSGCREATECDP.fields_by_name['principal']._options = None
  _MSGCREATECDP.fields_by_name['principal']._serialized_options = b'\310\336\037\000'
  _MSGCREATECDPRESPONSE.fields_by_name['cdp_id']._options = None
  _MSGCREATECDPRESPONSE.fields_by_name['cdp_id']._serialized_options = b'\342\336\037\005CdpID'
  ...
  _MSGDEPOSIT.fields_by_name['owner']._options = None
  _MSGDEPOSIT.fields_by_name['owner']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _MSGDEPOSIT.fields_by_name['collateral']._options = None
  _MSGDEPOSIT.fields_by_name['collateral']._serialized_options = b'\310\336\037\000'
  ...
  _MSGWITHDRAW.fields_by_name['owner']._options = None
  _MSGWITHDRAW.fields_by_name['owner']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _MSGWITHDRAW.fields_by_name['collateral']._options = None
  _MSGWITHDRAW.fields_by_name['collateral']._serialized_options = b'\310\336\037\000'
  _MSGDRAWDEBT.fields_by_name['sender']._options = None
  _MSGDRAWDEBT.fields_by_name['sender']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _MSGDRAWDEBT.fields_by_name['principal']._options = None
  _MSGDRAWDEBT.fields_by_name['principal']._serialized_options = b'\310\336\037\000'
  _MSGREPAYDEBT.fields_by_name['sender']._options = None
  _MSGREPAYDEBT.fields_by_name['sender']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _MSGREPAYDEBT.fields_by_name['payment']._options = None
  _MSGREPAYDEBT.fields_by_name['payment']._serialized_options = b'\310\336\037\000'
