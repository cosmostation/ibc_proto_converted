...
struct Axelar_Reward_V1beta1_RefundMsgRequest {
  ...
  var innerMessage: SwiftProtobuf.Google_Protobuf_Any {
    get {return _innerMessage ?? SwiftProtobuf.Google_Protobuf_Any()}
  ...
  fileprivate var _innerMessage: SwiftProtobuf.Google_Protobuf_Any? = nil
}
...
extension Axelar_Reward_V1beta1_RefundMsgRequest: @unchecked Sendable {}
extension Axelar_Reward_V1beta1_RefundMsgResponse: @unchecked Sendable {}
...
extension Axelar_Reward_V1beta1_RefundMsgRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._innerMessage {
