...
goog.provide('proto.cosmos.crypto.keyring.v1.Record');
goog.provide('proto.cosmos.crypto.keyring.v1.Record.ItemCase');
goog.provide('proto.cosmos.crypto.keyring.v1.Record.Ledger');
goog.provide('proto.cosmos.crypto.keyring.v1.Record.Local');
goog.provide('proto.cosmos.crypto.keyring.v1.Record.Multi');
goog.provide('proto.cosmos.crypto.keyring.v1.Record.Offline');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.crypto.hd.v1.BIP44Params');
...
proto.cosmos.crypto.keyring.v1.Record.Local.toObject = function(includeInstance, msg) {
  var f, obj = {
    privKey: (f = msg.getPrivKey()) && proto.google.protobuf.Any.toObject(includeInstance, f)
  };
...
proto.cosmos.crypto.keyring.v1.Record.Ledger.toObject = function(includeInstance, msg) {
  var f, obj = {
    path: (f = msg.getPath()) && proto.cosmos.crypto.hd.v1.BIP44Params.toObject(includeInstance, f)
  };
...
proto.cosmos.crypto.keyring.v1.Record.Ledger.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.crypto.hd.v1.BIP44Params;
      reader.readMessage(value,proto.cosmos.crypto.hd.v1.BIP44Params.deserializeBinaryFromReader);
      msg.setPath(value);
      break;
    default:
      reader.skipField();
...
proto.cosmos.crypto.keyring.v1.Record.Ledger.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.cosmos.crypto.hd.v1.BIP44Params.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.crypto.keyring.v1.Record.Ledger.prototype.getPath = function() {
  return /** @type{?proto.cosmos.crypto.hd.v1.BIP44Params} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.crypto.hd.v1.BIP44Params, 1));
};
