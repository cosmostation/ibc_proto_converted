...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MSGGOVUPDATEMINGASPRICE'].fields_by_name['authority']._options = None
  _globals['_MSGGOVUPDATEMINGASPRICE'].fields_by_name['authority']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_MSGGOVUPDATEMINGASPRICE'].fields_by_name['min_gas_price']._options = None
  _globals['_MSGGOVUPDATEMINGASPRICE'].fields_by_name['min_gas_price']._serialized_options = b'\310\336\037\000'
  _globals['_MSGGOVUPDATEMINGASPRICE']._options = None
  _globals['_MSGGOVUPDATEMINGASPRICE']._serialized_options = b'\230\240\037\000\202\347\260*\tauthority'
