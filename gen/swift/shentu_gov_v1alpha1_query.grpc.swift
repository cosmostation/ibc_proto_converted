...
internal protocol Shentu_Gov_V1alpha1_QueryClientProtocol: GRPCClient {
  ...
  func params(
    ...
    callOptions: CallOptions?
  ) -> UnaryCall<Cosmos_Gov_V1beta1_QueryParamsRequest, Shentu_Gov_V1alpha1_QueryParamsResponse>
  ...
  func certVoted(
    _ request: Shentu_Gov_V1alpha1_QueryCertVotedRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Shentu_Gov_V1alpha1_QueryCertVotedRequest, Shentu_Gov_V1alpha1_QueryCertVotedResponse>
}
...
extension Shentu_Gov_V1alpha1_QueryClientProtocol {
  ...
  internal func proposal(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.proposal.path,
      request: request,
  ...
  internal func proposals(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.proposals.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func vote(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.vote.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func votes(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.votes.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func params(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.params.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func deposit(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.deposit.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func deposits(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.deposits.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func tallyResult(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.tallyResult.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func certVoted(
    ...
    return self.makeUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.certVoted.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
extension Shentu_Gov_V1alpha1_QueryClient: @unchecked Sendable {}

@available(*, deprecated, renamed: "Shentu_Gov_V1alpha1_QueryNIOClient")
internal final class Shentu_Gov_V1alpha1_QueryClient: Shentu_Gov_V1alpha1_QueryClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  private var _interceptors: Shentu_Gov_V1alpha1_QueryClientInterceptorFactoryProtocol?
...
internal struct Shentu_Gov_V1alpha1_QueryNIOClient: Shentu_Gov_V1alpha1_QueryClientProtocol {
...
internal protocol Shentu_Gov_V1alpha1_QueryAsyncClientProtocol: GRPCClient {
  ...
  func makeParamsCall(
    _ request: Cosmos_Gov_V1beta1_QueryParamsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Cosmos_Gov_V1beta1_QueryParamsRequest, Shentu_Gov_V1alpha1_QueryParamsResponse>
  ...
  func makeCertVotedCall(
    _ request: Shentu_Gov_V1alpha1_QueryCertVotedRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Shentu_Gov_V1alpha1_QueryCertVotedRequest, Shentu_Gov_V1alpha1_QueryCertVotedResponse>
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Shentu_Gov_V1alpha1_QueryAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Shentu_Gov_V1alpha1_QueryClientMetadata.serviceDescriptor
  }
...
extension Shentu_Gov_V1alpha1_QueryAsyncClientProtocol {
  ...
  internal func params(
    _ request: Cosmos_Gov_V1beta1_QueryParamsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Shentu_Gov_V1alpha1_QueryParamsResponse {
    return try await self.performAsyncUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.params.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func certVoted(
    _ request: Shentu_Gov_V1alpha1_QueryCertVotedRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Shentu_Gov_V1alpha1_QueryCertVotedResponse {
    return try await self.performAsyncUnaryCall(
      path: Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.certVoted.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Shentu_Gov_V1alpha1_QueryAsyncClient: Shentu_Gov_V1alpha1_QueryAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Shentu_Gov_V1alpha1_QueryClientInterceptorFactoryProtocol?
...
internal protocol Shentu_Gov_V1alpha1_QueryClientInterceptorFactoryProtocol: Sendable {
  ...
  func makeParamsInterceptors() -> [ClientInterceptor<Cosmos_Gov_V1beta1_QueryParamsRequest, Shentu_Gov_V1alpha1_QueryParamsResponse>]
  ...
  func makeCertVotedInterceptors() -> [ClientInterceptor<Shentu_Gov_V1alpha1_QueryCertVotedRequest, Shentu_Gov_V1alpha1_QueryCertVotedResponse>]
}

internal enum Shentu_Gov_V1alpha1_QueryClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "shentu.gov.v1alpha1.Query",
    methods: [
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.proposal,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.proposals,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.vote,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.votes,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.params,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.deposit,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.deposits,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.tallyResult,
      Shentu_Gov_V1alpha1_QueryClientMetadata.Methods.certVoted,
    ]
  )
...
internal protocol Shentu_Gov_V1alpha1_QueryProvider: CallHandlerProvider {
  ...
  /// Params queries all parameters of the gov module.
  func params(request: Cosmos_Gov_V1beta1_QueryParamsRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Shentu_Gov_V1alpha1_QueryParamsResponse>
  ...
  /// Proposal queries proposal details based on ProposalID.
  func certVoted(request: Shentu_Gov_V1alpha1_QueryCertVotedRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Shentu_Gov_V1alpha1_QueryCertVotedResponse>
}

extension Shentu_Gov_V1alpha1_QueryProvider {
  internal var serviceName: Substring {
    return Shentu_Gov_V1alpha1_QueryServerMetadata.serviceDescriptor.fullName[...]
  }
  ...
  internal func handle(
    ...
    case "CertVoted":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Shentu_Gov_V1alpha1_QueryCertVotedRequest>(),
        responseSerializer: ProtobufSerializer<Shentu_Gov_V1alpha1_QueryCertVotedResponse>(),
        interceptors: self.interceptors?.makeCertVotedInterceptors() ?? [],
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Shentu_Gov_V1alpha1_QueryAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Shentu_Gov_V1alpha1_QueryServerInterceptorFactoryProtocol? { get }
  ...
  @Sendable func certVoted(
    request: Shentu_Gov_V1alpha1_QueryCertVotedRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Shentu_Gov_V1alpha1_QueryCertVotedResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Shentu_Gov_V1alpha1_QueryAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Shentu_Gov_V1alpha1_QueryServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Shentu_Gov_V1alpha1_QueryServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Shentu_Gov_V1alpha1_QueryServerInterceptorFactoryProtocol {
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeParamsInterceptors() -> [ServerInterceptor<Cosmos_Gov_V1beta1_QueryParamsRequest, Shentu_Gov_V1alpha1_QueryParamsResponse>]
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeCertVotedInterceptors() -> [ServerInterceptor<Shentu_Gov_V1alpha1_QueryCertVotedRequest, Shentu_Gov_V1alpha1_QueryCertVotedResponse>]
}

internal enum Shentu_Gov_V1alpha1_QueryServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "shentu.gov.v1alpha1.Query",
    methods: [
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.proposal,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.proposals,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.vote,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.votes,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.params,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.deposit,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.deposits,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.tallyResult,
      Shentu_Gov_V1alpha1_QueryServerMetadata.Methods.certVoted,
    ]
  )
