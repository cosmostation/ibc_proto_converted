...
public final class MsgCreatorGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "osmosis.cosmwasmpool.v1beta1.model.MsgCreator";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool,
      com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> getCreateCosmWasmPoolMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateCosmWasmPool",
      requestType = com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool.class,
      responseType = com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool,
      com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> getCreateCosmWasmPoolMethod() {
    io.grpc.MethodDescriptor<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool, com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> getCreateCosmWasmPoolMethod;
      ...
      synchronized (MsgCreatorGrpc.class) {
        if ((getCreateCosmWasmPoolMethod = MsgCreatorGrpc.getCreateCosmWasmPoolMethod) == null) {
          MsgCreatorGrpc.getCreateCosmWasmPoolMethod = getCreateCosmWasmPoolMethod =
              io.grpc.MethodDescriptor.<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool, com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateCosmWasmPool"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createCosmWasmPool(com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool request,
        io.grpc.stub.StreamObserver<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> responseObserver) {
  ...
  public static final class MsgCreatorStub
    ...
    /**
     */
    public void createCosmWasmPool(com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool request,
        io.grpc.stub.StreamObserver<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> responseObserver) {
  ...
  public static final class MsgCreatorBlockingStub
    ...
    /**
     */
    public com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse createCosmWasmPool(com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool request) {
  ...
  public static final class MsgCreatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse> createCosmWasmPool(
        com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_COSM_WASM_POOL:
          serviceImpl.createCosmWasmPool((com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool) request,
              (io.grpc.stub.StreamObserver<com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPool,
              com.osmosis.cosmwasmpool.v1beta1.model.TxProto.MsgCreateCosmWasmPoolResponse>(
