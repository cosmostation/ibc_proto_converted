...
struct Osmosis_Concentratedliquidity_V1beta1_PositionData {
  ...
  var uptimeAccumRecords: [Osmosis_Accum_V1beta1_Record] = []
...
struct Osmosis_Concentratedliquidity_V1beta1_GenesisState {
  ...
  var nextIncentiveRecordID: UInt64 = 0

  var incentivesAccumulatorPoolIDMigrationThreshold: UInt64 = 0

  var spreadFactorPoolIDMigrationThreshold: UInt64 = 0
...
extension Osmosis_Concentratedliquidity_V1beta1_PositionData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "uptime_accum_records"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.uptimeAccumRecords) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.uptimeAccumRecords.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.uptimeAccumRecords, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_PositionData, rhs: Osmosis_Concentratedliquidity_V1beta1_PositionData) -> Bool {
    ...
    if lhs.uptimeAccumRecords != rhs.uptimeAccumRecords {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Osmosis_Concentratedliquidity_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .standard(proto: "next_incentive_record_id"),
    6: .standard(proto: "incentives_accumulator_pool_id_migration_threshold"),
    7: .standard(proto: "spread_factor_pool_id_migration_threshold"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularUInt64Field(value: &self.nextIncentiveRecordID) }()
      case 6: try { try decoder.decodeSingularUInt64Field(value: &self.incentivesAccumulatorPoolIDMigrationThreshold) }()
      case 7: try { try decoder.decodeSingularUInt64Field(value: &self.spreadFactorPoolIDMigrationThreshold) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.nextIncentiveRecordID != 0 {
      try visitor.visitSingularUInt64Field(value: self.nextIncentiveRecordID, fieldNumber: 5)
    }
    if self.incentivesAccumulatorPoolIDMigrationThreshold != 0 {
      try visitor.visitSingularUInt64Field(value: self.incentivesAccumulatorPoolIDMigrationThreshold, fieldNumber: 6)
    }
    if self.spreadFactorPoolIDMigrationThreshold != 0 {
      try visitor.visitSingularUInt64Field(value: self.spreadFactorPoolIDMigrationThreshold, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_GenesisState, rhs: Osmosis_Concentratedliquidity_V1beta1_GenesisState) -> Bool {
    ...
    if lhs.nextIncentiveRecordID != rhs.nextIncentiveRecordID {return false}
    if lhs.incentivesAccumulatorPoolIDMigrationThreshold != rhs.incentivesAccumulatorPoolIDMigrationThreshold {return false}
    if lhs.spreadFactorPoolIDMigrationThreshold != rhs.spreadFactorPoolIDMigrationThreshold {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
