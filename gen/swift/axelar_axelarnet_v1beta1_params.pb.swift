...
extension Axelar_Axelarnet_V1beta1_Params: @unchecked Sendable {}
...
extension Axelar_Axelarnet_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "transfer_limit"),
    4: .standard(proto: "end_blocker_limit"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.transferLimit) }()
      case 4: try { try decoder.decodeSingularUInt64Field(value: &self.endBlockerLimit) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.transferLimit != 0 {
      try visitor.visitSingularUInt64Field(value: self.transferLimit, fieldNumber: 3)
    }
    if self.endBlockerLimit != 0 {
      try visitor.visitSingularUInt64Field(value: self.endBlockerLimit, fieldNumber: 4)
    }
