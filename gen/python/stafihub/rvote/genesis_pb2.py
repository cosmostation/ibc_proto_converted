...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_GENESISSTATE'].fields_by_name['proposal_life']._options = None
  _globals['_GENESISSTATE'].fields_by_name['proposal_life']._serialized_options = b'\362\336\037\024yaml:\"proposal_life\"'
