...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PARAMS'].fields_by_name['distribution_per_block']._options = None
  _globals['_PARAMS'].fields_by_name['distribution_per_block']._serialized_options = b'\310\336\037\000'
