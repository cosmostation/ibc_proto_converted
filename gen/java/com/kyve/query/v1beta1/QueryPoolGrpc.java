...
public final class QueryPoolGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "kyve.query.v1beta1.QueryPool";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest,
      com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> getPoolsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Pools",
      requestType = com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest.class,
      responseType = com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest,
      com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> getPoolsMethod() {
    io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest, com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> getPoolsMethod;
      ...
      synchronized (QueryPoolGrpc.class) {
        if ((getPoolsMethod = QueryPoolGrpc.getPoolsMethod) == null) {
          QueryPoolGrpc.getPoolsMethod = getPoolsMethod =
              io.grpc.MethodDescriptor.<com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest, com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Pools"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest,
      com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> getPoolMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Pool",
      requestType = com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest.class,
      responseType = com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest,
      com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> getPoolMethod() {
    io.grpc.MethodDescriptor<com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest, com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> getPoolMethod;
    if ((getPoolMethod = QueryPoolGrpc.getPoolMethod) == null) {
      synchronized (QueryPoolGrpc.class) {
        if ((getPoolMethod = QueryPoolGrpc.getPoolMethod) == null) {
          QueryPoolGrpc.getPoolMethod = getPoolMethod =
              io.grpc.MethodDescriptor.<com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest, com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Pool"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void pools(com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> responseObserver) {
     ...
     * </pre>
     */
    default void pool(com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> responseObserver) {
  ...
  public static final class QueryPoolStub
     ...
     * </pre>
     */
    public void pools(com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> responseObserver) {
     ...
     * </pre>
     */
    public void pool(com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class QueryPoolBlockingStub
     ...
     * </pre>
     */
    public com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse pools(com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest request) {
     ...
     * </pre>
     */
    public com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse pool(com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class QueryPoolFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse> pools(
        com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse> pool(
        com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POOLS:
          serviceImpl.pools((com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest) request,
              (io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse>) responseObserver);
          break;
        case METHODID_POOL:
          serviceImpl.pool((com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest) request,
              (io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kyve.query.v1beta1.PoolsProto.QueryPoolsRequest,
              com.kyve.query.v1beta1.PoolsProto.QueryPoolsResponse>(
                service, METHODID_POOLS)))
        .addMethod(
          getPoolMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kyve.query.v1beta1.PoolsProto.QueryPoolRequest,
              com.kyve.query.v1beta1.PoolsProto.QueryPoolResponse>(
  ...
  private static final class QueryPoolMethodDescriptorSupplier
    ...
    QueryPoolMethodDescriptorSupplier(java.lang.String methodName) {
