...
struct Zrchain_Mint_Module_V1_Module {
...
extension Zrchain_Mint_Module_V1_Module: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "zrchain.mint.module.v1"

extension Zrchain_Mint_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Zrchain_Mint_Module_V1_Module, rhs: Zrchain_Mint_Module_V1_Module) -> Bool {
