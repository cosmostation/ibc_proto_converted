...
goog.provide('proto.cosmos.slashing.v1beta1.GenesisState');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.slashing.v1beta1.Params');
goog.require('proto.cosmos.slashing.v1beta1.SigningInfo');
goog.require('proto.cosmos.slashing.v1beta1.ValidatorMissedBlocks');
...
proto.cosmos.slashing.v1beta1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    params: (f = msg.getParams()) && proto.cosmos.slashing.v1beta1.Params.toObject(includeInstance, f),
...
proto.cosmos.slashing.v1beta1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.slashing.v1beta1.Params;
      reader.readMessage(value,proto.cosmos.slashing.v1beta1.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    case 2:
...
proto.cosmos.slashing.v1beta1.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.cosmos.slashing.v1beta1.Params.serializeBinaryToWriter
    );
  }
...
proto.cosmos.slashing.v1beta1.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.cosmos.slashing.v1beta1.Params} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.slashing.v1beta1.Params, 1));
};
