...
struct Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var beforeSendHookAddresses: [String] = []
...
extension Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesRequest: @unchecked Sendable {}
extension Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesResponse: @unchecked Sendable {}
...
extension Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryAllBeforeSendHooksAddressesRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesRequest, rhs: Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryAllBeforeSendHooksAddressesResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "denoms"),
    2: .standard(proto: "before_send_hook_addresses"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.denoms) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.beforeSendHookAddresses) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.beforeSendHookAddresses.isEmpty {
      try visitor.visitRepeatedStringField(value: self.beforeSendHookAddresses, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesResponse, rhs: Osmosis_Tokenfactory_V1beta1_QueryAllBeforeSendHooksAddressesResponse) -> Bool {
    if lhs.denoms != rhs.denoms {return false}
    if lhs.beforeSendHookAddresses != rhs.beforeSendHookAddresses {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
