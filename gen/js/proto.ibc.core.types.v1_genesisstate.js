...
goog.provide('proto.ibc.core.types.v1.GenesisState');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.ibc.core.channel.v1.GenesisState');
goog.require('proto.ibc.core.client.v1.GenesisState');
goog.require('proto.ibc.core.connection.v1.GenesisState');
...
proto.ibc.core.types.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    clientGenesis: (f = msg.getClientGenesis()) && proto.ibc.core.client.v1.GenesisState.toObject(includeInstance, f),
    connectionGenesis: (f = msg.getConnectionGenesis()) && proto.ibc.core.connection.v1.GenesisState.toObject(includeInstance, f),
    channelGenesis: (f = msg.getChannelGenesis()) && proto.ibc.core.channel.v1.GenesisState.toObject(includeInstance, f)
  };
...
proto.ibc.core.types.v1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.ibc.core.client.v1.GenesisState;
      reader.readMessage(value,proto.ibc.core.client.v1.GenesisState.deserializeBinaryFromReader);
      msg.setClientGenesis(value);
      break;
    case 2:
      var value = new proto.ibc.core.connection.v1.GenesisState;
      reader.readMessage(value,proto.ibc.core.connection.v1.GenesisState.deserializeBinaryFromReader);
      msg.setConnectionGenesis(value);
      break;
    case 3:
      var value = new proto.ibc.core.channel.v1.GenesisState;
      reader.readMessage(value,proto.ibc.core.channel.v1.GenesisState.deserializeBinaryFromReader);
...
proto.ibc.core.types.v1.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.ibc.core.client.v1.GenesisState.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.ibc.core.connection.v1.GenesisState.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.ibc.core.channel.v1.GenesisState.serializeBinaryToWriter
    );
  }
};
...
proto.ibc.core.types.v1.GenesisState.prototype.getClientGenesis = function() {
  return /** @type{?proto.ibc.core.client.v1.GenesisState} */ (
    jspb.Message.getWrapperField(this, proto.ibc.core.client.v1.GenesisState, 1));
};


/**
 * @param {?proto.ibc.core.client.v1.GenesisState|undefined} value
 * @return {!proto.ibc.core.types.v1.GenesisState} returns this
*/
...
proto.ibc.core.types.v1.GenesisState.prototype.getConnectionGenesis = function() {
  return /** @type{?proto.ibc.core.connection.v1.GenesisState} */ (
    jspb.Message.getWrapperField(this, proto.ibc.core.connection.v1.GenesisState, 2));
};
...
proto.ibc.core.types.v1.GenesisState.prototype.getChannelGenesis = function() {
  return /** @type{?proto.ibc.core.channel.v1.GenesisState} */ (
    jspb.Message.getWrapperField(this, proto.ibc.core.channel.v1.GenesisState, 3));
};
