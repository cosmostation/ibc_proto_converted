...
struct Osmosis_Concentratedliquidity_Params {
  ...
  var unrestrictedPoolCreatorWhitelist: [String] = []

  var hookGasLimit: UInt64 = 0
...
extension Osmosis_Concentratedliquidity_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "unrestricted_pool_creator_whitelist"),
    8: .standard(proto: "hook_gas_limit"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeRepeatedStringField(value: &self.unrestrictedPoolCreatorWhitelist) }()
      case 8: try { try decoder.decodeSingularUInt64Field(value: &self.hookGasLimit) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.unrestrictedPoolCreatorWhitelist.isEmpty {
      try visitor.visitRepeatedStringField(value: self.unrestrictedPoolCreatorWhitelist, fieldNumber: 7)
    }
    if self.hookGasLimit != 0 {
      try visitor.visitSingularUInt64Field(value: self.hookGasLimit, fieldNumber: 8)
    }
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_Params, rhs: Osmosis_Concentratedliquidity_Params) -> Bool {
    ...
    if lhs.unrestrictedPoolCreatorWhitelist != rhs.unrestrictedPoolCreatorWhitelist {return false}
    if lhs.hookGasLimit != rhs.hookGasLimit {return false}
