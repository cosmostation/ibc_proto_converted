...
class Query(object):
    ...
    def ModuleAccountBalance(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.airdrop.Query/ModuleAccountBalance',
            lum__network_dot_airdrop_dot_query__pb2.QueryModuleAccountBalanceRequest.SerializeToString,
            lum__network_dot_airdrop_dot_query__pb2.QueryModuleAccountBalanceResponse.FromString,
    ...
    def Params(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.airdrop.Query/Params',
            lum__network_dot_airdrop_dot_query__pb2.QueryParamsRequest.SerializeToString,
            lum__network_dot_airdrop_dot_query__pb2.QueryParamsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ClaimRecord(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.airdrop.Query/ClaimRecord',
            lum__network_dot_airdrop_dot_query__pb2.QueryClaimRecordRequest.SerializeToString,
            lum__network_dot_airdrop_dot_query__pb2.QueryClaimRecordResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ClaimableForAction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.airdrop.Query/ClaimableForAction',
            lum__network_dot_airdrop_dot_query__pb2.QueryClaimableForActionRequest.SerializeToString,
            lum__network_dot_airdrop_dot_query__pb2.QueryClaimableForActionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def TotalClaimable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.airdrop.Query/TotalClaimable',
            lum__network_dot_airdrop_dot_query__pb2.QueryTotalClaimableRequest.SerializeToString,
            lum__network_dot_airdrop_dot_query__pb2.QueryTotalClaimableResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
