...
struct Sentinel_Node_V2_Params {
  ...
  var revenueShare: String = String()
...
extension Sentinel_Node_V2_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "expiry_duration"),
    ...
    11: .standard(proto: "revenue_share"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._expiryDuration) }()
      ...
      case 11: try { try decoder.decodeSingularStringField(value: &self.revenueShare) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.revenueShare.isEmpty {
      try visitor.visitSingularStringField(value: self.revenueShare, fieldNumber: 11)
    }
  ...
  static func ==(lhs: Sentinel_Node_V2_Params, rhs: Sentinel_Node_V2_Params) -> Bool {
    ...
    if lhs.revenueShare != rhs.revenueShare {return false}
