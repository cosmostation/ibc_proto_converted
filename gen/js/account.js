...
goog.provide('proto.acm.Account');
...
goog.require('proto.permission.AccountPermissions');
...
proto.acm.Account.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    permissions: (f = msg.getPermissions()) && proto.permission.AccountPermissions.toObject(includeInstance, f),
...
proto.acm.Account.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.permission.AccountPermissions;
      reader.readMessage(value,proto.permission.AccountPermissions.deserializeBinaryFromReader);
...
proto.acm.Account.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.permission.AccountPermissions.serializeBinaryToWriter
    );
  }
...
proto.acm.Account.prototype.getPublickey = function() {
  return /** @type{?proto.crypto.PublicKey} */ (
    jspb.Message.getWrapperField(this, proto.crypto.PublicKey, 2));
};
...
proto.acm.Account.prototype.getPermissions = function() {
  return /** @type{?proto.permission.AccountPermissions} */ (
    jspb.Message.getWrapperField(this, proto.permission.AccountPermissions, 6));
};
