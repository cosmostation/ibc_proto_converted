...
goog.provide('proto.provenance.marker.v1.MsgAddFinalizeActivateMarkerRequest');
...
proto.provenance.marker.v1.MsgAddFinalizeActivateMarkerRequest.prototype.getAccessListList = function() {
  return /** @type{!Array<!proto.provenance.marker.v1.AccessGrant>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.provenance.marker.v1.AccessGrant, 6));
};
