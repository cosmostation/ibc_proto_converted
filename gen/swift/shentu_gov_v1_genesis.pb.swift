...
struct Shentu_Gov_V1_GenesisState {
  ...
  var customParams: Shentu_Gov_V1_CustomParams {
    get {return _storage._customParams ?? Shentu_Gov_V1_CustomParams()}
...
extension Shentu_Gov_V1_GenesisState: @unchecked Sendable {}
...
extension Shentu_Gov_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "custom_params"),
    11: .standard(proto: "cert_voted_proposal_ids"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _customParams: Shentu_Gov_V1_CustomParams? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._customParams) }()
        case 11: try { try decoder.decodeRepeatedUInt64Field(value: &_storage._certVotedProposalIds) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._certVotedProposalIds.isEmpty {
        try visitor.visitPackedUInt64Field(value: _storage._certVotedProposalIds, fieldNumber: 11)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Shentu_Gov_V1_GenesisState, rhs: Shentu_Gov_V1_GenesisState) -> Bool {
