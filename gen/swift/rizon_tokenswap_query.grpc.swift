...
extension Rizonworld_Rizon_Tokenswap_QueryClientProtocol {
  ...
  internal func tokenswap(
    ...
    return self.makeUnaryCall(
      path: Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.tokenswap.path,
      request: request,
  ...
  internal func swappedAmount(
    ...
    return self.makeUnaryCall(
      path: Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.swappedAmount.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func params(
    ...
    return self.makeUnaryCall(
      path: Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.params.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
extension Rizonworld_Rizon_Tokenswap_QueryClient: @unchecked Sendable {}

@available(*, deprecated, renamed: "Rizonworld_Rizon_Tokenswap_QueryNIOClient")
internal final class Rizonworld_Rizon_Tokenswap_QueryClient: Rizonworld_Rizon_Tokenswap_QueryClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  private var _interceptors: Rizonworld_Rizon_Tokenswap_QueryClientInterceptorFactoryProtocol?
...
internal struct Rizonworld_Rizon_Tokenswap_QueryNIOClient: Rizonworld_Rizon_Tokenswap_QueryClientProtocol {
...
internal protocol Rizonworld_Rizon_Tokenswap_QueryAsyncClientProtocol: GRPCClient {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Rizonworld_Rizon_Tokenswap_QueryClientInterceptorFactoryProtocol? { get }

  func makeTokenswapCall(
    _ request: Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest, Rizonworld_Rizon_Tokenswap_QueryTokenswapResponse>

  func makeSwappedAmountCall(
    _ request: Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest, Rizonworld_Rizon_Tokenswap_QuerySwappedAmountResponse>

  func makeParamsCall(
    _ request: Rizonworld_Rizon_Tokenswap_QueryParamsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Rizonworld_Rizon_Tokenswap_QueryParamsRequest, Rizonworld_Rizon_Tokenswap_QueryParamsResponse>
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Rizonworld_Rizon_Tokenswap_QueryAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Rizonworld_Rizon_Tokenswap_QueryClientMetadata.serviceDescriptor
  }
  ...
  internal func makeTokenswapCall(
    _ request: Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest, Rizonworld_Rizon_Tokenswap_QueryTokenswapResponse> {
  ...
  internal func makeSwappedAmountCall(
    _ request: Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest, Rizonworld_Rizon_Tokenswap_QuerySwappedAmountResponse> {
    return self.makeAsyncUnaryCall(
...
extension Rizonworld_Rizon_Tokenswap_QueryAsyncClientProtocol {
  internal func tokenswap(
    _ request: Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Rizonworld_Rizon_Tokenswap_QueryTokenswapResponse {
  ...
  internal func swappedAmount(
    _ request: Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Rizonworld_Rizon_Tokenswap_QuerySwappedAmountResponse {
    return try await self.performAsyncUnaryCall(
      path: Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.swappedAmount.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func params(
    _ request: Rizonworld_Rizon_Tokenswap_QueryParamsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Rizonworld_Rizon_Tokenswap_QueryParamsResponse {
    return try await self.performAsyncUnaryCall(
      path: Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.params.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Rizonworld_Rizon_Tokenswap_QueryAsyncClient: Rizonworld_Rizon_Tokenswap_QueryAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Rizonworld_Rizon_Tokenswap_QueryClientInterceptorFactoryProtocol?
...
internal protocol Rizonworld_Rizon_Tokenswap_QueryClientInterceptorFactoryProtocol: Sendable {
...
internal enum Rizonworld_Rizon_Tokenswap_QueryClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "rizonworld.rizon.tokenswap.Query",
    methods: [
      Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.tokenswap,
      Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.swappedAmount,
      Rizonworld_Rizon_Tokenswap_QueryClientMetadata.Methods.params,
    ]
  )

  internal enum Methods {
    internal static let tokenswap = GRPCMethodDescriptor(
      name: "Tokenswap",
      path: "/rizonworld.rizon.tokenswap.Query/Tokenswap",
      type: GRPCCallType.unary
    )

    internal static let swappedAmount = GRPCMethodDescriptor(
      name: "SwappedAmount",
...
extension Rizonworld_Rizon_Tokenswap_QueryProvider {
  internal var serviceName: Substring {
    return Rizonworld_Rizon_Tokenswap_QueryServerMetadata.serviceDescriptor.fullName[...]
  }
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Rizonworld_Rizon_Tokenswap_QueryAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Rizonworld_Rizon_Tokenswap_QueryServerInterceptorFactoryProtocol? { get }

  /// Tokenswap queries tokenswap item for given tx hash
  @Sendable func tokenswap(
    request: Rizonworld_Rizon_Tokenswap_QueryTokenswapRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Rizonworld_Rizon_Tokenswap_QueryTokenswapResponse

  /// SwappedAmount queries current swapped amount of tokenswap
  @Sendable func swappedAmount(
    request: Rizonworld_Rizon_Tokenswap_QuerySwappedAmountRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Rizonworld_Rizon_Tokenswap_QuerySwappedAmountResponse

  /// Params queries parameters of tokenswap
  @Sendable func params(
    request: Rizonworld_Rizon_Tokenswap_QueryParamsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Rizonworld_Rizon_Tokenswap_QueryParamsResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Rizonworld_Rizon_Tokenswap_QueryAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Rizonworld_Rizon_Tokenswap_QueryServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Rizonworld_Rizon_Tokenswap_QueryServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "Tokenswap":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Rizonworld_Rizon_Tokenswap_QueryTokenswapResponse>(),
        interceptors: self.interceptors?.makeTokenswapInterceptors() ?? [],
        wrapping: self.tokenswap(request:context:)
      )
    ...
    case "SwappedAmount":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Rizonworld_Rizon_Tokenswap_QuerySwappedAmountResponse>(),
        interceptors: self.interceptors?.makeSwappedAmountInterceptors() ?? [],
        wrapping: self.swappedAmount(request:context:)
      )
...
internal enum Rizonworld_Rizon_Tokenswap_QueryServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "rizonworld.rizon.tokenswap.Query",
    methods: [
      Rizonworld_Rizon_Tokenswap_QueryServerMetadata.Methods.tokenswap,
      Rizonworld_Rizon_Tokenswap_QueryServerMetadata.Methods.swappedAmount,
      Rizonworld_Rizon_Tokenswap_QueryServerMetadata.Methods.params,
    ]
  )
