...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FEEINFO.fields_by_name['packet_id']._options = None
  _FEEINFO.fields_by_name['packet_id']._serialized_options = b'\310\336\037\000'
  _FEEINFO.fields_by_name['fee']._options = None
  _FEEINFO.fields_by_name['fee']._serialized_options = b'\310\336\037\000'
