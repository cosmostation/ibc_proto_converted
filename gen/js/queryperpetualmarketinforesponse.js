...
goog.provide('proto.injective.exchange.v1beta1.QueryPerpetualMarketInfoResponse');
...
proto.injective.exchange.v1beta1.QueryPerpetualMarketInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    info: (f = msg.getInfo()) && proto.injective.exchange.v1beta1.PerpetualMarketInfo.toObject(includeInstance, f)
  };
