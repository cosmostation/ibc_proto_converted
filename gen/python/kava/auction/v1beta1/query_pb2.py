...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUERYAUCTIONREQUEST']._options = None
  _globals['_QUERYAUCTIONREQUEST']._serialized_options = b'\210\240\037\000\350\240\037\000'
  _globals['_QUERYAUCTIONSREQUEST']._options = None
  _globals['_QUERYAUCTIONSREQUEST']._serialized_options = b'\210\240\037\000\350\240\037\000'
  _globals['_QUERY'].methods_by_name['Params']._options = None
  _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\202\323\344\223\002\036\022\034/kava/auction/v1beta1/params'
  _globals['_QUERY'].methods_by_name['Auction']._options = None
  _globals['_QUERY'].methods_by_name['Auction']._serialized_options = b'\202\323\344\223\002-\022+/kava/auction/v1beta1/auctions/{auction_id}'
  _globals['_QUERY'].methods_by_name['Auctions']._options = None
  _globals['_QUERY'].methods_by_name['Auctions']._serialized_options = b'\202\323\344\223\002 \022\036/kava/auction/v1beta1/auctions'
  _globals['_QUERY'].methods_by_name['NextAuctionID']._options = None
  _globals['_QUERY'].methods_by_name['NextAuctionID']._serialized_options = b'\202\323\344\223\002\'\022%/kava/auction/v1beta1/next-auction-id'
