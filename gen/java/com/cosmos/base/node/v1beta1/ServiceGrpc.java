...
public final class ServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.ConfigRequest,
      com.cosmos.base.node.v1beta1.ConfigResponse> getConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Config",
      requestType = com.cosmos.base.node.v1beta1.ConfigRequest.class,
      responseType = com.cosmos.base.node.v1beta1.ConfigResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.ConfigRequest,
      com.cosmos.base.node.v1beta1.ConfigResponse> getConfigMethod() {
    io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.ConfigRequest, com.cosmos.base.node.v1beta1.ConfigResponse> getConfigMethod;
    if ((getConfigMethod = ServiceGrpc.getConfigMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getConfigMethod = ServiceGrpc.getConfigMethod) == null) {
          ServiceGrpc.getConfigMethod = getConfigMethod =
              io.grpc.MethodDescriptor.<com.cosmos.base.node.v1beta1.ConfigRequest, com.cosmos.base.node.v1beta1.ConfigResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Config"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.base.node.v1beta1.ConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.base.node.v1beta1.ConfigResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.StatusRequest,
      com.cosmos.base.node.v1beta1.StatusResponse> getStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Status",
      requestType = com.cosmos.base.node.v1beta1.StatusRequest.class,
      responseType = com.cosmos.base.node.v1beta1.StatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.StatusRequest,
      com.cosmos.base.node.v1beta1.StatusResponse> getStatusMethod() {
    io.grpc.MethodDescriptor<com.cosmos.base.node.v1beta1.StatusRequest, com.cosmos.base.node.v1beta1.StatusResponse> getStatusMethod;
    if ((getStatusMethod = ServiceGrpc.getStatusMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getStatusMethod = ServiceGrpc.getStatusMethod) == null) {
          ServiceGrpc.getStatusMethod = getStatusMethod =
              io.grpc.MethodDescriptor.<com.cosmos.base.node.v1beta1.StatusRequest, com.cosmos.base.node.v1beta1.StatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Status"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.base.node.v1beta1.StatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.base.node.v1beta1.StatusResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void config(com.cosmos.base.node.v1beta1.ConfigRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.ConfigResponse> responseObserver) {
     ...
     * </pre>
     */
    default void status(com.cosmos.base.node.v1beta1.StatusRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.StatusResponse> responseObserver) {
  ...
  public static final class ServiceStub
     ...
     * </pre>
     */
    public void config(com.cosmos.base.node.v1beta1.ConfigRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.ConfigResponse> responseObserver) {
     ...
     * </pre>
     */
    public void status(com.cosmos.base.node.v1beta1.StatusRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.StatusResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ServiceBlockingStub
     ...
     * </pre>
     */
    public com.cosmos.base.node.v1beta1.ConfigResponse config(com.cosmos.base.node.v1beta1.ConfigRequest request) {
     ...
     * </pre>
     */
    public com.cosmos.base.node.v1beta1.StatusResponse status(com.cosmos.base.node.v1beta1.StatusRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cosmos.base.node.v1beta1.ConfigResponse> config(
        com.cosmos.base.node.v1beta1.ConfigRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cosmos.base.node.v1beta1.StatusResponse> status(
        com.cosmos.base.node.v1beta1.StatusRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONFIG:
          serviceImpl.config((com.cosmos.base.node.v1beta1.ConfigRequest) request,
              (io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.ConfigResponse>) responseObserver);
          break;
        case METHODID_STATUS:
          serviceImpl.status((com.cosmos.base.node.v1beta1.StatusRequest) request,
              (io.grpc.stub.StreamObserver<com.cosmos.base.node.v1beta1.StatusResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cosmos.base.node.v1beta1.ConfigRequest,
              com.cosmos.base.node.v1beta1.ConfigResponse>(
                service, METHODID_CONFIG)))
        .addMethod(
          getStatusMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cosmos.base.node.v1beta1.StatusRequest,
              com.cosmos.base.node.v1beta1.StatusResponse>(
