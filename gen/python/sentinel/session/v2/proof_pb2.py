...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PROOF'].fields_by_name['id']._options = None
  _globals['_PROOF'].fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
  _globals['_PROOF'].fields_by_name['bandwidth']._options = None
  _globals['_PROOF'].fields_by_name['bandwidth']._serialized_options = b'\310\336\037\000'
  _globals['_PROOF'].fields_by_name['duration']._options = None
  _globals['_PROOF'].fields_by_name['duration']._serialized_options = b'\310\336\037\000\230\337\037\001'
  _globals['_PROOF']._serialized_start=146
  _globals['_PROOF']._serialized_end=308
