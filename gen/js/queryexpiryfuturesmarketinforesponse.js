...
goog.provide('proto.injective.exchange.v1beta1.QueryExpiryFuturesMarketInfoResponse');
...
proto.injective.exchange.v1beta1.QueryExpiryFuturesMarketInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    info: (f = msg.getInfo()) && proto.injective.exchange.v1beta1.ExpiryFuturesMarketInfo.toObject(includeInstance, f)
  };
...
proto.injective.exchange.v1beta1.QueryExpiryFuturesMarketInfoResponse.prototype.getInfo = function() {
  return /** @type{?proto.injective.exchange.v1beta1.ExpiryFuturesMarketInfo} */ (
    jspb.Message.getWrapperField(this, proto.injective.exchange.v1beta1.ExpiryFuturesMarketInfo, 1));
};
