...
goog.provide('proto.irismod.token.GenesisState');
...
goog.require('proto.irismod.token.Token');
 ...
 * @const
 */
proto.irismod.token.GenesisState.repeatedFields_ = [2,3];
...
proto.irismod.token.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.irismod.token.Token.toObject, includeInstance),
...
proto.irismod.token.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.irismod.token.Token;
      reader.readMessage(value,proto.irismod.token.Token.deserializeBinaryFromReader);
      msg.addTokens(value);
      break;
    case 3:
...
proto.irismod.token.GenesisState.prototype.getTokensList = function() {
  return /** @type{!Array<!proto.irismod.token.Token>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.irismod.token.Token, 2));
};
 ...
 */
proto.irismod.token.GenesisState.prototype.getBurnedCoinsList = function() {
 ...
 * @return {!proto.irismod.token.GenesisState} returns this
*/
proto.irismod.token.GenesisState.prototype.setBurnedCoinsList = function(value) {
 ...
 */
proto.irismod.token.GenesisState.prototype.addBurnedCoins = function(opt_value, opt_index) {
 ...
 * @return {!proto.irismod.token.GenesisState} returns this
 */
proto.irismod.token.GenesisState.prototype.clearBurnedCoinsList = function() {
