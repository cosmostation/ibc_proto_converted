...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONTENT.fields_by_name['uri']._serialized_options = b'\342\336\037\003URI'
  _CONTENT._options = None
  _CONTENT._serialized_options = b'\350\240\037\001'
  _RECORD.fields_by_name['tx_hash']._options = None
  _RECORD.fields_by_name['tx_hash']._serialized_options = b'\362\336\037\016yaml:\"tx_hash\"'
  _RECORD.fields_by_name['contents']._options = None
  _RECORD.fields_by_name['contents']._serialized_options = b'\310\336\037\000'
  _RECORD._options = None
  _RECORD._serialized_options = b'\350\240\037\001'
