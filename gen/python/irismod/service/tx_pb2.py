...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\023com.irismod.serviceB\007TxProtoZ0github.com/irisnet/irismod/modules/service/types\242\002\003ISX\252\002\017Irismod.Service\312\002\017Irismod\\Service\342\002\033Irismod\\Service\\GPBMetadata\352\002\020Irismod::Service\310\341\036\000'
  _globals['_MSGDEFINESERVICE'].fields_by_name['author_description']._options = None
  _globals['_MSGDEFINESERVICE'].fields_by_name['author_description']._serialized_options = b'\362\336\037\031yaml:\"author_description\"'
  _globals['_MSGBINDSERVICE'].fields_by_name['service_name']._options = None
  _globals['_MSGBINDSERVICE'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGBINDSERVICE'].fields_by_name['deposit']._options = None
  _globals['_MSGBINDSERVICE'].fields_by_name['deposit']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGBINDSERVICE'].fields_by_name['qos']._options = None
  _globals['_MSGBINDSERVICE'].fields_by_name['qos']._serialized_options = b'\342\336\037\003QoS'
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['service_name']._options = None
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['deposit']._options = None
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['deposit']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['qos']._options = None
  _globals['_MSGUPDATESERVICEBINDING'].fields_by_name['qos']._serialized_options = b'\342\336\037\003QoS'
  _globals['_MSGSETWITHDRAWADDRESS'].fields_by_name['withdraw_address']._options = None
  _globals['_MSGSETWITHDRAWADDRESS'].fields_by_name['withdraw_address']._serialized_options = b'\362\336\037\027yaml:\"withdraw_address\"'
  _globals['_MSGDISABLESERVICEBINDING'].fields_by_name['service_name']._options = None
  _globals['_MSGDISABLESERVICEBINDING'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGENABLESERVICEBINDING'].fields_by_name['service_name']._options = None
  _globals['_MSGENABLESERVICEBINDING'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGENABLESERVICEBINDING'].fields_by_name['deposit']._options = None
  _globals['_MSGENABLESERVICEBINDING'].fields_by_name['deposit']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGREFUNDSERVICEDEPOSIT'].fields_by_name['service_name']._options = None
  _globals['_MSGREFUNDSERVICEDEPOSIT'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGCALLSERVICE'].fields_by_name['service_name']._options = None
  _globals['_MSGCALLSERVICE'].fields_by_name['service_name']._serialized_options = b'\362\336\037\023yaml:\"service_name\"'
  _globals['_MSGCALLSERVICE'].fields_by_name['service_fee_cap']._options = None
  _globals['_MSGCALLSERVICE'].fields_by_name['service_fee_cap']._serialized_options = b'\310\336\037\000\362\336\037\026yaml:\"service_fee_cap\"\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGCALLSERVICE'].fields_by_name['repeated_frequency']._options = None
  _globals['_MSGCALLSERVICE'].fields_by_name['repeated_frequency']._serialized_options = b'\362\336\037\031yaml:\"repeated_frequency\"'
  _globals['_MSGCALLSERVICE'].fields_by_name['repeated_total']._options = None
  _globals['_MSGCALLSERVICE'].fields_by_name['repeated_total']._serialized_options = b'\362\336\037\025yaml:\"repeated_total\"'
  _globals['_MSGCALLSERVICERESPONSE'].fields_by_name['request_context_id']._options = None
  _globals['_MSGCALLSERVICERESPONSE'].fields_by_name['request_context_id']._serialized_options = b'\362\336\037\031yaml:\"request_context_id\"'
  _globals['_MSGRESPONDSERVICE'].fields_by_name['request_id']._options = None
  _globals['_MSGRESPONDSERVICE'].fields_by_name['request_id']._serialized_options = b'\362\336\037\021yaml:\"request_id\"'
  _globals['_MSGPAUSEREQUESTCONTEXT'].fields_by_name['request_context_id']._options = None
  _globals['_MSGPAUSEREQUESTCONTEXT'].fields_by_name['request_context_id']._serialized_options = b'\362\336\037\031yaml:\"request_context_id\"'
  _globals['_MSGSTARTREQUESTCONTEXT'].fields_by_name['request_context_id']._options = None
  _globals['_MSGSTARTREQUESTCONTEXT'].fields_by_name['request_context_id']._serialized_options = b'\362\336\037\031yaml:\"request_context_id\"'
  _globals['_MSGKILLREQUESTCONTEXT'].fields_by_name['request_context_id']._options = None
  _globals['_MSGKILLREQUESTCONTEXT'].fields_by_name['request_context_id']._serialized_options = b'\362\336\037\031yaml:\"request_context_id\"'
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['request_context_id']._options = None
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['request_context_id']._serialized_options = b'\362\336\037\031yaml:\"request_context_id\"'
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['service_fee_cap']._options = None
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['service_fee_cap']._serialized_options = b'\310\336\037\000\362\336\037\026yaml:\"service_fee_cap\"\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['repeated_frequency']._options = None
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['repeated_frequency']._serialized_options = b'\362\336\037\031yaml:\"repeated_frequency\"'
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['repeated_total']._options = None
  _globals['_MSGUPDATEREQUESTCONTEXT'].fields_by_name['repeated_total']._serialized_options = b'\362\336\037\025yaml:\"repeated_total\"'
