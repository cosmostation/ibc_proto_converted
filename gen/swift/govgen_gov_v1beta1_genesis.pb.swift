...
struct Govgen_Gov_V1beta1_GenesisState {
  ...
  var depositParams: Govgen_Gov_V1beta1_DepositParams {
    get {return _storage._depositParams ?? Govgen_Gov_V1beta1_DepositParams()}
  ...
  var votingParams: Govgen_Gov_V1beta1_VotingParams {
    get {return _storage._votingParams ?? Govgen_Gov_V1beta1_VotingParams()}
  ...
  var tallyParams: Govgen_Gov_V1beta1_TallyParams {
    get {return _storage._tallyParams ?? Govgen_Gov_V1beta1_TallyParams()}
...
extension Govgen_Gov_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Govgen_Gov_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _deposits: [Govgen_Gov_V1beta1_Deposit] = []
    var _votes: [Govgen_Gov_V1beta1_Vote] = []
    var _proposals: [Govgen_Gov_V1beta1_Proposal] = []
    var _depositParams: Govgen_Gov_V1beta1_DepositParams? = nil
    var _votingParams: Govgen_Gov_V1beta1_VotingParams? = nil
    var _tallyParams: Govgen_Gov_V1beta1_TallyParams? = nil
  ...
  static func ==(lhs: Govgen_Gov_V1beta1_GenesisState, rhs: Govgen_Gov_V1beta1_GenesisState) -> Bool {
