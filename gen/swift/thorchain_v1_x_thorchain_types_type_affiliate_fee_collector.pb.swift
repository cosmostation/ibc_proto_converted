...
struct Types_AffiliateFeeCollector {
...
extension Types_AffiliateFeeCollector: @unchecked Sendable {}
...
extension Types_AffiliateFeeCollector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AffiliateFeeCollector"
  ...
  static func ==(lhs: Types_AffiliateFeeCollector, rhs: Types_AffiliateFeeCollector) -> Bool {
