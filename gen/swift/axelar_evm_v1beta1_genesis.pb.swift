...
struct Axelar_Evm_V1beta1_GenesisState {
  ...
  struct Chain {
    ...
    var commandQueue: Axelar_Utils_V1beta1_QueueState {
      get {return _storage._commandQueue ?? Axelar_Utils_V1beta1_QueueState()}
      set {_uniqueStorage()._commandQueue = newValue}
    }
    /// Returns true if `commandQueue` has been explicitly set.
    var hasCommandQueue: Bool {return _storage._commandQueue != nil}
    /// Clears the value of `commandQueue`. Subsequent reads from it will return its default value.
    mutating func clearCommandQueue() {_uniqueStorage()._commandQueue = nil}
    ...
    var confirmedEventQueue: Axelar_Utils_V1beta1_QueueState {
      get {return _storage._confirmedEventQueue ?? Axelar_Utils_V1beta1_QueueState()}
      set {_uniqueStorage()._confirmedEventQueue = newValue}
    }
    /// Returns true if `confirmedEventQueue` has been explicitly set.
    var hasConfirmedEventQueue: Bool {return _storage._confirmedEventQueue != nil}
    /// Clears the value of `confirmedEventQueue`. Subsequent reads from it will return its default value.
    mutating func clearConfirmedEventQueue() {_uniqueStorage()._confirmedEventQueue = nil}

    var legacyConfirmedDeposits: [Axelar_Evm_V1beta1_ERC20Deposit] {
      get {return _storage._legacyConfirmedDeposits}
      set {_uniqueStorage()._legacyConfirmedDeposits = newValue}
    }

    var legacyBurnedDeposits: [Axelar_Evm_V1beta1_ERC20Deposit] {
      get {return _storage._legacyBurnedDeposits}
      set {_uniqueStorage()._legacyBurnedDeposits = newValue}
    }
...
extension Axelar_Evm_V1beta1_GenesisState: @unchecked Sendable {}
extension Axelar_Evm_V1beta1_GenesisState.Chain: @unchecked Sendable {}
...
extension Axelar_Evm_V1beta1_GenesisState.Chain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .standard(proto: "confirmed_event_queue"),
    13: .standard(proto: "legacy_confirmed_deposits"),
    14: .standard(proto: "legacy_burned_deposits"),
  ]

  fileprivate class _StorageClass {
    var _params: Axelar_Evm_V1beta1_Params? = nil
    var _burnerInfos: [Axelar_Evm_V1beta1_BurnerInfo] = []
    var _commandQueue: Axelar_Utils_V1beta1_QueueState? = nil
    ...
    var _events: [Axelar_Evm_V1beta1_Event] = []
    var _confirmedEventQueue: Axelar_Utils_V1beta1_QueueState? = nil
    var _legacyConfirmedDeposits: [Axelar_Evm_V1beta1_ERC20Deposit] = []
    var _legacyBurnedDeposits: [Axelar_Evm_V1beta1_ERC20Deposit] = []
    ...
    init(copying source: _StorageClass) {
      ...
      _confirmedEventQueue = source._confirmedEventQueue
      _legacyConfirmedDeposits = source._legacyConfirmedDeposits
      _legacyBurnedDeposits = source._legacyBurnedDeposits
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._commandQueue) }()
        ...
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._confirmedEventQueue) }()
        case 13: try { try decoder.decodeRepeatedMessageField(value: &_storage._legacyConfirmedDeposits) }()
        case 14: try { try decoder.decodeRepeatedMessageField(value: &_storage._legacyBurnedDeposits) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._commandQueue {
      ...
      try { if let v = _storage._gateway {
      ...
      try { if let v = _storage._confirmedEventQueue {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
      } }()
      if !_storage._legacyConfirmedDeposits.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._legacyConfirmedDeposits, fieldNumber: 13)
      }
      if !_storage._legacyBurnedDeposits.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._legacyBurnedDeposits, fieldNumber: 14)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Axelar_Evm_V1beta1_GenesisState.Chain, rhs: Axelar_Evm_V1beta1_GenesisState.Chain) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._confirmedEventQueue != rhs_storage._confirmedEventQueue {return false}
        if _storage._legacyConfirmedDeposits != rhs_storage._legacyConfirmedDeposits {return false}
        if _storage._legacyBurnedDeposits != rhs_storage._legacyBurnedDeposits {return false}
        return true
      }
