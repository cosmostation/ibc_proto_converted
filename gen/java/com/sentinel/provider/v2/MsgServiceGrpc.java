...
public final class MsgServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "sentinel.provider.v2.MsgService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgRegisterRequest,
      com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> getMsgRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgRegister",
      requestType = com.sentinel.provider.v2.MsgProto.MsgRegisterRequest.class,
      responseType = com.sentinel.provider.v2.MsgProto.MsgRegisterResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgRegisterRequest,
      com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> getMsgRegisterMethod() {
    io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgRegisterRequest, com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> getMsgRegisterMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgRegisterMethod = MsgServiceGrpc.getMsgRegisterMethod) == null) {
          MsgServiceGrpc.getMsgRegisterMethod = getMsgRegisterMethod =
              io.grpc.MethodDescriptor.<com.sentinel.provider.v2.MsgProto.MsgRegisterRequest, com.sentinel.provider.v2.MsgProto.MsgRegisterResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgRegister"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.provider.v2.MsgProto.MsgRegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.provider.v2.MsgProto.MsgRegisterResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgUpdateRequest,
      com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> getMsgUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgUpdate",
      requestType = com.sentinel.provider.v2.MsgProto.MsgUpdateRequest.class,
      responseType = com.sentinel.provider.v2.MsgProto.MsgUpdateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgUpdateRequest,
      com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> getMsgUpdateMethod() {
    io.grpc.MethodDescriptor<com.sentinel.provider.v2.MsgProto.MsgUpdateRequest, com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> getMsgUpdateMethod;
    if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgUpdateMethod = MsgServiceGrpc.getMsgUpdateMethod) == null) {
          MsgServiceGrpc.getMsgUpdateMethod = getMsgUpdateMethod =
              io.grpc.MethodDescriptor.<com.sentinel.provider.v2.MsgProto.MsgUpdateRequest, com.sentinel.provider.v2.MsgProto.MsgUpdateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgUpdate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.provider.v2.MsgProto.MsgUpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.provider.v2.MsgProto.MsgUpdateResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void msgRegister(com.sentinel.provider.v2.MsgProto.MsgRegisterRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgRegisterMethod(), responseObserver);
    }

    /**
     */
    default void msgUpdate(com.sentinel.provider.v2.MsgProto.MsgUpdateRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void msgRegister(com.sentinel.provider.v2.MsgProto.MsgRegisterRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> responseObserver) {
    ...
    /**
     */
    public void msgUpdate(com.sentinel.provider.v2.MsgProto.MsgUpdateRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.sentinel.provider.v2.MsgProto.MsgRegisterResponse msgRegister(com.sentinel.provider.v2.MsgProto.MsgRegisterRequest request) {
    ...
    /**
     */
    public com.sentinel.provider.v2.MsgProto.MsgUpdateResponse msgUpdate(com.sentinel.provider.v2.MsgProto.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.provider.v2.MsgProto.MsgRegisterResponse> msgRegister(
        com.sentinel.provider.v2.MsgProto.MsgRegisterRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.provider.v2.MsgProto.MsgUpdateResponse> msgUpdate(
        com.sentinel.provider.v2.MsgProto.MsgUpdateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MSG_REGISTER:
          serviceImpl.msgRegister((com.sentinel.provider.v2.MsgProto.MsgRegisterRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgRegisterResponse>) responseObserver);
          break;
        case METHODID_MSG_UPDATE:
          serviceImpl.msgUpdate((com.sentinel.provider.v2.MsgProto.MsgUpdateRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.provider.v2.MsgProto.MsgUpdateResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.provider.v2.MsgProto.MsgRegisterRequest,
              com.sentinel.provider.v2.MsgProto.MsgRegisterResponse>(
                service, METHODID_MSG_REGISTER)))
        .addMethod(
          getMsgUpdateMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.provider.v2.MsgProto.MsgUpdateRequest,
              com.sentinel.provider.v2.MsgProto.MsgUpdateResponse>(
