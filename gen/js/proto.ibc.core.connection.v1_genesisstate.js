...
goog.provide('proto.ibc.core.connection.v1.GenesisState');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.ibc.core.connection.v1.ConnectionPaths');
goog.require('proto.ibc.core.connection.v1.IdentifiedConnection');
...
proto.ibc.core.connection.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.ibc.core.connection.v1.IdentifiedConnection.toObject, includeInstance),
    clientConnectionPathsList: jspb.Message.toObjectList(msg.getClientConnectionPathsList(),
    proto.ibc.core.connection.v1.ConnectionPaths.toObject, includeInstance),
...
proto.ibc.core.connection.v1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.ibc.core.connection.v1.IdentifiedConnection;
      reader.readMessage(value,proto.ibc.core.connection.v1.IdentifiedConnection.deserializeBinaryFromReader);
      msg.addConnections(value);
      break;
    case 2:
      var value = new proto.ibc.core.connection.v1.ConnectionPaths;
      reader.readMessage(value,proto.ibc.core.connection.v1.ConnectionPaths.deserializeBinaryFromReader);
...
proto.ibc.core.connection.v1.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.ibc.core.connection.v1.IdentifiedConnection.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.ibc.core.connection.v1.ConnectionPaths.serializeBinaryToWriter
    );
  }
...
proto.ibc.core.connection.v1.GenesisState.prototype.getConnectionsList = function() {
  return /** @type{!Array<!proto.ibc.core.connection.v1.IdentifiedConnection>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ibc.core.connection.v1.IdentifiedConnection, 1));
};
...
proto.ibc.core.connection.v1.GenesisState.prototype.getClientConnectionPathsList = function() {
  return /** @type{!Array<!proto.ibc.core.connection.v1.ConnectionPaths>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ibc.core.connection.v1.ConnectionPaths, 2));
};
...
proto.ibc.core.connection.v1.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.ibc.core.connection.v1.Params} */ (
    jspb.Message.getWrapperField(this, proto.ibc.core.connection.v1.Params, 4));
};
