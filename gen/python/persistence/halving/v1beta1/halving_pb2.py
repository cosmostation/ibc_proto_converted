...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PARAMS'].fields_by_name['blockHeight']._options = None
  _globals['_PARAMS'].fields_by_name['blockHeight']._serialized_options = b'\362\336\037\022yaml:\"blockHeight\"'
