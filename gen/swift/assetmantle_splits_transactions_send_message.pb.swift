...
struct Assetmantle_Modules_Splits_Transactions_Send_Message {
...
extension Assetmantle_Modules_Splits_Transactions_Send_Message: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "assetmantle.modules.splits.transactions.send"

extension Assetmantle_Modules_Splits_Transactions_Send_Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Message"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "from"),
    2: .standard(proto: "from_i_d"),
    3: .standard(proto: "to_i_d"),
    4: .standard(proto: "ownable_i_d"),
    5: .same(proto: "value"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._ownableID) }()
  ...
  static func ==(lhs: Assetmantle_Modules_Splits_Transactions_Send_Message, rhs: Assetmantle_Modules_Splits_Transactions_Send_Message) -> Bool {
