...
@javax.annotation.Generated(
    ...
    comments = "Source: shentu/gov/v1/query.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class QueryGrpc {

  private QueryGrpc() {}

  public static final String SERVICE_NAME = "shentu.gov.v1.Query";
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.gov.v1.QueryProto.QueryParamsRequest,
      com.shentu.gov.v1.QueryProto.QueryParamsResponse> getParamsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Params",
      requestType = com.cosmos.gov.v1.QueryProto.QueryParamsRequest.class,
      responseType = com.shentu.gov.v1.QueryProto.QueryParamsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.gov.v1.QueryProto.QueryParamsRequest,
      com.shentu.gov.v1.QueryProto.QueryParamsResponse> getParamsMethod() {
    io.grpc.MethodDescriptor<com.cosmos.gov.v1.QueryProto.QueryParamsRequest, com.shentu.gov.v1.QueryProto.QueryParamsResponse> getParamsMethod;
    if ((getParamsMethod = QueryGrpc.getParamsMethod) == null) {
      synchronized (QueryGrpc.class) {
        if ((getParamsMethod = QueryGrpc.getParamsMethod) == null) {
          QueryGrpc.getParamsMethod = getParamsMethod =
              io.grpc.MethodDescriptor.<com.cosmos.gov.v1.QueryProto.QueryParamsRequest, com.shentu.gov.v1.QueryProto.QueryParamsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shentu.gov.v1.QueryProto.QueryParamsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.shentu.gov.v1.QueryProto.QueryCertVotedRequest,
      com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> getCertVotedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CertVoted",
      requestType = com.shentu.gov.v1.QueryProto.QueryCertVotedRequest.class,
      responseType = com.shentu.gov.v1.QueryProto.QueryCertVotedResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.shentu.gov.v1.QueryProto.QueryCertVotedRequest,
      com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> getCertVotedMethod() {
    io.grpc.MethodDescriptor<com.shentu.gov.v1.QueryProto.QueryCertVotedRequest, com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> getCertVotedMethod;
    if ((getCertVotedMethod = QueryGrpc.getCertVotedMethod) == null) {
      synchronized (QueryGrpc.class) {
        if ((getCertVotedMethod = QueryGrpc.getCertVotedMethod) == null) {
          QueryGrpc.getCertVotedMethod = getCertVotedMethod =
              io.grpc.MethodDescriptor.<com.shentu.gov.v1.QueryProto.QueryCertVotedRequest, com.shentu.gov.v1.QueryProto.QueryCertVotedResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CertVoted"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shentu.gov.v1.QueryProto.QueryCertVotedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shentu.gov.v1.QueryProto.QueryCertVotedResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void params(com.cosmos.gov.v1.QueryProto.QueryParamsRequest request,
        io.grpc.stub.StreamObserver<com.shentu.gov.v1.QueryProto.QueryParamsResponse> responseObserver) {
     ...
     * </pre>
     */
    default void certVoted(com.shentu.gov.v1.QueryProto.QueryCertVotedRequest request,
        io.grpc.stub.StreamObserver<com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> responseObserver) {
  ...
  public static final class QueryStub
     ...
     * </pre>
     */
    public void certVoted(com.shentu.gov.v1.QueryProto.QueryCertVotedRequest request,
        io.grpc.stub.StreamObserver<com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class QueryBlockingStub
     ...
     * </pre>
     */
    public com.shentu.gov.v1.QueryProto.QueryParamsResponse params(com.cosmos.gov.v1.QueryProto.QueryParamsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.shentu.gov.v1.QueryProto.QueryCertVotedResponse certVoted(com.shentu.gov.v1.QueryProto.QueryCertVotedRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class QueryFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.shentu.gov.v1.QueryProto.QueryParamsResponse> params(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.shentu.gov.v1.QueryProto.QueryCertVotedResponse> certVoted(
        com.shentu.gov.v1.QueryProto.QueryCertVotedRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_CERT_VOTED = 9;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_CERT_VOTED:
          serviceImpl.certVoted((com.shentu.gov.v1.QueryProto.QueryCertVotedRequest) request,
              (io.grpc.stub.StreamObserver<com.shentu.gov.v1.QueryProto.QueryCertVotedResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.shentu.gov.v1.QueryProto.QueryParamsResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.shentu.gov.v1.QueryProto.QueryCertVotedRequest,
              com.shentu.gov.v1.QueryProto.QueryCertVotedResponse>(
  ...
  private static abstract class QueryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.shentu.gov.v1.QueryProto.getDescriptor();
    }
