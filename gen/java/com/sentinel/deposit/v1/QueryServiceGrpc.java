...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositsRequest,
      com.sentinel.deposit.v1.QueryDepositsResponse> getQueryDepositsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryDeposits",
      requestType = com.sentinel.deposit.v1.QueryDepositsRequest.class,
      responseType = com.sentinel.deposit.v1.QueryDepositsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositsRequest,
      com.sentinel.deposit.v1.QueryDepositsResponse> getQueryDepositsMethod() {
    io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositsRequest, com.sentinel.deposit.v1.QueryDepositsResponse> getQueryDepositsMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryDepositsMethod = QueryServiceGrpc.getQueryDepositsMethod) == null) {
          QueryServiceGrpc.getQueryDepositsMethod = getQueryDepositsMethod =
              io.grpc.MethodDescriptor.<com.sentinel.deposit.v1.QueryDepositsRequest, com.sentinel.deposit.v1.QueryDepositsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryDeposits"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.deposit.v1.QueryDepositsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.deposit.v1.QueryDepositsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositRequest,
      com.sentinel.deposit.v1.QueryDepositResponse> getQueryDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryDeposit",
      requestType = com.sentinel.deposit.v1.QueryDepositRequest.class,
      responseType = com.sentinel.deposit.v1.QueryDepositResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositRequest,
      com.sentinel.deposit.v1.QueryDepositResponse> getQueryDepositMethod() {
    io.grpc.MethodDescriptor<com.sentinel.deposit.v1.QueryDepositRequest, com.sentinel.deposit.v1.QueryDepositResponse> getQueryDepositMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryDepositMethod = QueryServiceGrpc.getQueryDepositMethod) == null) {
          QueryServiceGrpc.getQueryDepositMethod = getQueryDepositMethod =
              io.grpc.MethodDescriptor.<com.sentinel.deposit.v1.QueryDepositRequest, com.sentinel.deposit.v1.QueryDepositResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.deposit.v1.QueryDepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.deposit.v1.QueryDepositResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void queryDeposits(com.sentinel.deposit.v1.QueryDepositsRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryDepositsMethod(), responseObserver);
    }

    /**
     */
    default void queryDeposit(com.sentinel.deposit.v1.QueryDepositRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositResponse> responseObserver) {
  ...
  public static final class QueryServiceStub
    ...
    /**
     */
    public void queryDeposits(com.sentinel.deposit.v1.QueryDepositsRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositsResponse> responseObserver) {
    ...
    /**
     */
    public void queryDeposit(com.sentinel.deposit.v1.QueryDepositRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class QueryServiceBlockingStub
    ...
    /**
     */
    public com.sentinel.deposit.v1.QueryDepositsResponse queryDeposits(com.sentinel.deposit.v1.QueryDepositsRequest request) {
    ...
    /**
     */
    public com.sentinel.deposit.v1.QueryDepositResponse queryDeposit(com.sentinel.deposit.v1.QueryDepositRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class QueryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.deposit.v1.QueryDepositsResponse> queryDeposits(
        com.sentinel.deposit.v1.QueryDepositsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.deposit.v1.QueryDepositResponse> queryDeposit(
        com.sentinel.deposit.v1.QueryDepositRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERY_DEPOSITS:
          serviceImpl.queryDeposits((com.sentinel.deposit.v1.QueryDepositsRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositsResponse>) responseObserver);
          break;
        case METHODID_QUERY_DEPOSIT:
          serviceImpl.queryDeposit((com.sentinel.deposit.v1.QueryDepositRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.deposit.v1.QueryDepositResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.deposit.v1.QueryDepositsRequest,
              com.sentinel.deposit.v1.QueryDepositsResponse>(
                service, METHODID_QUERY_DEPOSITS)))
        .addMethod(
          getQueryDepositMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.deposit.v1.QueryDepositRequest,
              com.sentinel.deposit.v1.QueryDepositResponse>(
