...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetRewardReceiverAddress = channel.unary_unary(
                '/osmosis.lockup.Msg/SetRewardReceiverAddress',
                request_serializer=osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddress.SerializeToString,
                response_deserializer=osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddressResponse.FromString,
                )
...
class MsgServicer(object):
    ...
    def SetRewardReceiverAddress(self, request, context):
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetRewardReceiverAddress': grpc.unary_unary_rpc_method_handler(
                    servicer.SetRewardReceiverAddress,
                    request_deserializer=osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddress.FromString,
                    response_serializer=osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddressResponse.SerializeToString,
            ),
    }
...
class Msg(object):
    ...
    @staticmethod
    def SetRewardReceiverAddress(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.lockup.Msg/SetRewardReceiverAddress',
            osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddress.SerializeToString,
            osmosis_dot_lockup_dot_tx__pb2.MsgSetRewardReceiverAddressResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
