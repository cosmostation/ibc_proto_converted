...
struct Assetmantle_Schema_Ids_Base_MaintainerID {
...
extension Assetmantle_Schema_Ids_Base_MaintainerID: @unchecked Sendable {}
...
extension Assetmantle_Schema_Ids_Base_MaintainerID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MaintainerID"
  ...
  static func ==(lhs: Assetmantle_Schema_Ids_Base_MaintainerID, rhs: Assetmantle_Schema_Ids_Base_MaintainerID) -> Bool {
