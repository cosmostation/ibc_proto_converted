...
class Query(object):
    ...
    def Beam(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.beam.Query/Beam',
            lum__network_dot_beam_dot_query__pb2.QueryGetBeamRequest.SerializeToString,
            lum__network_dot_beam_dot_query__pb2.QueryGetBeamResponse.FromString,
    ...
    def Beams(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.beam.Query/Beams',
            lum__network_dot_beam_dot_query__pb2.QueryFetchBeamsRequest.SerializeToString,
            lum__network_dot_beam_dot_query__pb2.QueryFetchBeamsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def BeamsOpenQueue(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.beam.Query/BeamsOpenQueue',
            lum__network_dot_beam_dot_query__pb2.QueryFetchBeamsOpenQueueRequest.SerializeToString,
            lum__network_dot_beam_dot_query__pb2.QueryFetchBeamsOpenQueueResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
