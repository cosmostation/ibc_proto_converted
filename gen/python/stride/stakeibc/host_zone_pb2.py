...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_HOSTZONE'].fields_by_name['last_redemption_rate']._options = None
  _globals['_HOSTZONE'].fields_by_name['last_redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_HOSTZONE'].fields_by_name['redemption_rate']._options = None
  _globals['_HOSTZONE'].fields_by_name['redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_HOSTZONE'].fields_by_name['staked_bal']._options = None
  _globals['_HOSTZONE'].fields_by_name['staked_bal']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int'
  _globals['_HOSTZONE'].fields_by_name['address']._options = None
  _globals['_HOSTZONE'].fields_by_name['address']._serialized_options = b'\362\336\037\016yaml:\"address\"'
  _globals['_HOSTZONE'].fields_by_name['min_redemption_rate']._options = None
  _globals['_HOSTZONE'].fields_by_name['min_redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
  _globals['_HOSTZONE'].fields_by_name['max_redemption_rate']._options = None
  _globals['_HOSTZONE'].fields_by_name['max_redemption_rate']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\322\264-\ncosmos.Dec'
