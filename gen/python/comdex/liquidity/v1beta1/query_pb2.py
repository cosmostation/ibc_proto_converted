...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\034com.comdex.liquidity.v1beta1B\nQueryProtoP\001Z3github.com/comdex-official/comdex/x/liquidity/types\242\002\003CLX\252\002\030Comdex.Liquidity.V1beta1\312\002\030Comdex\\Liquidity\\V1beta1\342\002$Comdex\\Liquidity\\V1beta1\\GPBMetadata\352\002\032Comdex::Liquidity::V1beta1'
  _QUERYPARAMSRESPONSE.fields_by_name['params']._options = None
  _QUERYPARAMSRESPONSE.fields_by_name['params']._serialized_options = b'\310\336\037\000'
  _QUERYGENERICPARAMSRESPONSE.fields_by_name['params']._options = None
  _QUERYGENERICPARAMSRESPONSE.fields_by_name['params']._serialized_options = b'\310\336\037\000'
  ...
  _QUEUEDPOOLCOIN.fields_by_name['pool_coin']._options = None
  _QUEUEDPOOLCOIN.fields_by_name['pool_coin']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _QUEUEDPOOLCOIN.fields_by_name['deque_at']._options = None
  _QUEUEDPOOLCOIN.fields_by_name['deque_at']._serialized_options = b'\310\336\037\000\362\336\037\017yaml:\"deque_at\"\220\337\037\001'
  _QUERYFARMERRESPONSE.fields_by_name['active_pool_coin']._options = None
  _QUERYFARMERRESPONSE.fields_by_name['active_pool_coin']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _QUERYFARMERRESPONSE.fields_by_name['queued_pool_coin']._options = None
  _QUERYFARMERRESPONSE.fields_by_name['queued_pool_coin']._serialized_options = b'\310\336\037\000'
  _QUERYDESERIALIZEPOOLCOINRESPONSE.fields_by_name['coins']._options = None
  _QUERYDESERIALIZEPOOLCOINRESPONSE.fields_by_name['coins']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _POOLINCENTIVE.fields_by_name['total_rewards']._options = None
  _POOLINCENTIVE.fields_by_name['total_rewards']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _POOLINCENTIVE.fields_by_name['distributed_rewards']._options = None
  _POOLINCENTIVE.fields_by_name['distributed_rewards']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _POOLINCENTIVE.fields_by_name['epoch_duration']._options = None
  _POOLINCENTIVE.fields_by_name['epoch_duration']._serialized_options = b'\310\336\037\000\352\336\037\030epoch_duration,omitempty\362\336\037\025yaml:\"epoch_duration\"\230\337\037\001'
  _POOLINCENTIVE.fields_by_name['next_distribution']._options = None
  _POOLINCENTIVE.fields_by_name['next_distribution']._serialized_options = b'\310\336\037\000\362\336\037\030yaml:\"next_distribution\"\220\337\037\001'
  _QUERYFARMEDPOOLCOINRESPONSE.fields_by_name['coin']._options = None
  _QUERYFARMEDPOOLCOINRESPONSE.fields_by_name['coin']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  ...
  _TOTALACTIVEANDQUEUEDPOOLCOINS.fields_by_name['total_active_pool_coin']._options = None
  _TOTALACTIVEANDQUEUEDPOOLCOINS.fields_by_name['total_active_pool_coin']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _TOTALACTIVEANDQUEUEDPOOLCOINS.fields_by_name['total_queued_pool_coin']._options = None
  _TOTALACTIVEANDQUEUEDPOOLCOINS.fields_by_name['total_queued_pool_coin']._serialized_options = b'\310\336\037\000\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _QUERY.methods_by_name['Params']._options = None
  _QUERY.methods_by_name['Params']._serialized_options = b'\202\323\344\223\002\"\022 /comdex/liquidity/v1beta1/params'
  _QUERY.methods_by_name['GenericParams']._options = None
  _QUERY.methods_by_name['GenericParams']._serialized_options = b'\202\323\344\223\0023\0221/comdex/liquidity/v1beta1/generic_params/{app_id}'
  _QUERY.methods_by_name['Pools']._options = None
  _QUERY.methods_by_name['Pools']._serialized_options = b'\202\323\344\223\002*\022(/comdex/liquidity/v1beta1/pools/{app_id}'
  _QUERY.methods_by_name['Pool']._options = None
  _QUERY.methods_by_name['Pool']._serialized_options = b'\202\323\344\223\0024\0222/comdex/liquidity/v1beta1/pools/{app_id}/{pool_id}'
  _QUERY.methods_by_name['PoolByReserveAddress']._options = None
  _QUERY.methods_by_name['PoolByReserveAddress']._serialized_options = b'\202\323\344\223\002L\022J/comdex/liquidity/v1beta1/pools/{app_id}/reserve_address/{reserve_address}'
  _QUERY.methods_by_name['PoolByPoolCoinDenom']._options = None
  _QUERY.methods_by_name['PoolByPoolCoinDenom']._serialized_options = b'\202\323\344\223\002L\022J/comdex/liquidity/v1beta1/pools/{app_id}/pool_coin_denom/{pool_coin_denom}'
  _QUERY.methods_by_name['Pairs']._options = None
  _QUERY.methods_by_name['Pairs']._serialized_options = b'\202\323\344\223\002*\022(/comdex/liquidity/v1beta1/pairs/{app_id}'
  _QUERY.methods_by_name['Pair']._options = None
  _QUERY.methods_by_name['Pair']._serialized_options = b'\202\323\344\223\0024\0222/comdex/liquidity/v1beta1/pairs/{app_id}/{pair_id}'
  _QUERY.methods_by_name['DepositRequests']._options = None
  _QUERY.methods_by_name['DepositRequests']._serialized_options = b'\202\323\344\223\002E\022C/comdex/liquidity/v1beta1/pools/{app_id}/{pool_id}/deposit_requests'
  _QUERY.methods_by_name['DepositRequest']._options = None
  _QUERY.methods_by_name['DepositRequest']._serialized_options = b'\202\323\344\223\002J\022H/comdex/liquidity/v1beta1/pools/{app_id}/{pool_id}/deposit_requests/{id}'
  _QUERY.methods_by_name['WithdrawRequests']._options = None
  _QUERY.methods_by_name['WithdrawRequests']._serialized_options = b'\202\323\344\223\002F\022D/comdex/liquidity/v1beta1/pools/{app_id}/{pool_id}/withdraw_requests'
  _QUERY.methods_by_name['WithdrawRequest']._options = None
  _QUERY.methods_by_name['WithdrawRequest']._serialized_options = b'\202\323\344\223\002K\022I/comdex/liquidity/v1beta1/pools/{app_id}/{pool_id}/withdraw_requests/{id}'
  _QUERY.methods_by_name['Orders']._options = None
  _QUERY.methods_by_name['Orders']._serialized_options = b'\202\323\344\223\0025\0223/comdex/liquidity/v1beta1/orders/{app_id}/{pair_id}'
  _QUERY.methods_by_name['Order']._options = None
  _QUERY.methods_by_name['Order']._serialized_options = b'\202\323\344\223\002:\0228/comdex/liquidity/v1beta1/orders/{app_id}/{pair_id}/{id}'
  _QUERY.methods_by_name['OrdersByOrderer']._options = None
  _QUERY.methods_by_name['OrdersByOrderer']._serialized_options = b'\202\323\344\223\0025\0223/comdex/liquidity/v1beta1/orders/{app_id}/{orderer}'
  _QUERY.methods_by_name['Farmer']._options = None
  _QUERY.methods_by_name['Farmer']._serialized_options = b'\202\323\344\223\002>\022</comdex/liquidity/v1beta1/farmer/{app_id}/{pool_id}/{farmer}'
  _QUERY.methods_by_name['DeserializePoolCoin']._options = None
  _QUERY.methods_by_name['DeserializePoolCoin']._serialized_options = b'\202\323\344\223\002M\022K/comdex/liquidity/v1beta1/deserialize/{app_id}/{pool_id}/{pool_coin_amount}'
  _QUERY.methods_by_name['PoolIncentives']._options = None
  _QUERY.methods_by_name['PoolIncentives']._serialized_options = b'\202\323\344\223\0024\0222/comdex/liquidity/v1beta1/pool_incentives/{app_id}'
  _QUERY.methods_by_name['FarmedPoolCoin']._options = None
  _QUERY.methods_by_name['FarmedPoolCoin']._serialized_options = b'\202\323\344\223\002:\0228/comdex/liquidity/v1beta1/farmed_coin/{app_id}/{pool_id}'
  _QUERY.methods_by_name['TotalActiveAndQueuedPoolCoin']._options = None
  _QUERY.methods_by_name['TotalActiveAndQueuedPoolCoin']._serialized_options = b'\202\323\344\223\0024\0222/comdex/liquidity/v1beta1/all_farmed_coin/{app_id}'
  _QUERY.methods_by_name['OrderBooks']._options = None
  _QUERY.methods_by_name['OrderBooks']._serialized_options = b'\202\323\344\223\0020\022./comdex/liquidity/v1beta1/order_books/{app_id}'
