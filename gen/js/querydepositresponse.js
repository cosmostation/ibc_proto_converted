...
goog.provide('proto.sentinel.deposit.v1.QueryDepositResponse');
...
proto.sentinel.deposit.v1.QueryDepositResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    deposit: (f = msg.getDeposit()) && proto.sentinel.deposit.v1.Deposit.toObject(includeInstance, f)
  };
...
proto.sentinel.deposit.v1.QueryDepositResponse.prototype.getDeposit = function() {
  return /** @type{?proto.sentinel.deposit.v1.Deposit} */ (
    jspb.Message.getWrapperField(this, proto.sentinel.deposit.v1.Deposit, 1));
};
