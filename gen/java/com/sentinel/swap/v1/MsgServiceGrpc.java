...
public final class MsgServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "sentinel.swap.v1.MsgService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.sentinel.swap.v1.MsgProto.MsgSwapRequest,
      com.sentinel.swap.v1.MsgProto.MsgSwapResponse> getMsgSwapMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgSwap",
      requestType = com.sentinel.swap.v1.MsgProto.MsgSwapRequest.class,
      responseType = com.sentinel.swap.v1.MsgProto.MsgSwapResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.swap.v1.MsgProto.MsgSwapRequest,
      com.sentinel.swap.v1.MsgProto.MsgSwapResponse> getMsgSwapMethod() {
    io.grpc.MethodDescriptor<com.sentinel.swap.v1.MsgProto.MsgSwapRequest, com.sentinel.swap.v1.MsgProto.MsgSwapResponse> getMsgSwapMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgSwapMethod = MsgServiceGrpc.getMsgSwapMethod) == null) {
          MsgServiceGrpc.getMsgSwapMethod = getMsgSwapMethod =
              io.grpc.MethodDescriptor.<com.sentinel.swap.v1.MsgProto.MsgSwapRequest, com.sentinel.swap.v1.MsgProto.MsgSwapResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgSwap"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.swap.v1.MsgProto.MsgSwapRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.swap.v1.MsgProto.MsgSwapResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void msgSwap(com.sentinel.swap.v1.MsgProto.MsgSwapRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.swap.v1.MsgProto.MsgSwapResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void msgSwap(com.sentinel.swap.v1.MsgProto.MsgSwapRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.swap.v1.MsgProto.MsgSwapResponse> responseObserver) {
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.sentinel.swap.v1.MsgProto.MsgSwapResponse msgSwap(com.sentinel.swap.v1.MsgProto.MsgSwapRequest request) {
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.swap.v1.MsgProto.MsgSwapResponse> msgSwap(
        com.sentinel.swap.v1.MsgProto.MsgSwapRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MSG_SWAP:
          serviceImpl.msgSwap((com.sentinel.swap.v1.MsgProto.MsgSwapRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.swap.v1.MsgProto.MsgSwapResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.swap.v1.MsgProto.MsgSwapRequest,
              com.sentinel.swap.v1.MsgProto.MsgSwapResponse>(
