...
extension Secret_Compute_V1beta1_GenesisState: @unchecked Sendable {}
extension Secret_Compute_V1beta1_Code: @unchecked Sendable {}
extension Secret_Compute_V1beta1_Contract: @unchecked Sendable {}
extension Secret_Compute_V1beta1_Sequence: @unchecked Sendable {}
...
extension Secret_Compute_V1beta1_Contract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._contractCustomInfo {
