 ...
 */
public final class QueryLiquidityPoolsResponse extends
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.irismod.coinswap.QueryProto.internal_static_irismod_coinswap_QueryLiquidityPoolsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.irismod.coinswap.QueryLiquidityPoolsResponse.class, com.irismod.coinswap.QueryLiquidityPoolsResponse.Builder.class);
  }

  public static final int POOLS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.irismod.coinswap.PoolInfo> pools_;
  /**
   * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
   */
  @java.lang.Override
  public java.util.List<com.irismod.coinswap.PoolInfo> getPoolsList() {
    return pools_;
  }
  /**
   * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
   */
  @java.lang.Override
  public java.util.List<? extends com.irismod.coinswap.PoolInfoOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.irismod.coinswap.PoolInfo getPools(int index) {
   ...
   */
  @java.lang.Override
  public com.irismod.coinswap.PoolInfoOrBuilder getPoolsOrBuilder(
      int index) {
    return pools_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.irismod.coinswap.QueryLiquidityPoolsResponse)) {
      return super.equals(obj);
    }
    com.irismod.coinswap.QueryLiquidityPoolsResponse other = (com.irismod.coinswap.QueryLiquidityPoolsResponse) obj;
  ...
  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseFrom(
  ...
  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseFrom(
  ...
  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.irismod.coinswap.QueryLiquidityPoolsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.irismod.coinswap.QueryLiquidityPoolsResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.irismod.coinswap.QueryLiquidityPoolsResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.irismod.coinswap.QueryProto.internal_static_irismod_coinswap_QueryLiquidityPoolsResponse_descriptor;
    }
    ...
    // Construct using com.irismod.coinswap.QueryLiquidityPoolsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.irismod.coinswap.QueryLiquidityPoolsResponse getDefaultInstanceForType() {
      return com.irismod.coinswap.QueryLiquidityPoolsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.irismod.coinswap.QueryLiquidityPoolsResponse build() {
      com.irismod.coinswap.QueryLiquidityPoolsResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.irismod.coinswap.QueryLiquidityPoolsResponse buildPartial() {
      com.irismod.coinswap.QueryLiquidityPoolsResponse result = new com.irismod.coinswap.QueryLiquidityPoolsResponse(this);
    ...
    private void buildPartialRepeatedFields(com.irismod.coinswap.QueryLiquidityPoolsResponse result) {
      if (poolsBuilder_ == null) {
    ...
    private void buildPartial0(com.irismod.coinswap.QueryLiquidityPoolsResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.irismod.coinswap.QueryLiquidityPoolsResponse) {
        return mergeFrom((com.irismod.coinswap.QueryLiquidityPoolsResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.irismod.coinswap.QueryLiquidityPoolsResponse other) {
      if (other == com.irismod.coinswap.QueryLiquidityPoolsResponse.getDefaultInstance()) return this;
      if (poolsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.irismod.coinswap.PoolInfo m =
                  input.readMessage(
                      com.irismod.coinswap.PoolInfo.parser(),
                      extensionRegistry);
              if (poolsBuilder_ == null) {
                ensurePoolsIsMutable();
                pools_.add(m);
    ...
    private void ensurePoolsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        pools_ = new java.util.ArrayList<com.irismod.coinswap.PoolInfo>(pools_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.irismod.coinswap.PoolInfo, com.irismod.coinswap.PoolInfo.Builder, com.irismod.coinswap.PoolInfoOrBuilder> poolsBuilder_;
    ...
    public Builder setPools(
        int index, com.irismod.coinswap.PoolInfo value) {
      if (poolsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setPools(
        int index, com.irismod.coinswap.PoolInfo.Builder builderForValue) {
      if (poolsBuilder_ == null) {
        ensurePoolsIsMutable();
     ...
     * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
     */
    public Builder addPools(com.irismod.coinswap.PoolInfo value) {
      if (poolsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllPools(
        java.lang.Iterable<? extends com.irismod.coinswap.PoolInfo> values) {
      if (poolsBuilder_ == null) {
        ensurePoolsIsMutable();
     ...
     * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
     */
    public com.irismod.coinswap.PoolInfo.Builder getPoolsBuilder(
        int index) {
     ...
     * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
     */
    public com.irismod.coinswap.PoolInfo.Builder addPoolsBuilder() {
      return getPoolsFieldBuilder().addBuilder(
          com.irismod.coinswap.PoolInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
     */
    public com.irismod.coinswap.PoolInfo.Builder addPoolsBuilder(
        int index) {
      return getPoolsFieldBuilder().addBuilder(
          index, com.irismod.coinswap.PoolInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .irismod.coinswap.PoolInfo pools = 1 [json_name = "pools", (.gogoproto.nullable) = false];</code>
     */
    public java.util.List<com.irismod.coinswap.PoolInfo.Builder> 
         getPoolsBuilderList() {
  ...
  private static final com.irismod.coinswap.QueryLiquidityPoolsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.irismod.coinswap.QueryLiquidityPoolsResponse();
  }

  public static com.irismod.coinswap.QueryLiquidityPoolsResponse getDefaultInstance() {
