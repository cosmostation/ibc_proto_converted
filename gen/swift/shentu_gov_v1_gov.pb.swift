...
struct Shentu_Gov_V1_CustomParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var certifierUpdateSecurityVoteTally: Cosmos_Gov_V1_TallyParams {
    get {return _certifierUpdateSecurityVoteTally ?? Cosmos_Gov_V1_TallyParams()}
  ...
  var certifierUpdateStakeVoteTally: Cosmos_Gov_V1_TallyParams {
    get {return _certifierUpdateStakeVoteTally ?? Cosmos_Gov_V1_TallyParams()}
  ...
  fileprivate var _certifierUpdateSecurityVoteTally: Cosmos_Gov_V1_TallyParams? = nil
  fileprivate var _certifierUpdateStakeVoteTally: Cosmos_Gov_V1_TallyParams? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Shentu_Gov_V1_CustomParams: @unchecked Sendable {}
...
extension Shentu_Gov_V1_CustomParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Shentu_Gov_V1_CustomParams, rhs: Shentu_Gov_V1_CustomParams) -> Bool {
