...
struct Akash_Deployment_V1beta3_Resource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var resources: Akash_Base_V1beta3_ResourceUnits {
    get {return _resources ?? Akash_Base_V1beta3_ResourceUnits()}
  ...
  fileprivate var _resources: Akash_Base_V1beta3_ResourceUnits? = nil
  fileprivate var _price: Cosmos_Base_V1beta1_DecCoin? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Akash_Deployment_V1beta3_Resource: @unchecked Sendable {}
...
extension Akash_Deployment_V1beta3_Resource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Deployment_V1beta3_Resource, rhs: Akash_Deployment_V1beta3_Resource) -> Bool {
