...
var cosmos_distribution_v1beta1_query_pb = require('../../../cosmos/distribution/v1beta1/query_pb.js');
...
function serialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoRequest(arg) {
  if (!(arg instanceof cosmos_distribution_v1beta1_query_pb.QueryValidatorDistributionInfoRequest)) {
    throw new Error('Expected argument of type cosmos.distribution.v1beta1.QueryValidatorDistributionInfoRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoRequest(buffer_arg) {
  return cosmos_distribution_v1beta1_query_pb.QueryValidatorDistributionInfoRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoResponse(arg) {
  if (!(arg instanceof cosmos_distribution_v1beta1_query_pb.QueryValidatorDistributionInfoResponse)) {
    throw new Error('Expected argument of type cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoResponse(buffer_arg) {
  return cosmos_distribution_v1beta1_query_pb.QueryValidatorDistributionInfoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
validatorDistributionInfo: {
    ...
    requestSerialize: serialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoRequest,
    requestDeserialize: deserialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoRequest,
    responseSerialize: serialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoResponse,
    responseDeserialize: deserialize_cosmos_distribution_v1beta1_QueryValidatorDistributionInfoResponse,
  },
