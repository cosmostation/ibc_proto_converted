...
public final class ServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.assetmantle.modules.orders.transactions.immediate.Message,
      com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> getHandleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Handle",
      requestType = com.assetmantle.modules.orders.transactions.immediate.Message.class,
      responseType = com.assetmantle.modules.orders.transactions.immediate.TransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.assetmantle.modules.orders.transactions.immediate.Message,
      com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> getHandleMethod() {
    io.grpc.MethodDescriptor<com.assetmantle.modules.orders.transactions.immediate.Message, com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> getHandleMethod;
    if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
          ServiceGrpc.getHandleMethod = getHandleMethod =
              io.grpc.MethodDescriptor.<com.assetmantle.modules.orders.transactions.immediate.Message, com.assetmantle.modules.orders.transactions.immediate.TransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Handle"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.orders.transactions.immediate.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.orders.transactions.immediate.TransactionResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void handle(com.assetmantle.modules.orders.transactions.immediate.Message request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> responseObserver) {
  ...
  public static final class ServiceStub
    ...
    /**
     */
    public void handle(com.assetmantle.modules.orders.transactions.immediate.Message request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> responseObserver) {
  ...
  public static final class ServiceBlockingStub
    ...
    /**
     */
    public com.assetmantle.modules.orders.transactions.immediate.TransactionResponse handle(com.assetmantle.modules.orders.transactions.immediate.Message request) {
  ...
  public static final class ServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.assetmantle.modules.orders.transactions.immediate.TransactionResponse> handle(
        com.assetmantle.modules.orders.transactions.immediate.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HANDLE:
          serviceImpl.handle((com.assetmantle.modules.orders.transactions.immediate.Message) request,
              (io.grpc.stub.StreamObserver<com.assetmantle.modules.orders.transactions.immediate.TransactionResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.assetmantle.modules.orders.transactions.immediate.Message,
              com.assetmantle.modules.orders.transactions.immediate.TransactionResponse>(
