...
goog.provide('proto.cosmos.params.v1beta1.QueryParamsResponse');
...
proto.cosmos.params.v1beta1.QueryParamsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    param: (f = msg.getParam()) && proto.cosmos.params.v1beta1.ParamChange.toObject(includeInstance, f)
  };
...
proto.cosmos.params.v1beta1.QueryParamsResponse.prototype.getParam = function() {
  return /** @type{?proto.cosmos.params.v1beta1.ParamChange} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.params.v1beta1.ParamChange, 1));
};
