...
public final class ReflectionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.reflection.v1.FileDescriptorsRequest,
      com.cosmos.reflection.v1.FileDescriptorsResponse> getFileDescriptorsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FileDescriptors",
      requestType = com.cosmos.reflection.v1.FileDescriptorsRequest.class,
      responseType = com.cosmos.reflection.v1.FileDescriptorsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.reflection.v1.FileDescriptorsRequest,
      com.cosmos.reflection.v1.FileDescriptorsResponse> getFileDescriptorsMethod() {
    io.grpc.MethodDescriptor<com.cosmos.reflection.v1.FileDescriptorsRequest, com.cosmos.reflection.v1.FileDescriptorsResponse> getFileDescriptorsMethod;
      ...
      synchronized (ReflectionServiceGrpc.class) {
        if ((getFileDescriptorsMethod = ReflectionServiceGrpc.getFileDescriptorsMethod) == null) {
          ReflectionServiceGrpc.getFileDescriptorsMethod = getFileDescriptorsMethod =
              io.grpc.MethodDescriptor.<com.cosmos.reflection.v1.FileDescriptorsRequest, com.cosmos.reflection.v1.FileDescriptorsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FileDescriptors"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.reflection.v1.FileDescriptorsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.reflection.v1.FileDescriptorsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void fileDescriptors(com.cosmos.reflection.v1.FileDescriptorsRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.reflection.v1.FileDescriptorsResponse> responseObserver) {
  ...
  public static final class ReflectionServiceStub
     ...
     * </pre>
     */
    public void fileDescriptors(com.cosmos.reflection.v1.FileDescriptorsRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.reflection.v1.FileDescriptorsResponse> responseObserver) {
  ...
  public static final class ReflectionServiceBlockingStub
     ...
     * </pre>
     */
    public com.cosmos.reflection.v1.FileDescriptorsResponse fileDescriptors(com.cosmos.reflection.v1.FileDescriptorsRequest request) {
  ...
  public static final class ReflectionServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cosmos.reflection.v1.FileDescriptorsResponse> fileDescriptors(
        com.cosmos.reflection.v1.FileDescriptorsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FILE_DESCRIPTORS:
          serviceImpl.fileDescriptors((com.cosmos.reflection.v1.FileDescriptorsRequest) request,
              (io.grpc.stub.StreamObserver<com.cosmos.reflection.v1.FileDescriptorsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cosmos.reflection.v1.FileDescriptorsRequest,
              com.cosmos.reflection.v1.FileDescriptorsResponse>(
