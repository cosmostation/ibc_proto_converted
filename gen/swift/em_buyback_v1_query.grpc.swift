...
extension Em_Buyback_V1_QueryClientProtocol {
  ...
  internal func balance(
    ...
    return self.makeUnaryCall(
      path: Em_Buyback_V1_QueryClientMetadata.Methods.balance.path,
      request: request,
  ...
  internal func buybackTime(
    ...
    return self.makeUnaryCall(
      path: Em_Buyback_V1_QueryClientMetadata.Methods.buybackTime.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
extension Em_Buyback_V1_QueryClient: @unchecked Sendable {}

@available(*, deprecated, renamed: "Em_Buyback_V1_QueryNIOClient")
internal final class Em_Buyback_V1_QueryClient: Em_Buyback_V1_QueryClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  private var _interceptors: Em_Buyback_V1_QueryClientInterceptorFactoryProtocol?
...
internal struct Em_Buyback_V1_QueryNIOClient: Em_Buyback_V1_QueryClientProtocol {
...
internal protocol Em_Buyback_V1_QueryAsyncClientProtocol: GRPCClient {
  ...
  func makeBalanceCall(
    _ request: Em_Buyback_V1_QueryBalanceRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Em_Buyback_V1_QueryBalanceRequest, Em_Buyback_V1_QueryBalanceResponse>

  func makeBuybackTimeCall(
    _ request: Em_Buyback_V1_QueryBuybackTimeRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Em_Buyback_V1_QueryBuybackTimeRequest, Em_Buyback_V1_QueryBuybackTimeResponse>
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Em_Buyback_V1_QueryAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Em_Buyback_V1_QueryClientMetadata.serviceDescriptor
  }
  ...
  internal func makeBuybackTimeCall(
    _ request: Em_Buyback_V1_QueryBuybackTimeRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Em_Buyback_V1_QueryBuybackTimeRequest, Em_Buyback_V1_QueryBuybackTimeResponse> {
    return self.makeAsyncUnaryCall(
...
extension Em_Buyback_V1_QueryAsyncClientProtocol {
  internal func balance(
    _ request: Em_Buyback_V1_QueryBalanceRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Em_Buyback_V1_QueryBalanceResponse {
  ...
  internal func buybackTime(
    _ request: Em_Buyback_V1_QueryBuybackTimeRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Em_Buyback_V1_QueryBuybackTimeResponse {
    return try await self.performAsyncUnaryCall(
      path: Em_Buyback_V1_QueryClientMetadata.Methods.buybackTime.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Em_Buyback_V1_QueryAsyncClient: Em_Buyback_V1_QueryAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Em_Buyback_V1_QueryClientInterceptorFactoryProtocol?
...
internal protocol Em_Buyback_V1_QueryClientInterceptorFactoryProtocol: Sendable {
...
internal enum Em_Buyback_V1_QueryClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "em.buyback.v1.Query",
    methods: [
      Em_Buyback_V1_QueryClientMetadata.Methods.balance,
      Em_Buyback_V1_QueryClientMetadata.Methods.buybackTime,
    ]
  )
  ...
  internal enum Methods {
    ...
    internal static let buybackTime = GRPCMethodDescriptor(
      name: "BuybackTime",
...
extension Em_Buyback_V1_QueryProvider {
  internal var serviceName: Substring {
    return Em_Buyback_V1_QueryServerMetadata.serviceDescriptor.fullName[...]
  }
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Em_Buyback_V1_QueryAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Em_Buyback_V1_QueryServerInterceptorFactoryProtocol? { get }

  /// Query for the current buyback balance
  @Sendable func balance(
    request: Em_Buyback_V1_QueryBalanceRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Em_Buyback_V1_QueryBalanceResponse

  /// Query for buyback time periods
  @Sendable func buybackTime(
    request: Em_Buyback_V1_QueryBuybackTimeRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Em_Buyback_V1_QueryBuybackTimeResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Em_Buyback_V1_QueryAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Em_Buyback_V1_QueryServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Em_Buyback_V1_QueryServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "BuybackTime":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Em_Buyback_V1_QueryBuybackTimeResponse>(),
        interceptors: self.interceptors?.makeBuybackTimeInterceptors() ?? [],
        wrapping: self.buybackTime(request:context:)
      )
...
internal enum Em_Buyback_V1_QueryServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "em.buyback.v1.Query",
    methods: [
      Em_Buyback_V1_QueryServerMetadata.Methods.balance,
      Em_Buyback_V1_QueryServerMetadata.Methods.buybackTime,
    ]
  )
