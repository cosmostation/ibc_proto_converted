...
struct Assetmantle_Modules_Assets_Transactions_Mint_TransactionResponse {
...
extension Assetmantle_Modules_Assets_Transactions_Mint_TransactionResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "assetmantle.modules.assets.transactions.mint"

extension Assetmantle_Modules_Assets_Transactions_Mint_TransactionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Assetmantle_Modules_Assets_Transactions_Mint_TransactionResponse, rhs: Assetmantle_Modules_Assets_Transactions_Mint_TransactionResponse) -> Bool {
