...
struct Ixo_Bonds_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var bonds: [Ixo_Bonds_V1beta1_Bond] = []

  var batches: [Ixo_Bonds_V1beta1_Batch] = []
...
extension Ixo_Bonds_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Ixo_Bonds_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ixo_Bonds_V1beta1_GenesisState, rhs: Ixo_Bonds_V1beta1_GenesisState) -> Bool {
