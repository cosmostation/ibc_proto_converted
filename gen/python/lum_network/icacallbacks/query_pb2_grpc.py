...
class Query(object):
    ...
    def Params(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.icacallbacks.Query/Params',
            lum__network_dot_icacallbacks_dot_query__pb2.QueryParamsRequest.SerializeToString,
            lum__network_dot_icacallbacks_dot_query__pb2.QueryParamsResponse.FromString,
    ...
    def CallbackData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.icacallbacks.Query/CallbackData',
            lum__network_dot_icacallbacks_dot_query__pb2.QueryGetCallbackDataRequest.SerializeToString,
            lum__network_dot_icacallbacks_dot_query__pb2.QueryGetCallbackDataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CallbackDataAll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lum.network.icacallbacks.Query/CallbackDataAll',
            lum__network_dot_icacallbacks_dot_query__pb2.QueryAllCallbackDataRequest.SerializeToString,
            lum__network_dot_icacallbacks_dot_query__pb2.QueryAllCallbackDataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
