...
proto.tendermint.abci.RequestBeginBlock.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastCommitInfo: (f = msg.getLastCommitInfo()) && proto.tendermint.abci.CommitInfo.toObject(includeInstance, f),
...
proto.tendermint.abci.RequestBeginBlock.prototype.getLastCommitInfo = function() {
  return /** @type{?proto.tendermint.abci.CommitInfo} */ (
    jspb.Message.getWrapperField(this, proto.tendermint.abci.CommitInfo, 3));
};
