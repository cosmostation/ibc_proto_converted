...
goog.provide('proto.injective.peggy.v1.QueryLastEventByAddrResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.peggy.v1.LastClaimEvent');
...
proto.injective.peggy.v1.QueryLastEventByAddrResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    lastClaimEvent: (f = msg.getLastClaimEvent()) && proto.injective.peggy.v1.LastClaimEvent.toObject(includeInstance, f)
  };
...
proto.injective.peggy.v1.QueryLastEventByAddrResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.injective.peggy.v1.LastClaimEvent;
      reader.readMessage(value,proto.injective.peggy.v1.LastClaimEvent.deserializeBinaryFromReader);
...
proto.injective.peggy.v1.QueryLastEventByAddrResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.injective.peggy.v1.LastClaimEvent.serializeBinaryToWriter
    );
  }
};
...
proto.injective.peggy.v1.QueryLastEventByAddrResponse.prototype.getLastClaimEvent = function() {
  return /** @type{?proto.injective.peggy.v1.LastClaimEvent} */ (
    jspb.Message.getWrapperField(this, proto.injective.peggy.v1.LastClaimEvent, 1));
};
