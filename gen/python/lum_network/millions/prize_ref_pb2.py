...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PRIZEREF'].fields_by_name['amount']._options = None
  _globals['_PRIZEREF'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int'
  _globals['_PRIZEREF'].fields_by_name['prize_id']._options = None
  _globals['_PRIZEREF'].fields_by_name['prize_id']._serialized_options = b'\310\336\037\001'
  _globals['_PRIZEREF'].fields_by_name['winner_address']._options = None
  _globals['_PRIZEREF'].fields_by_name['winner_address']._serialized_options = b'\310\336\037\001\322\264-\024cosmos.AddressString'
