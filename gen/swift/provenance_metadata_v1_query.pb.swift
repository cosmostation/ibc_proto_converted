...
struct Provenance_Metadata_V1_ScopeSpecificationRequest {
  ...
  /// be included.
  var includeContractSpecs: Bool = false
...
struct Provenance_Metadata_V1_ScopeSpecificationResponse {
  ...
  var scopeSpecification: Provenance_Metadata_V1_ScopeSpecificationWrapper {
    get {return _storage._scopeSpecification ?? Provenance_Metadata_V1_ScopeSpecificationWrapper()}
    set {_uniqueStorage()._scopeSpecification = newValue}
  }
  /// Returns true if `scopeSpecification` has been explicitly set.
  var hasScopeSpecification: Bool {return _storage._scopeSpecification != nil}
  /// Clears the value of `scopeSpecification`. Subsequent reads from it will return its default value.
  mutating func clearScopeSpecification() {_uniqueStorage()._scopeSpecification = nil}

  /// contract_specs is any number of wrapped contract specifications in this scope specification (if requested).
  var contractSpecs: [Provenance_Metadata_V1_ContractSpecificationWrapper] {
    get {return _storage._contractSpecs}
    set {_uniqueStorage()._contractSpecs = newValue}
  }

  /// record_specs is any number of wrapped record specifications in this scope specification (if requested).
  var recordSpecs: [Provenance_Metadata_V1_RecordSpecificationWrapper] {
    get {return _storage._recordSpecs}
    set {_uniqueStorage()._recordSpecs = newValue}
  }

  /// request is a copy of the request that generated these results.
  var request: Provenance_Metadata_V1_ScopeSpecificationRequest {
    get {return _storage._request ?? Provenance_Metadata_V1_ScopeSpecificationRequest()}
    set {_uniqueStorage()._request = newValue}
  }
  /// Returns true if `request` has been explicitly set.
  var hasRequest: Bool {return _storage._request != nil}
...
struct Provenance_Metadata_V1_AccountDataRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Metadata_V1_AccountDataResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Provenance_Metadata_V1_QueryParamsRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_QueryParamsResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopesAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopesAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionsRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionsResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionsAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_SessionsAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordsRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordsResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordsAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordsAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OwnershipRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OwnershipResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ValueOwnershipRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ValueOwnershipResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeSpecificationWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeSpecificationsAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ScopeSpecificationsAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ContractSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ContractSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_ContractSpecificationWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_ContractSpecificationsAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_ContractSpecificationsAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationsForContractSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationsForContractSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationWrapper: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationsAllRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_RecordSpecificationsAllResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorParamsRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorParamsResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorsByURIRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorsByURIResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorsByScopeRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSLocatorsByScopeResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSAllLocatorsRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_OSAllLocatorsResponse: @unchecked Sendable {}
extension Provenance_Metadata_V1_AccountDataRequest: @unchecked Sendable {}
extension Provenance_Metadata_V1_AccountDataResponse: @unchecked Sendable {}
...
extension Provenance_Metadata_V1_SessionWrapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._contractSpecIDInfo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
...
extension Provenance_Metadata_V1_RecordWrapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._recordIDInfo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      try { if let v = _storage._recordSpecIDInfo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
...
extension Provenance_Metadata_V1_ScopeSpecificationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "include_contract_specs"),
    11: .standard(proto: "include_record_specs"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularBoolField(value: &self.includeContractSpecs) }()
      case 11: try { try decoder.decodeSingularBoolField(value: &self.includeRecordSpecs) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.includeContractSpecs != false {
      try visitor.visitSingularBoolField(value: self.includeContractSpecs, fieldNumber: 10)
    }
    if self.includeRecordSpecs != false {
      try visitor.visitSingularBoolField(value: self.includeRecordSpecs, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Provenance_Metadata_V1_ScopeSpecificationRequest, rhs: Provenance_Metadata_V1_ScopeSpecificationRequest) -> Bool {
    ...
    if lhs.includeContractSpecs != rhs.includeContractSpecs {return false}
...
extension Provenance_Metadata_V1_ScopeSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "contract_specs"),
    3: .standard(proto: "record_specs"),
    98: .same(proto: "request"),
  ]

  fileprivate class _StorageClass {
    var _scopeSpecification: Provenance_Metadata_V1_ScopeSpecificationWrapper? = nil
    var _contractSpecs: [Provenance_Metadata_V1_ContractSpecificationWrapper] = []
    var _recordSpecs: [Provenance_Metadata_V1_RecordSpecificationWrapper] = []
    var _request: Provenance_Metadata_V1_ScopeSpecificationRequest? = nil
    ...
    init(copying source: _StorageClass) {
      _scopeSpecification = source._scopeSpecification
      _contractSpecs = source._contractSpecs
      _recordSpecs = source._recordSpecs
      _request = source._request
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._scopeSpecification) }()
        case 2: try { try decoder.decodeRepeatedMessageField(value: &_storage._contractSpecs) }()
        case 3: try { try decoder.decodeRepeatedMessageField(value: &_storage._recordSpecs) }()
        case 98: try { try decoder.decodeSingularMessageField(value: &_storage._request) }()
        default: break
        }
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      try { if let v = _storage._scopeSpecification {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      } }()
      if !_storage._contractSpecs.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._contractSpecs, fieldNumber: 2)
      }
      if !_storage._recordSpecs.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._recordSpecs, fieldNumber: 3)
      }
      try { if let v = _storage._request {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 98)
      } }()
  ...
  static func ==(lhs: Provenance_Metadata_V1_ScopeSpecificationResponse, rhs: Provenance_Metadata_V1_ScopeSpecificationResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._scopeSpecification != rhs_storage._scopeSpecification {return false}
        if _storage._contractSpecs != rhs_storage._contractSpecs {return false}
        if _storage._recordSpecs != rhs_storage._recordSpecs {return false}
        if _storage._request != rhs_storage._request {return false}
        return true
      }
      if !storagesAreEqual {return false}
...
extension Provenance_Metadata_V1_ContractSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      try { if let v = _storage._contractSpecification {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      } }()
...
extension Provenance_Metadata_V1_RecordSpecificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      try { if let v = _storage._recordSpecification {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      } }()
      try { if let v = _storage._request {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 98)
...
extension Provenance_Metadata_V1_AccountDataRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AccountDataRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Provenance_Metadata_V1_AccountDataRequest, rhs: Provenance_Metadata_V1_AccountDataRequest) -> Bool {
...
extension Provenance_Metadata_V1_AccountDataResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AccountDataResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ]
  ...
  static func ==(lhs: Provenance_Metadata_V1_AccountDataResponse, rhs: Provenance_Metadata_V1_AccountDataResponse) -> Bool {
