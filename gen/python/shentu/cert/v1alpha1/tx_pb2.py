...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\030com.shentu.cert.v1alpha1B\007TxProtoP\001Z/github.com/shentufoundation/shentu/x/cert/types\242\002\003SCX\252\002\024Shentu.Cert.V1alpha1\312\002\024Shentu\\Cert\\V1alpha1\342\002 Shentu\\Cert\\V1alpha1\\GPBMetadata\352\002\026Shentu::Cert::V1alpha1'
  _MSGPROPOSECERTIFIER.fields_by_name['proposer']._options = None
  _MSGPROPOSECERTIFIER.fields_by_name['proposer']._serialized_options = b'\362\336\037\017yaml:\"proposer\"'
  _MSGPROPOSECERTIFIER.fields_by_name['alias']._options = None
  _MSGPROPOSECERTIFIER.fields_by_name['alias']._serialized_options = b'\362\336\037\014yaml:\"alias\"'
  _MSGPROPOSECERTIFIER.fields_by_name['certifier']._options = None
  _MSGPROPOSECERTIFIER.fields_by_name['certifier']._serialized_options = b'\362\336\037\020yaml:\"certifier\"'
  _MSGPROPOSECERTIFIER.fields_by_name['description']._options = None
  _MSGPROPOSECERTIFIER.fields_by_name['description']._serialized_options = b'\362\336\037\022yaml:\"description\"'
  _MSGPROPOSECERTIFIER._options = None
  _MSGPROPOSECERTIFIER._serialized_options = b'\210\240\037\000\350\240\037\000'
  _MSGISSUECERTIFICATE.fields_by_name['content']._options = None
  _MSGISSUECERTIFICATE.fields_by_name['content']._serialized_options = b'\312\264-\007Content'
  _MSGISSUECERTIFICATE.fields_by_name['compiler']._options = None
  _MSGISSUECERTIFICATE.fields_by_name['compiler']._serialized_options = b'\362\336\037\017yaml:\"compiler\"'
  _MSGISSUECERTIFICATE.fields_by_name['bytecode_hash']._options = None
  _MSGISSUECERTIFICATE.fields_by_name['bytecode_hash']._serialized_options = b'\362\336\037\023yaml:\"bytecodehash\"'
  _MSGISSUECERTIFICATE.fields_by_name['description']._options = None
  _MSGISSUECERTIFICATE.fields_by_name['description']._serialized_options = b'\362\336\037\022yaml:\"description\"'
  _MSGISSUECERTIFICATE.fields_by_name['certifier']._options = None
  _MSGISSUECERTIFICATE.fields_by_name['certifier']._serialized_options = b'\362\336\037\020yaml:\"certifier\"'
  _MSGISSUECERTIFICATE._options = None
  _MSGISSUECERTIFICATE._serialized_options = b'\210\240\037\000\350\240\037\000'
  _MSGREVOKECERTIFICATE.fields_by_name['revoker']._options = None
  _MSGREVOKECERTIFICATE.fields_by_name['revoker']._serialized_options = b'\362\336\037\016yaml:\"revoker\"'
  _MSGREVOKECERTIFICATE.fields_by_name['id']._options = None
  _MSGREVOKECERTIFICATE.fields_by_name['id']._serialized_options = b'\362\336\037\tyaml:\"id\"'
  _MSGREVOKECERTIFICATE.fields_by_name['description']._options = None
  _MSGREVOKECERTIFICATE.fields_by_name['description']._serialized_options = b'\362\336\037\022yaml:\"description\"'
  _MSGREVOKECERTIFICATE._options = None
  _MSGREVOKECERTIFICATE._serialized_options = b'\210\240\037\000\350\240\037\000'
  _MSGCERTIFYPLATFORM.fields_by_name['certifier']._options = None
  _MSGCERTIFYPLATFORM.fields_by_name['certifier']._serialized_options = b'\362\336\037\020yaml:\"certifier\"'
  _MSGCERTIFYPLATFORM.fields_by_name['validator_pubkey']._options = None
  _MSGCERTIFYPLATFORM.fields_by_name['validator_pubkey']._serialized_options = b'\312\264-\024cosmos.crypto.PubKey'
  _MSGCERTIFYPLATFORM.fields_by_name['platform']._options = None
  _MSGCERTIFYPLATFORM.fields_by_name['platform']._serialized_options = b'\362\336\037\017yaml:\"platform\"'
  _MSGCERTIFYPLATFORM._options = None
  _MSGCERTIFYPLATFORM._serialized_options = b'\210\240\037\000\350\240\037\000'
