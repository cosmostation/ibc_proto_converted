...
public final class MsgGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgAnchorData,
      com.regen.data.v1alpha2.MsgAnchorDataResponse> getAnchorDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AnchorData",
      requestType = com.regen.data.v1alpha2.MsgAnchorData.class,
      responseType = com.regen.data.v1alpha2.MsgAnchorDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgAnchorData,
      com.regen.data.v1alpha2.MsgAnchorDataResponse> getAnchorDataMethod() {
    io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgAnchorData, com.regen.data.v1alpha2.MsgAnchorDataResponse> getAnchorDataMethod;
    if ((getAnchorDataMethod = MsgGrpc.getAnchorDataMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getAnchorDataMethod = MsgGrpc.getAnchorDataMethod) == null) {
          MsgGrpc.getAnchorDataMethod = getAnchorDataMethod =
              io.grpc.MethodDescriptor.<com.regen.data.v1alpha2.MsgAnchorData, com.regen.data.v1alpha2.MsgAnchorDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AnchorData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.regen.data.v1alpha2.MsgAnchorData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.regen.data.v1alpha2.MsgAnchorDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgSignData,
      com.regen.data.v1alpha2.MsgSignDataResponse> getSignDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SignData",
      requestType = com.regen.data.v1alpha2.MsgSignData.class,
      responseType = com.regen.data.v1alpha2.MsgSignDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgSignData,
      com.regen.data.v1alpha2.MsgSignDataResponse> getSignDataMethod() {
    io.grpc.MethodDescriptor<com.regen.data.v1alpha2.MsgSignData, com.regen.data.v1alpha2.MsgSignDataResponse> getSignDataMethod;
    if ((getSignDataMethod = MsgGrpc.getSignDataMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getSignDataMethod = MsgGrpc.getSignDataMethod) == null) {
          MsgGrpc.getSignDataMethod = getSignDataMethod =
              io.grpc.MethodDescriptor.<com.regen.data.v1alpha2.MsgSignData, com.regen.data.v1alpha2.MsgSignDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SignData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.regen.data.v1alpha2.MsgSignData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.regen.data.v1alpha2.MsgSignDataResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void anchorData(com.regen.data.v1alpha2.MsgAnchorData request,
        io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgAnchorDataResponse> responseObserver) {
     ...
     * </pre>
     */
    default void signData(com.regen.data.v1alpha2.MsgSignData request,
        io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgSignDataResponse> responseObserver) {
  ...
  public static final class MsgStub
     ...
     * </pre>
     */
    public void anchorData(com.regen.data.v1alpha2.MsgAnchorData request,
        io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgAnchorDataResponse> responseObserver) {
     ...
     * </pre>
     */
    public void signData(com.regen.data.v1alpha2.MsgSignData request,
        io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgSignDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgBlockingStub
     ...
     * </pre>
     */
    public com.regen.data.v1alpha2.MsgAnchorDataResponse anchorData(com.regen.data.v1alpha2.MsgAnchorData request) {
     ...
     * </pre>
     */
    public com.regen.data.v1alpha2.MsgSignDataResponse signData(com.regen.data.v1alpha2.MsgSignData request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.regen.data.v1alpha2.MsgAnchorDataResponse> anchorData(
        com.regen.data.v1alpha2.MsgAnchorData request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.regen.data.v1alpha2.MsgSignDataResponse> signData(
        com.regen.data.v1alpha2.MsgSignData request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ANCHOR_DATA:
          serviceImpl.anchorData((com.regen.data.v1alpha2.MsgAnchorData) request,
              (io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgAnchorDataResponse>) responseObserver);
          break;
        case METHODID_SIGN_DATA:
          serviceImpl.signData((com.regen.data.v1alpha2.MsgSignData) request,
              (io.grpc.stub.StreamObserver<com.regen.data.v1alpha2.MsgSignDataResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.regen.data.v1alpha2.MsgAnchorData,
              com.regen.data.v1alpha2.MsgAnchorDataResponse>(
                service, METHODID_ANCHOR_DATA)))
        .addMethod(
          getSignDataMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.regen.data.v1alpha2.MsgSignData,
              com.regen.data.v1alpha2.MsgSignDataResponse>(
