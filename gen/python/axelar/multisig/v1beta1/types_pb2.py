...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\033com.axelar.multisig.v1beta1B\nTypesProtoP\001Z5github.com/axelarnetwork/axelar-core/x/multisig/types\242\002\003AMX\252\002\027Axelar.Multisig.V1beta1\312\002\027Axelar\\Multisig\\V1beta1\342\002#Axelar\\Multisig\\V1beta1\\GPBMetadata\352\002\031Axelar::Multisig::V1beta1'
  _KEY_PUBKEYSENTRY._options = None
  _KEY_PUBKEYSENTRY._serialized_options = b'8\001'
  _KEY.fields_by_name['id']._options = None
  _KEY.fields_by_name['id']._serialized_options = b'\342\336\037\002ID\372\336\037>github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID'
  _KEY.fields_by_name['snapshot']._options = None
  _KEY.fields_by_name['snapshot']._serialized_options = b'\310\336\037\000'
  _KEY.fields_by_name['pub_keys']._options = None
  _KEY.fields_by_name['pub_keys']._serialized_options = b'\212\337\037Bgithub.com/axelarnetwork/axelar-core/x/multisig/exported.PublicKey'
  _KEY.fields_by_name['signing_threshold']._options = None
  _KEY.fields_by_name['signing_threshold']._serialized_options = b'\310\336\037\000'
  _KEY._options = None
  _KEY._serialized_options = b'\230\241\037\001'
  _KEYGENSESSION_ISPUBKEYRECEIVEDENTRY._options = None
  _KEYGENSESSION_ISPUBKEYRECEIVEDENTRY._serialized_options = b'8\001'
  _KEYGENSESSION.fields_by_name['key']._options = None
  _KEYGENSESSION.fields_by_name['key']._serialized_options = b'\310\336\037\000'
  _KEYGENSESSION.fields_by_name['keygen_threshold']._options = None
  _KEYGENSESSION.fields_by_name['keygen_threshold']._serialized_options = b'\310\336\037\000'
  _KEYGENSESSION._options = None
  _KEYGENSESSION._serialized_options = b'\230\241\037\001'
  _MULTISIG_SIGSENTRY._options = None
  _MULTISIG_SIGSENTRY._serialized_options = b'8\001'
  _MULTISIG.fields_by_name['key_id']._options = None
  _MULTISIG.fields_by_name['key_id']._serialized_options = b'\342\336\037\005KeyID\372\336\037>github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID'
  _MULTISIG.fields_by_name['payload_hash']._options = None
  _MULTISIG.fields_by_name['payload_hash']._serialized_options = b'\372\336\037=github.com/axelarnetwork/axelar-core/x/multisig/exported.Hash'
  _MULTISIG.fields_by_name['sigs']._options = None
  _MULTISIG.fields_by_name['sigs']._serialized_options = b'\212\337\037\tSignature'
  _MULTISIG._options = None
  _MULTISIG._serialized_options = b'\230\241\037\001'
  _SIGNINGSESSION.fields_by_name['id']._options = None
  _SIGNINGSESSION.fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
  _SIGNINGSESSION.fields_by_name['multi_sig']._options = None
  _SIGNINGSESSION.fields_by_name['multi_sig']._serialized_options = b'\310\336\037\000'
  _SIGNINGSESSION.fields_by_name['key']._options = None
  _SIGNINGSESSION.fields_by_name['key']._serialized_options = b'\310\336\037\000'
  _SIGNINGSESSION.fields_by_name['module_metadata']._options = None
  _SIGNINGSESSION.fields_by_name['module_metadata']._serialized_options = b'\312\264-&github.com/cosmos/codec/ProtoMarshaler'
  _SIGNINGSESSION._options = None
  _SIGNINGSESSION._serialized_options = b'\230\241\037\001'
  _KEYEPOCH.fields_by_name['chain']._options = None
  _KEYEPOCH.fields_by_name['chain']._serialized_options = b'\372\336\037?github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName'
  _KEYEPOCH.fields_by_name['key_id']._options = None
  _KEYEPOCH.fields_by_name['key_id']._serialized_options = b'\342\336\037\005KeyID\372\336\037>github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID'
