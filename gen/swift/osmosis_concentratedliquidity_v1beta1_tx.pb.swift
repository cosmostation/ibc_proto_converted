...
struct Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositionsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositions: @unchecked Sendable {}
extension Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositionsResponse: @unchecked Sendable {}
...
extension Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgTransferPositions"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "position_ids"),
    2: .same(proto: "sender"),
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositions, rhs: Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositions) -> Bool {
    if lhs.positionIds != rhs.positionIds {return false}
    if lhs.sender != rhs.sender {return false}
...
extension Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositionsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgTransferPositionsResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositionsResponse, rhs: Osmosis_Concentratedliquidity_V1beta1_MsgTransferPositionsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
