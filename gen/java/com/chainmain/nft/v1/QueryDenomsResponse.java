...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.chainmain.nft.v1.QueryProto.internal_static_chainmain_nft_v1_QueryDenomsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.chainmain.nft.v1.QueryDenomsResponse.class, com.chainmain.nft.v1.QueryDenomsResponse.Builder.class);
  }

  public static final int DENOMS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.chainmain.nft.v1.Denom> denoms_;
  /**
   * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
   */
  @java.lang.Override
  public java.util.List<com.chainmain.nft.v1.Denom> getDenomsList() {
    return denoms_;
  }
  /**
   * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
   */
  @java.lang.Override
  public java.util.List<? extends com.chainmain.nft.v1.DenomOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.chainmain.nft.v1.Denom getDenoms(int index) {
   ...
   */
  @java.lang.Override
  public com.chainmain.nft.v1.DenomOrBuilder getDenomsOrBuilder(
      int index) {
    return denoms_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.chainmain.nft.v1.QueryDenomsResponse)) {
      return super.equals(obj);
    }
    com.chainmain.nft.v1.QueryDenomsResponse other = (com.chainmain.nft.v1.QueryDenomsResponse) obj;
  ...
  public static com.chainmain.nft.v1.QueryDenomsResponse parseFrom(
  ...
  public static com.chainmain.nft.v1.QueryDenomsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.chainmain.nft.v1.QueryDenomsResponse parseFrom(
  ...
  public static com.chainmain.nft.v1.QueryDenomsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.chainmain.nft.v1.QueryDenomsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.chainmain.nft.v1.QueryDenomsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.chainmain.nft.v1.QueryDenomsResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.chainmain.nft.v1.QueryDenomsResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.chainmain.nft.v1.QueryProto.internal_static_chainmain_nft_v1_QueryDenomsResponse_descriptor;
    }
    ...
    // Construct using com.chainmain.nft.v1.QueryDenomsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.chainmain.nft.v1.QueryDenomsResponse getDefaultInstanceForType() {
      return com.chainmain.nft.v1.QueryDenomsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.chainmain.nft.v1.QueryDenomsResponse build() {
      com.chainmain.nft.v1.QueryDenomsResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.chainmain.nft.v1.QueryDenomsResponse buildPartial() {
      com.chainmain.nft.v1.QueryDenomsResponse result = new com.chainmain.nft.v1.QueryDenomsResponse(this);
    ...
    private void buildPartialRepeatedFields(com.chainmain.nft.v1.QueryDenomsResponse result) {
      if (denomsBuilder_ == null) {
    ...
    private void buildPartial0(com.chainmain.nft.v1.QueryDenomsResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.chainmain.nft.v1.QueryDenomsResponse) {
        return mergeFrom((com.chainmain.nft.v1.QueryDenomsResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.chainmain.nft.v1.QueryDenomsResponse other) {
      if (other == com.chainmain.nft.v1.QueryDenomsResponse.getDefaultInstance()) return this;
      if (denomsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.chainmain.nft.v1.Denom m =
                  input.readMessage(
                      com.chainmain.nft.v1.Denom.parser(),
                      extensionRegistry);
              if (denomsBuilder_ == null) {
                ensureDenomsIsMutable();
                denoms_.add(m);
    ...
    private void ensureDenomsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        denoms_ = new java.util.ArrayList<com.chainmain.nft.v1.Denom>(denoms_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.chainmain.nft.v1.Denom, com.chainmain.nft.v1.Denom.Builder, com.chainmain.nft.v1.DenomOrBuilder> denomsBuilder_;
    ...
    public Builder setDenoms(
        int index, com.chainmain.nft.v1.Denom value) {
      if (denomsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setDenoms(
        int index, com.chainmain.nft.v1.Denom.Builder builderForValue) {
      if (denomsBuilder_ == null) {
        ensureDenomsIsMutable();
     ...
     * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
     */
    public Builder addDenoms(com.chainmain.nft.v1.Denom value) {
      if (denomsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllDenoms(
        java.lang.Iterable<? extends com.chainmain.nft.v1.Denom> values) {
      if (denomsBuilder_ == null) {
        ensureDenomsIsMutable();
     ...
     * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
     */
    public com.chainmain.nft.v1.Denom.Builder getDenomsBuilder(
        int index) {
     ...
     * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
     */
    public com.chainmain.nft.v1.Denom.Builder addDenomsBuilder() {
      return getDenomsFieldBuilder().addBuilder(
          com.chainmain.nft.v1.Denom.getDefaultInstance());
    }
    /**
     * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
     */
    public com.chainmain.nft.v1.Denom.Builder addDenomsBuilder(
        int index) {
      return getDenomsFieldBuilder().addBuilder(
          index, com.chainmain.nft.v1.Denom.getDefaultInstance());
    }
    /**
     * <code>repeated .chainmain.nft.v1.Denom denoms = 1 [json_name = "denoms", (.gogoproto.nullable) = false];</code>
     */
    public java.util.List<com.chainmain.nft.v1.Denom.Builder> 
  ...
  private static final com.chainmain.nft.v1.QueryDenomsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.chainmain.nft.v1.QueryDenomsResponse();
  }

  public static com.chainmain.nft.v1.QueryDenomsResponse getDefaultInstance() {
