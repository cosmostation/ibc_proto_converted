...
struct Zrchain_Policy_SignMethodPasskey {
...
extension Zrchain_Policy_SignMethodPasskey: @unchecked Sendable {}
...
extension Zrchain_Policy_SignMethodPasskey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SignMethodPasskey"
  ...
  static func ==(lhs: Zrchain_Policy_SignMethodPasskey, rhs: Zrchain_Policy_SignMethodPasskey) -> Bool {
