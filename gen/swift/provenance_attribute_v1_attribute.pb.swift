...
struct Provenance_Attribute_V1_EventAttributeExpirationUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var originalExpiration: String = String()

  var updatedExpiration: String = String()
...
struct Provenance_Attribute_V1_EventAttributeExpired {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Attribute_V1_EventAccountDataUpdated {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Provenance_Attribute_V1_AttributeType: @unchecked Sendable {}
extension Provenance_Attribute_V1_Params: @unchecked Sendable {}
extension Provenance_Attribute_V1_Attribute: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeAdd: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeUpdate: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeExpirationUpdate: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeDelete: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeDistinctDelete: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAttributeExpired: @unchecked Sendable {}
extension Provenance_Attribute_V1_EventAccountDataUpdated: @unchecked Sendable {}
...
extension Provenance_Attribute_V1_Attribute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._expirationDate) }()
      default: break
      }
    }
  }
...
extension Provenance_Attribute_V1_EventAttributeAdd: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularStringField(value: &self.expiration) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.expiration.isEmpty {
      try visitor.visitSingularStringField(value: self.expiration, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Provenance_Attribute_V1_EventAttributeExpirationUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventAttributeExpirationUpdate"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "value"),
    3: .same(proto: "account"),
    4: .same(proto: "owner"),
    5: .standard(proto: "original_expiration"),
    6: .standard(proto: "updated_expiration"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.originalExpiration) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.updatedExpiration) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.originalExpiration.isEmpty {
      try visitor.visitSingularStringField(value: self.originalExpiration, fieldNumber: 5)
    }
    if !self.updatedExpiration.isEmpty {
      try visitor.visitSingularStringField(value: self.updatedExpiration, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Provenance_Attribute_V1_EventAttributeExpirationUpdate, rhs: Provenance_Attribute_V1_EventAttributeExpirationUpdate) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.value != rhs.value {return false}
    if lhs.account != rhs.account {return false}
    if lhs.owner != rhs.owner {return false}
    if lhs.originalExpiration != rhs.originalExpiration {return false}
    if lhs.updatedExpiration != rhs.updatedExpiration {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Provenance_Attribute_V1_EventAttributeExpired: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventAttributeExpired"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .standard(proto: "value_hash"),
    3: .standard(proto: "attribute_type"),
    4: .same(proto: "account"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.valueHash) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.attributeType) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.account) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.expiration) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.valueHash.isEmpty {
      try visitor.visitSingularStringField(value: self.valueHash, fieldNumber: 2)
    }
    if !self.attributeType.isEmpty {
      try visitor.visitSingularStringField(value: self.attributeType, fieldNumber: 3)
    }
    ...
    if !self.expiration.isEmpty {
      try visitor.visitSingularStringField(value: self.expiration, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Provenance_Attribute_V1_EventAttributeExpired, rhs: Provenance_Attribute_V1_EventAttributeExpired) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.valueHash != rhs.valueHash {return false}
    if lhs.attributeType != rhs.attributeType {return false}
    if lhs.account != rhs.account {return false}
    if lhs.expiration != rhs.expiration {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Provenance_Attribute_V1_EventAccountDataUpdated: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventAccountDataUpdated"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Provenance_Attribute_V1_EventAccountDataUpdated, rhs: Provenance_Attribute_V1_EventAccountDataUpdated) -> Bool {
    if lhs.account != rhs.account {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
