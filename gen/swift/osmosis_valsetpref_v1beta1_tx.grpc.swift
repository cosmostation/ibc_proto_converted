...
internal protocol Osmosis_Valsetpref_V1beta1_MsgClientProtocol: GRPCClient {
  ...
  func undelegateFromRebalancedValidatorSet(
    _ request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    callOptions: CallOptions?
  ) -> UnaryCall<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>
...
extension Osmosis_Valsetpref_V1beta1_MsgClientProtocol {
  ...
  ///
  /// - Parameters:
  ///   - request: Request to send to UndelegateFromRebalancedValidatorSet.
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func undelegateFromRebalancedValidatorSet(
    _ request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse> {
    return self.makeUnaryCall(
      path: Osmosis_Valsetpref_V1beta1_MsgClientMetadata.Methods.undelegateFromRebalancedValidatorSet.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeUndelegateFromRebalancedValidatorSetInterceptors() ?? []
    )
  }
...
internal protocol Osmosis_Valsetpref_V1beta1_MsgAsyncClientProtocol: GRPCClient {
  ...
  func makeUndelegateFromRebalancedValidatorSetCall(
    _ request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>
...
extension Osmosis_Valsetpref_V1beta1_MsgAsyncClientProtocol {
  ...
  internal func makeUndelegateFromRebalancedValidatorSetCall(
    _ request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse> {
    return self.makeAsyncUnaryCall(
...
extension Osmosis_Valsetpref_V1beta1_MsgAsyncClientProtocol {
  ...
  internal func undelegateFromRebalancedValidatorSet(
    _ request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    callOptions: CallOptions? = nil
  ) async throws -> Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse {
    return try await self.performAsyncUnaryCall(
      path: Osmosis_Valsetpref_V1beta1_MsgClientMetadata.Methods.undelegateFromRebalancedValidatorSet.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
internal protocol Osmosis_Valsetpref_V1beta1_MsgClientInterceptorFactoryProtocol: Sendable {
  ...
  /// - Returns: Interceptors to use when invoking 'undelegateFromRebalancedValidatorSet'.
  func makeUndelegateFromRebalancedValidatorSetInterceptors() -> [ClientInterceptor<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>]
...
internal enum Osmosis_Valsetpref_V1beta1_MsgClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Osmosis_Valsetpref_V1beta1_MsgClientMetadata.Methods.undelegateFromRebalancedValidatorSet,
  ...
  internal enum Methods {
    ...
    internal static let undelegateFromRebalancedValidatorSet = GRPCMethodDescriptor(
      name: "UndelegateFromRebalancedValidatorSet",
      path: "/osmosis.valsetpref.v1beta1.Msg/UndelegateFromRebalancedValidatorSet",
      type: GRPCCallType.unary
    )
...
internal protocol Osmosis_Valsetpref_V1beta1_MsgProvider: CallHandlerProvider {
  ...
  /// the validator set, but takes into consideration the current delegations
  /// to the user's validator set to determine the weights assigned to each.
  func undelegateFromRebalancedValidatorSet(request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, context: StatusOnlyCallContext) -> EventLoopFuture<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>
...
extension Osmosis_Valsetpref_V1beta1_MsgProvider {
  ...
  internal func handle(
    ...
    case "UndelegateFromRebalancedValidatorSet":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet>(),
        responseSerializer: ProtobufSerializer<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>(),
        interceptors: self.interceptors?.makeUndelegateFromRebalancedValidatorSetInterceptors() ?? [],
        userFunction: self.undelegateFromRebalancedValidatorSet(request:context:)
      )
...
internal protocol Osmosis_Valsetpref_V1beta1_MsgAsyncProvider: CallHandlerProvider {
  ...
  /// the validator set, but takes into consideration the current delegations
  /// to the user's validator set to determine the weights assigned to each.
  @Sendable func undelegateFromRebalancedValidatorSet(
    request: Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet,
    context: GRPCAsyncServerCallContext
  ) async throws -> Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse
  ...
  internal func handle(
    ...
    case "UndelegateFromRebalancedValidatorSet":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>(),
        interceptors: self.interceptors?.makeUndelegateFromRebalancedValidatorSetInterceptors() ?? [],
        wrapping: self.undelegateFromRebalancedValidatorSet(request:context:)
      )
...
internal protocol Osmosis_Valsetpref_V1beta1_MsgServerInterceptorFactoryProtocol {
  ...
  /// - Returns: Interceptors to use when handling 'undelegateFromRebalancedValidatorSet'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUndelegateFromRebalancedValidatorSetInterceptors() -> [ServerInterceptor<Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSet, Osmosis_Valsetpref_V1beta1_MsgUndelegateFromRebalancedValidatorSetResponse>]
...
internal enum Osmosis_Valsetpref_V1beta1_MsgServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Osmosis_Valsetpref_V1beta1_MsgServerMetadata.Methods.undelegateFromRebalancedValidatorSet,
