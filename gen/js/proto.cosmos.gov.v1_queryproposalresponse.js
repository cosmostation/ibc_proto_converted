...
goog.provide('proto.cosmos.gov.v1.QueryProposalResponse');
...
proto.cosmos.gov.v1.QueryProposalResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    proposal: (f = msg.getProposal()) && proto.cosmos.gov.v1.Proposal.toObject(includeInstance, f)
  };
...
proto.cosmos.gov.v1.QueryProposalResponse.prototype.getProposal = function() {
  return /** @type{?proto.cosmos.gov.v1.Proposal} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.gov.v1.Proposal, 1));
};
