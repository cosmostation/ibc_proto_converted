...
struct Shentu_Oracle_V1alpha1_MsgCreateTxTask {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var atxBytes: Data = Data()

  var bounty: [Cosmos_Base_V1beta1_Coin] = []

  var validTime: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _validTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_validTime = newValue}
  }
  /// Returns true if `validTime` has been explicitly set.
  var hasValidTime: Bool {return self._validTime != nil}
  /// Clears the value of `validTime`. Subsequent reads from it will return its default value.
  mutating func clearValidTime() {self._validTime = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _validTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

struct Shentu_Oracle_V1alpha1_MsgCreateTxTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// sha256 hash of the application chain transaction
  var atxHash: Data = Data()
...
struct Shentu_Oracle_V1alpha1_MsgTxTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Shentu_Oracle_V1alpha1_MsgTxTaskResponseResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Shentu_Oracle_V1alpha1_MsgDeleteTxTask {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Shentu_Oracle_V1alpha1_MsgDeleteTxTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Shentu_Oracle_V1alpha1_MsgCreateOperator: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgCreateOperatorResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgRemoveOperator: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgRemoveOperatorResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgAddCollateral: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgAddCollateralResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgReduceCollateral: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgReduceCollateralResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgWithdrawReward: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgWithdrawRewardResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgCreateTask: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgCreateTaskResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgTaskResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgTaskResponseResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgDeleteTask: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgDeleteTaskResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgCreateTxTask: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgCreateTxTaskResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgTxTaskResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgTxTaskResponseResponse: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgDeleteTxTask: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_MsgDeleteTxTaskResponse: @unchecked Sendable {}
...
extension Shentu_Oracle_V1alpha1_MsgCreateTask: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._validDuration {
...
extension Shentu_Oracle_V1alpha1_MsgCreateTxTask: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgCreateTxTask"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "creator"),
    2: .standard(proto: "chain_id"),
    3: .standard(proto: "atx_bytes"),
    4: .same(proto: "bounty"),
    5: .standard(proto: "valid_time"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularBytesField(value: &self.atxBytes) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.bounty) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._validTime) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.atxBytes.isEmpty {
      try visitor.visitSingularBytesField(value: self.atxBytes, fieldNumber: 3)
    }
    if !self.bounty.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.bounty, fieldNumber: 4)
    }
    try { if let v = self._validTime {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgCreateTxTask, rhs: Shentu_Oracle_V1alpha1_MsgCreateTxTask) -> Bool {
    if lhs.creator != rhs.creator {return false}
    if lhs.chainID != rhs.chainID {return false}
    if lhs.atxBytes != rhs.atxBytes {return false}
    if lhs.bounty != rhs.bounty {return false}
...
extension Shentu_Oracle_V1alpha1_MsgCreateTxTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgCreateTxTaskResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "atx_hash"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.atxHash) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.atxHash.isEmpty {
      try visitor.visitSingularBytesField(value: self.atxHash, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgCreateTxTaskResponse, rhs: Shentu_Oracle_V1alpha1_MsgCreateTxTaskResponse) -> Bool {
    if lhs.atxHash != rhs.atxHash {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Shentu_Oracle_V1alpha1_MsgTxTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgTxTaskResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "atx_hash"),
    2: .same(proto: "score"),
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgTxTaskResponse, rhs: Shentu_Oracle_V1alpha1_MsgTxTaskResponse) -> Bool {
    if lhs.atxHash != rhs.atxHash {return false}
    if lhs.score != rhs.score {return false}
    if lhs.`operator` != rhs.`operator` {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Shentu_Oracle_V1alpha1_MsgTxTaskResponseResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgTxTaskResponseResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgTxTaskResponseResponse, rhs: Shentu_Oracle_V1alpha1_MsgTxTaskResponseResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Shentu_Oracle_V1alpha1_MsgDeleteTxTask: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgDeleteTxTask"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "atx_hash"),
    2: .same(proto: "from"),
  ]
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgDeleteTxTask, rhs: Shentu_Oracle_V1alpha1_MsgDeleteTxTask) -> Bool {
    if lhs.atxHash != rhs.atxHash {return false}
    if lhs.from != rhs.from {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Shentu_Oracle_V1alpha1_MsgDeleteTxTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgDeleteTxTaskResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_MsgDeleteTxTaskResponse, rhs: Shentu_Oracle_V1alpha1_MsgDeleteTxTaskResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
