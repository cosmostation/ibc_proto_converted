...
struct Akash_Deployment_V1beta3_Group {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var groupID: Akash_Deployment_V1beta3_GroupID {
    get {return _groupID ?? Akash_Deployment_V1beta3_GroupID()}
  ...
  var state: Akash_Deployment_V1beta3_Group.State = .invalid

  var groupSpec: Akash_Deployment_V1beta3_GroupSpec {
    get {return _groupSpec ?? Akash_Deployment_V1beta3_GroupSpec()}
  ...
  fileprivate var _groupID: Akash_Deployment_V1beta3_GroupID? = nil
  fileprivate var _groupSpec: Akash_Deployment_V1beta3_GroupSpec? = nil
}

#if swift(>=4.2)

extension Akash_Deployment_V1beta3_Group.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Akash_Deployment_V1beta3_Group.State] = [
    .invalid,
    .open,
    .paused,
    .insufficientFunds,
...
extension Akash_Deployment_V1beta3_Group: @unchecked Sendable {}
extension Akash_Deployment_V1beta3_Group.State: @unchecked Sendable {}
...
extension Akash_Deployment_V1beta3_Group: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Deployment_V1beta3_Group, rhs: Akash_Deployment_V1beta3_Group) -> Bool {
...
extension Akash_Deployment_V1beta3_Group.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
