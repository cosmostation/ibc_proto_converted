...
struct Stratos_Pot_Module_V1_Module {
...
extension Stratos_Pot_Module_V1_Module: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "stratos.pot.module.v1"

extension Stratos_Pot_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Pot_Module_V1_Module, rhs: Stratos_Pot_Module_V1_Module) -> Bool {
