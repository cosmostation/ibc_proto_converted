...
struct Shentu_Gov_V1alpha1_QueryCertVotedRequest {
...
struct Shentu_Gov_V1alpha1_QueryCertVotedResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Shentu_Gov_V1alpha1_QueryParamsResponse {
  ...
  var customParams: Shentu_Gov_V1alpha1_CustomParams {
    get {return _customParams ?? Shentu_Gov_V1alpha1_CustomParams()}
  ...
  fileprivate var _customParams: Shentu_Gov_V1alpha1_CustomParams? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Shentu_Gov_V1alpha1_QueryCertVotedRequest: @unchecked Sendable {}
extension Shentu_Gov_V1alpha1_QueryCertVotedResponse: @unchecked Sendable {}
extension Shentu_Gov_V1alpha1_QueryParamsResponse: @unchecked Sendable {}
...
extension Shentu_Gov_V1alpha1_QueryCertVotedRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Shentu_Gov_V1alpha1_QueryCertVotedRequest, rhs: Shentu_Gov_V1alpha1_QueryCertVotedRequest) -> Bool {
...
extension Shentu_Gov_V1alpha1_QueryCertVotedResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Shentu_Gov_V1alpha1_QueryCertVotedResponse, rhs: Shentu_Gov_V1alpha1_QueryCertVotedResponse) -> Bool {
...
extension Shentu_Gov_V1alpha1_QueryParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "custom_params"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._customParams) }()
      default: break
      }
    }
  }
