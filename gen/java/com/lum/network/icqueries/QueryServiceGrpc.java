...
public final class QueryServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "lum.network.icqueries.QueryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryQueriesRequest,
      com.lum.network.icqueries.QueryProto.QueryQueriesResponse> getQueriesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Queries",
      requestType = com.lum.network.icqueries.QueryProto.QueryQueriesRequest.class,
      responseType = com.lum.network.icqueries.QueryProto.QueryQueriesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryQueriesRequest,
      com.lum.network.icqueries.QueryProto.QueryQueriesResponse> getQueriesMethod() {
    io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryQueriesRequest, com.lum.network.icqueries.QueryProto.QueryQueriesResponse> getQueriesMethod;
    if ((getQueriesMethod = QueryServiceGrpc.getQueriesMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getQueriesMethod = QueryServiceGrpc.getQueriesMethod) == null) {
          QueryServiceGrpc.getQueriesMethod = getQueriesMethod =
              io.grpc.MethodDescriptor.<com.lum.network.icqueries.QueryProto.QueryQueriesRequest, com.lum.network.icqueries.QueryProto.QueryQueriesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Queries"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lum.network.icqueries.QueryProto.QueryQueriesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lum.network.icqueries.QueryProto.QueryQueriesResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest,
      com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PendingQueries",
      requestType = com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest.class,
      responseType = com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest,
      com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod() {
    io.grpc.MethodDescriptor<com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest, com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getPendingQueriesMethod = QueryServiceGrpc.getPendingQueriesMethod) == null) {
          QueryServiceGrpc.getPendingQueriesMethod = getPendingQueriesMethod =
              io.grpc.MethodDescriptor.<com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest, com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PendingQueries"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void queries(com.lum.network.icqueries.QueryProto.QueryQueriesRequest request,
        io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryQueriesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueriesMethod(), responseObserver);
    }

    /**
     */
    default void pendingQueries(com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest request,
        io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> responseObserver) {
  ...
  public static final class QueryServiceStub
    ...
    /**
     */
    public void queries(com.lum.network.icqueries.QueryProto.QueryQueriesRequest request,
        io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryQueriesResponse> responseObserver) {
    ...
    /**
     */
    public void pendingQueries(com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest request,
        io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class QueryServiceBlockingStub
    ...
    /**
     */
    public com.lum.network.icqueries.QueryProto.QueryQueriesResponse queries(com.lum.network.icqueries.QueryProto.QueryQueriesRequest request) {
    ...
    /**
     */
    public com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse pendingQueries(com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class QueryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lum.network.icqueries.QueryProto.QueryQueriesResponse> queries(
        com.lum.network.icqueries.QueryProto.QueryQueriesRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse> pendingQueries(
        com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERIES:
          serviceImpl.queries((com.lum.network.icqueries.QueryProto.QueryQueriesRequest) request,
              (io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryQueriesResponse>) responseObserver);
          break;
        case METHODID_PENDING_QUERIES:
          serviceImpl.pendingQueries((com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest) request,
              (io.grpc.stub.StreamObserver<com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.lum.network.icqueries.QueryProto.QueryQueriesRequest,
              com.lum.network.icqueries.QueryProto.QueryQueriesResponse>(
                service, METHODID_QUERIES)))
        .addMethod(
          getPendingQueriesMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.lum.network.icqueries.QueryProto.QueryPendingQueriesRequest,
              com.lum.network.icqueries.QueryProto.QueryPendingQueriesResponse>(
