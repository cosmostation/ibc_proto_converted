...
goog.provide('proto.cosmos.mint.v1beta1.GenesisState');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.mint.v1beta1.Minter');
...
proto.cosmos.mint.v1beta1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    minter: (f = msg.getMinter()) && proto.cosmos.mint.v1beta1.Minter.toObject(includeInstance, f),
...
proto.cosmos.mint.v1beta1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.mint.v1beta1.Minter;
      reader.readMessage(value,proto.cosmos.mint.v1beta1.Minter.deserializeBinaryFromReader);
      msg.setMinter(value);
      break;
    case 2:
...
proto.cosmos.mint.v1beta1.GenesisState.prototype.getMinter = function() {
  return /** @type{?proto.cosmos.mint.v1beta1.Minter} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.mint.v1beta1.Minter, 1));
};


/**
 * @param {?proto.cosmos.mint.v1beta1.Minter|undefined} value
 * @return {!proto.cosmos.mint.v1beta1.GenesisState} returns this
*/
