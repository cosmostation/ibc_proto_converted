...
struct Osmosis_Concentratedliquidity_V1beta1_PositionWithPeriodLock {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  fileprivate var _position: Osmosis_Concentratedliquidity_V1beta1_Position? = nil
  fileprivate var _locks: Osmosis_Lockup_PeriodLock? = nil
}
...
extension Osmosis_Concentratedliquidity_V1beta1_PositionWithPeriodLock: @unchecked Sendable {}
...
extension Osmosis_Concentratedliquidity_V1beta1_FullPositionBreakdown: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "asset0"),
    3: .same(proto: "asset1"),
    4: .standard(proto: "claimable_spread_rewards"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.claimableSpreadRewards) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.claimableSpreadRewards.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.claimableSpreadRewards, fieldNumber: 4)
    }
...
extension Osmosis_Concentratedliquidity_V1beta1_PositionWithPeriodLock: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PositionWithPeriodLock"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "position"),
    2: .same(proto: "locks"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._position) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._locks) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_PositionWithPeriodLock, rhs: Osmosis_Concentratedliquidity_V1beta1_PositionWithPeriodLock) -> Bool {
    if lhs._position != rhs._position {return false}
