...
struct Axelar_Reward_V1beta1_Params {
  ...
  var keyMgmtRelativeInflationRate: Data = Data()
...
extension Axelar_Reward_V1beta1_Params: @unchecked Sendable {}
...
extension Axelar_Reward_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "key_mgmt_relative_inflation_rate"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBytesField(value: &self.keyMgmtRelativeInflationRate) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.keyMgmtRelativeInflationRate.isEmpty {
      try visitor.visitSingularBytesField(value: self.keyMgmtRelativeInflationRate, fieldNumber: 2)
    }
  ...
  static func ==(lhs: Axelar_Reward_V1beta1_Params, rhs: Axelar_Reward_V1beta1_Params) -> Bool {
    ...
    if lhs.keyMgmtRelativeInflationRate != rhs.keyMgmtRelativeInflationRate {return false}
