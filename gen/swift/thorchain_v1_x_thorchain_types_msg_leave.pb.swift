...
extension Types_MsgLeave: @unchecked Sendable {}
...
extension Types_MsgLeave: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgLeave"
  ...
  static func ==(lhs: Types_MsgLeave, rhs: Types_MsgLeave) -> Bool {
