...
struct Osmosis_Poolincentives_V1beta1_AnyPoolToInternalGauges {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Poolincentives_V1beta1_ConcentratedPoolToNoLockGauges {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Poolincentives_V1beta1_AnyPoolToInternalGauges: @unchecked Sendable {}
extension Osmosis_Poolincentives_V1beta1_ConcentratedPoolToNoLockGauges: @unchecked Sendable {}
...
extension Osmosis_Poolincentives_V1beta1_AnyPoolToInternalGauges: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AnyPoolToInternalGauges"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Osmosis_Poolincentives_V1beta1_AnyPoolToInternalGauges, rhs: Osmosis_Poolincentives_V1beta1_AnyPoolToInternalGauges) -> Bool {
...
extension Osmosis_Poolincentives_V1beta1_ConcentratedPoolToNoLockGauges: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ConcentratedPoolToNoLockGauges"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "pool_to_gauge"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.poolToGauge) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.poolToGauge.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.poolToGauge, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Osmosis_Poolincentives_V1beta1_ConcentratedPoolToNoLockGauges, rhs: Osmosis_Poolincentives_V1beta1_ConcentratedPoolToNoLockGauges) -> Bool {
    if lhs.poolToGauge != rhs.poolToGauge {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
