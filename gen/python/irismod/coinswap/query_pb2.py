...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUERYLIQUIDITYPOOLRESPONSE'].fields_by_name['pool']._options = None
  _globals['_QUERYLIQUIDITYPOOLRESPONSE'].fields_by_name['pool']._serialized_options = b'\310\336\037\000'
  _globals['_QUERYLIQUIDITYPOOLSRESPONSE'].fields_by_name['pools']._options = None
  _globals['_QUERYLIQUIDITYPOOLSRESPONSE'].fields_by_name['pools']._serialized_options = b'\310\336\037\000'
  _globals['_POOLINFO'].fields_by_name['standard']._options = None
  _globals['_POOLINFO'].fields_by_name['standard']._serialized_options = b'\310\336\037\000'
  _globals['_POOLINFO'].fields_by_name['token']._options = None
  _globals['_POOLINFO'].fields_by_name['token']._serialized_options = b'\310\336\037\000'
  _globals['_POOLINFO'].fields_by_name['lpt']._options = None
  _globals['_POOLINFO'].fields_by_name['lpt']._serialized_options = b'\310\336\037\000'
  _globals['_QUERY'].methods_by_name['LiquidityPool']._options = None
  _globals['_QUERY'].methods_by_name['LiquidityPool']._serialized_options = b'\202\323\344\223\002%\022#/irismod/coinswap/pools/{lpt_denom}'
  _globals['_QUERY'].methods_by_name['LiquidityPools']._options = None
  _globals['_QUERY'].methods_by_name['LiquidityPools']._serialized_options = b'\202\323\344\223\002\031\022\027/irismod/coinswap/pools'
