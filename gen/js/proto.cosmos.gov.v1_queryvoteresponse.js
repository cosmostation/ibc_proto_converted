...
goog.provide('proto.cosmos.gov.v1.QueryVoteResponse');
...
proto.cosmos.gov.v1.QueryVoteResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    vote: (f = msg.getVote()) && proto.cosmos.gov.v1.Vote.toObject(includeInstance, f)
  };
...
proto.cosmos.gov.v1.QueryVoteResponse.prototype.getVote = function() {
  return /** @type{?proto.cosmos.gov.v1.Vote} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.gov.v1.Vote, 1));
};
