...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_ADDMARKERPROPOSAL'].fields_by_name['amount']._options = None
  _globals['_ADDMARKERPROPOSAL'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_ADDMARKERPROPOSAL'].fields_by_name['access_list']._options = None
  _globals['_ADDMARKERPROPOSAL'].fields_by_name['access_list']._serialized_options = b'\310\336\037\000'
  _globals['_ADDMARKERPROPOSAL']._options = None
  _globals['_ADDMARKERPROPOSAL']._serialized_options = b'\030\001\350\240\037\001'
  _globals['_SUPPLYINCREASEPROPOSAL'].fields_by_name['amount']._options = None
  _globals['_SUPPLYINCREASEPROPOSAL'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_SUPPLYINCREASEPROPOSAL']._options = None
  _globals['_SUPPLYINCREASEPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_SUPPLYDECREASEPROPOSAL'].fields_by_name['amount']._options = None
  _globals['_SUPPLYDECREASEPROPOSAL'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_SUPPLYDECREASEPROPOSAL']._options = None
  _globals['_SUPPLYDECREASEPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_SETADMINISTRATORPROPOSAL'].fields_by_name['access']._options = None
  _globals['_SETADMINISTRATORPROPOSAL'].fields_by_name['access']._serialized_options = b'\310\336\037\000'
  _globals['_SETADMINISTRATORPROPOSAL']._options = None
  _globals['_SETADMINISTRATORPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_REMOVEADMINISTRATORPROPOSAL']._options = None
  _globals['_REMOVEADMINISTRATORPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_CHANGESTATUSPROPOSAL']._options = None
  _globals['_CHANGESTATUSPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_WITHDRAWESCROWPROPOSAL'].fields_by_name['amount']._options = None
  _globals['_WITHDRAWESCROWPROPOSAL'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_WITHDRAWESCROWPROPOSAL']._options = None
  _globals['_WITHDRAWESCROWPROPOSAL']._serialized_options = b'\230\240\037\000\350\240\037\001'
  _globals['_SETDENOMMETADATAPROPOSAL'].fields_by_name['metadata']._options = None
  _globals['_SETDENOMMETADATAPROPOSAL'].fields_by_name['metadata']._serialized_options = b'\310\336\037\000\332\336\0372github.com/cosmos/cosmos-sdk/x/bank/types.Metadata'
  _globals['_SETDENOMMETADATAPROPOSAL']._options = None
  _globals['_SETDENOMMETADATAPROPOSAL']._serialized_options = b'\230\240\037\000'
