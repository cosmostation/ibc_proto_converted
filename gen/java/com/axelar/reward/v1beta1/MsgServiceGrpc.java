...
public final class MsgServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.RefundMsgRequest,
      com.axelar.reward.v1beta1.RefundMsgResponse> getRefundMsgMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RefundMsg",
      requestType = com.axelar.reward.v1beta1.RefundMsgRequest.class,
      responseType = com.axelar.reward.v1beta1.RefundMsgResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.RefundMsgRequest,
      com.axelar.reward.v1beta1.RefundMsgResponse> getRefundMsgMethod() {
    io.grpc.MethodDescriptor<com.axelar.reward.v1beta1.RefundMsgRequest, com.axelar.reward.v1beta1.RefundMsgResponse> getRefundMsgMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getRefundMsgMethod = MsgServiceGrpc.getRefundMsgMethod) == null) {
          MsgServiceGrpc.getRefundMsgMethod = getRefundMsgMethod =
              io.grpc.MethodDescriptor.<com.axelar.reward.v1beta1.RefundMsgRequest, com.axelar.reward.v1beta1.RefundMsgResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RefundMsg"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.RefundMsgRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.axelar.reward.v1beta1.RefundMsgResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void refundMsg(com.axelar.reward.v1beta1.RefundMsgRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.RefundMsgResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void refundMsg(com.axelar.reward.v1beta1.RefundMsgRequest request,
        io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.RefundMsgResponse> responseObserver) {
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.axelar.reward.v1beta1.RefundMsgResponse refundMsg(com.axelar.reward.v1beta1.RefundMsgRequest request) {
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.axelar.reward.v1beta1.RefundMsgResponse> refundMsg(
        com.axelar.reward.v1beta1.RefundMsgRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REFUND_MSG:
          serviceImpl.refundMsg((com.axelar.reward.v1beta1.RefundMsgRequest) request,
              (io.grpc.stub.StreamObserver<com.axelar.reward.v1beta1.RefundMsgResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.axelar.reward.v1beta1.RefundMsgRequest,
              com.axelar.reward.v1beta1.RefundMsgResponse>(
