...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.irismod.nft.NftProto.internal_static_irismod_nft_Owner_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.irismod.nft.Owner.class, com.irismod.nft.Owner.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<com.irismod.nft.IDCollection> idCollections_;
  /**
   ...
   */
  @java.lang.Override
  public java.util.List<com.irismod.nft.IDCollection> getIdCollectionsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.irismod.nft.IDCollectionOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.irismod.nft.IDCollection getIdCollections(int index) {
   ...
   */
  @java.lang.Override
  public com.irismod.nft.IDCollectionOrBuilder getIdCollectionsOrBuilder(
      int index) {
    return idCollections_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.irismod.nft.Owner)) {
      return super.equals(obj);
    }
    com.irismod.nft.Owner other = (com.irismod.nft.Owner) obj;
  ...
  public static com.irismod.nft.Owner parseFrom(
  ...
  public static com.irismod.nft.Owner parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.irismod.nft.Owner parseFrom(
  ...
  public static com.irismod.nft.Owner parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.irismod.nft.Owner parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.irismod.nft.Owner parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.irismod.nft.Owner prototype) {
  ...
  public static final class Builder extends
      ...
      com.irismod.nft.OwnerOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.irismod.nft.NftProto.internal_static_irismod_nft_Owner_descriptor;
    }
    ...
    // Construct using com.irismod.nft.Owner.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.irismod.nft.Owner getDefaultInstanceForType() {
      return com.irismod.nft.Owner.getDefaultInstance();
    }

    @java.lang.Override
    public com.irismod.nft.Owner build() {
      com.irismod.nft.Owner result = buildPartial();
    ...
    @java.lang.Override
    public com.irismod.nft.Owner buildPartial() {
      com.irismod.nft.Owner result = new com.irismod.nft.Owner(this);
    ...
    private void buildPartialRepeatedFields(com.irismod.nft.Owner result) {
      if (idCollectionsBuilder_ == null) {
    ...
    private void buildPartial0(com.irismod.nft.Owner result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.irismod.nft.Owner) {
        return mergeFrom((com.irismod.nft.Owner)other);
      } else {
    ...
    public Builder mergeFrom(com.irismod.nft.Owner other) {
      if (other == com.irismod.nft.Owner.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              com.irismod.nft.IDCollection m =
                  input.readMessage(
                      com.irismod.nft.IDCollection.parser(),
                      extensionRegistry);
              if (idCollectionsBuilder_ == null) {
                ensureIdCollectionsIsMutable();
    ...
    private void ensureIdCollectionsIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        idCollections_ = new java.util.ArrayList<com.irismod.nft.IDCollection>(idCollections_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.irismod.nft.IDCollection, com.irismod.nft.IDCollection.Builder, com.irismod.nft.IDCollectionOrBuilder> idCollectionsBuilder_;
    ...
    public Builder setIdCollections(
        int index, com.irismod.nft.IDCollection value) {
      if (idCollectionsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setIdCollections(
        int index, com.irismod.nft.IDCollection.Builder builderForValue) {
      if (idCollectionsBuilder_ == null) {
        ensureIdCollectionsIsMutable();
     ...
     * <code>repeated .irismod.nft.IDCollection id_collections = 2 [json_name = "idCollections", (.gogoproto.nullable) = false, (.gogoproto.customname) = "IDCollections", (.gogoproto.moretags) = "yaml:&#92;"idcs&#92;""];</code>
     */
    public Builder addIdCollections(com.irismod.nft.IDCollection value) {
      if (idCollectionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addIdCollections(
        com.irismod.nft.IDCollection.Builder builderForValue) {
      if (idCollectionsBuilder_ == null) {
        ensureIdCollectionsIsMutable();
    ...
    public Builder addAllIdCollections(
        java.lang.Iterable<? extends com.irismod.nft.IDCollection> values) {
      if (idCollectionsBuilder_ == null) {
        ensureIdCollectionsIsMutable();
     ...
     * <code>repeated .irismod.nft.IDCollection id_collections = 2 [json_name = "idCollections", (.gogoproto.nullable) = false, (.gogoproto.customname) = "IDCollections", (.gogoproto.moretags) = "yaml:&#92;"idcs&#92;""];</code>
     */
    public com.irismod.nft.IDCollection.Builder getIdCollectionsBuilder(
        int index) {
     ...
     * <code>repeated .irismod.nft.IDCollection id_collections = 2 [json_name = "idCollections", (.gogoproto.nullable) = false, (.gogoproto.customname) = "IDCollections", (.gogoproto.moretags) = "yaml:&#92;"idcs&#92;""];</code>
     */
    public com.irismod.nft.IDCollection.Builder addIdCollectionsBuilder() {
      return getIdCollectionsFieldBuilder().addBuilder(
          com.irismod.nft.IDCollection.getDefaultInstance());
    }
    /**
     * <code>repeated .irismod.nft.IDCollection id_collections = 2 [json_name = "idCollections", (.gogoproto.nullable) = false, (.gogoproto.customname) = "IDCollections", (.gogoproto.moretags) = "yaml:&#92;"idcs&#92;""];</code>
     */
    public com.irismod.nft.IDCollection.Builder addIdCollectionsBuilder(
        int index) {
      return getIdCollectionsFieldBuilder().addBuilder(
          index, com.irismod.nft.IDCollection.getDefaultInstance());
    }
    /**
     * <code>repeated .irismod.nft.IDCollection id_collections = 2 [json_name = "idCollections", (.gogoproto.nullable) = false, (.gogoproto.customname) = "IDCollections", (.gogoproto.moretags) = "yaml:&#92;"idcs&#92;""];</code>
     */
    public java.util.List<com.irismod.nft.IDCollection.Builder> 
         getIdCollectionsBuilderList() {
      return getIdCollectionsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.irismod.nft.IDCollection, com.irismod.nft.IDCollection.Builder, com.irismod.nft.IDCollectionOrBuilder> 
  ...
  private static final com.irismod.nft.Owner DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.irismod.nft.Owner();
  }

  public static com.irismod.nft.Owner getDefaultInstance() {
