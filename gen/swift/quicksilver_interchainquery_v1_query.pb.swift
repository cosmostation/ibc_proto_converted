...
struct Quicksilver_Interchainquery_V1_QueryRequestsRequest {
...
struct Quicksilver_Interchainquery_V1_QueryRequestsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Quicksilver_Interchainquery_V1_GetTxWithProofResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Quicksilver_Interchainquery_V1_QueryRequestsRequest: @unchecked Sendable {}
extension Quicksilver_Interchainquery_V1_QueryRequestsResponse: @unchecked Sendable {}
extension Quicksilver_Interchainquery_V1_GetTxWithProofResponse: @unchecked Sendable {}
...
extension Quicksilver_Interchainquery_V1_QueryRequestsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_QueryRequestsRequest, rhs: Quicksilver_Interchainquery_V1_QueryRequestsRequest) -> Bool {
...
extension Quicksilver_Interchainquery_V1_QueryRequestsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_QueryRequestsResponse, rhs: Quicksilver_Interchainquery_V1_QueryRequestsResponse) -> Bool {
...
extension Quicksilver_Interchainquery_V1_GetTxWithProofResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_GetTxWithProofResponse, rhs: Quicksilver_Interchainquery_V1_GetTxWithProofResponse) -> Bool {
