...
public final class ABCIListenerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest,
      com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> getListenFinalizeBlockMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListenFinalizeBlock",
      requestType = com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest.class,
      responseType = com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest,
      com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> getListenFinalizeBlockMethod() {
    io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest, com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> getListenFinalizeBlockMethod;
      ...
      synchronized (ABCIListenerServiceGrpc.class) {
        if ((getListenFinalizeBlockMethod = ABCIListenerServiceGrpc.getListenFinalizeBlockMethod) == null) {
          ABCIListenerServiceGrpc.getListenFinalizeBlockMethod = getListenFinalizeBlockMethod =
              io.grpc.MethodDescriptor.<com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest, com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListenFinalizeBlock"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenCommitRequest,
      com.cosmos.store.streaming.abci.ListenCommitResponse> getListenCommitMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListenCommit",
      requestType = com.cosmos.store.streaming.abci.ListenCommitRequest.class,
      responseType = com.cosmos.store.streaming.abci.ListenCommitResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenCommitRequest,
      com.cosmos.store.streaming.abci.ListenCommitResponse> getListenCommitMethod() {
    io.grpc.MethodDescriptor<com.cosmos.store.streaming.abci.ListenCommitRequest, com.cosmos.store.streaming.abci.ListenCommitResponse> getListenCommitMethod;
      ...
      synchronized (ABCIListenerServiceGrpc.class) {
        if ((getListenCommitMethod = ABCIListenerServiceGrpc.getListenCommitMethod) == null) {
          ABCIListenerServiceGrpc.getListenCommitMethod = getListenCommitMethod =
              io.grpc.MethodDescriptor.<com.cosmos.store.streaming.abci.ListenCommitRequest, com.cosmos.store.streaming.abci.ListenCommitResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListenCommit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.store.streaming.abci.ListenCommitRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cosmos.store.streaming.abci.ListenCommitResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void listenFinalizeBlock(com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> responseObserver) {
     ...
     * </pre>
     */
    default void listenCommit(com.cosmos.store.streaming.abci.ListenCommitRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenCommitResponse> responseObserver) {
  ...
  public static final class ABCIListenerServiceStub
     ...
     * </pre>
     */
    public void listenFinalizeBlock(com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> responseObserver) {
     ...
     * </pre>
     */
    public void listenCommit(com.cosmos.store.streaming.abci.ListenCommitRequest request,
        io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenCommitResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ABCIListenerServiceBlockingStub
     ...
     * </pre>
     */
    public com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse listenFinalizeBlock(com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest request) {
     ...
     * </pre>
     */
    public com.cosmos.store.streaming.abci.ListenCommitResponse listenCommit(com.cosmos.store.streaming.abci.ListenCommitRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ABCIListenerServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse> listenFinalizeBlock(
        com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cosmos.store.streaming.abci.ListenCommitResponse> listenCommit(
        com.cosmos.store.streaming.abci.ListenCommitRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LISTEN_FINALIZE_BLOCK:
          serviceImpl.listenFinalizeBlock((com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest) request,
              (io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse>) responseObserver);
          break;
        case METHODID_LISTEN_COMMIT:
          serviceImpl.listenCommit((com.cosmos.store.streaming.abci.ListenCommitRequest) request,
              (io.grpc.stub.StreamObserver<com.cosmos.store.streaming.abci.ListenCommitResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cosmos.store.streaming.abci.ListenFinalizeBlockRequest,
              com.cosmos.store.streaming.abci.ListenFinalizeBlockResponse>(
                service, METHODID_LISTEN_FINALIZE_BLOCK)))
        .addMethod(
          getListenCommitMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cosmos.store.streaming.abci.ListenCommitRequest,
              com.cosmos.store.streaming.abci.ListenCommitResponse>(
