...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\033com.cudosnode.cudosnode.nftB\nQueryProtoZ.github.com/CudoVentures/cudos-node/x/nft/types\242\002\003CCN\252\002\027Cudosnode.Cudosnode.Nft\312\002\027Cudosnode\\Cudosnode\\Nft\342\002#Cudosnode\\Cudosnode\\Nft\\GPBMetadata\352\002\031Cudosnode::Cudosnode::Nft'
  ...
  _globals['_QUERYSUPPLYRESPONSE'].fields_by_name['amount']._serialized_options = b'\352\336\037\006amount'
  ...
  _globals['_QUERYCOLLECTIONSBYIDSREQUEST'].fields_by_name['denom_ids']._options = None
  _globals['_QUERYCOLLECTIONSBYIDSREQUEST'].fields_by_name['denom_ids']._serialized_options = b'\362\336\037\020yaml:\"denom_ids\"'
  ...
  _globals['_QUERYDENOMBYNAMEREQUEST'].fields_by_name['denom_name']._options = None
  _globals['_QUERYDENOMBYNAMEREQUEST'].fields_by_name['denom_name']._serialized_options = b'\362\336\037\021yaml:\"denom_name\"'
  _globals['_QUERYDENOMBYSYMBOLREQUEST'].fields_by_name['symbol']._options = None
  _globals['_QUERYDENOMBYSYMBOLREQUEST'].fields_by_name['symbol']._serialized_options = b'\362\336\037\ryaml:\"symbol\"'
  ...
  _globals['_QUERYAPPROVALSNFTREQUEST'].fields_by_name['denom_id']._options = None
  _globals['_QUERYAPPROVALSNFTREQUEST'].fields_by_name['denom_id']._serialized_options = b'\362\336\037\017yaml:\"denom_id\"'
  _globals['_QUERYAPPROVALSNFTREQUEST'].fields_by_name['token_id']._options = None
  _globals['_QUERYAPPROVALSNFTREQUEST'].fields_by_name['token_id']._serialized_options = b'\362\336\037\017yaml:\"token_id\"'
  _globals['_QUERYAPPROVALSNFTRESPONSE'].fields_by_name['ApprovedAddresses']._options = None
  _globals['_QUERYAPPROVALSNFTRESPONSE'].fields_by_name['ApprovedAddresses']._serialized_options = b'\342\336\037\021ApprovedAddresses\352\336\037\022approved_addresses'
  _globals['_QUERYAPPROVALSISAPPROVEDFORALLRESPONSE'].fields_by_name['isApproved']._options = None
  _globals['_QUERYAPPROVALSISAPPROVEDFORALLRESPONSE'].fields_by_name['isApproved']._serialized_options = b'\352\336\037\013is_approved'
  _globals['_QUERY'].methods_by_name['Supply']._options = None
  _globals['_QUERY'].methods_by_name['Supply']._serialized_options = b'\202\323\344\223\002.\022,/cudosnode/nft/collections/{denom_id}/supply'
  _globals['_QUERY'].methods_by_name['Owner']._options = None
  _globals['_QUERY'].methods_by_name['Owner']._serialized_options = b'\202\323\344\223\002\025\022\023/cudosnode/nft/nfts'
  _globals['_QUERY'].methods_by_name['Collection']._options = None
  _globals['_QUERY'].methods_by_name['Collection']._serialized_options = b'\202\323\344\223\002\'\022%/cudosnode/nft/collections/{denom_id}'
  _globals['_QUERY'].methods_by_name['CollectionsByDenomIds']._options = None
  _globals['_QUERY'].methods_by_name['CollectionsByDenomIds']._serialized_options = b'\202\323\344\223\002&\022$/cudosnode/nft/collectionsByDenomIds'
  _globals['_QUERY'].methods_by_name['Denom']._options = None
  _globals['_QUERY'].methods_by_name['Denom']._serialized_options = b'\202\323\344\223\002\"\022 /cudosnode/nft/denoms/{denom_id}'
  _globals['_QUERY'].methods_by_name['DenomByName']._options = None
  _globals['_QUERY'].methods_by_name['DenomByName']._serialized_options = b'\202\323\344\223\002)\022\'/cudosnode/nft/denoms/name/{denom_name}'
  _globals['_QUERY'].methods_by_name['DenomBySymbol']._options = None
  _globals['_QUERY'].methods_by_name['DenomBySymbol']._serialized_options = b'\202\323\344\223\002%\022#/cudosnode/nft/denoms/name/{symbol}'
  _globals['_QUERY'].methods_by_name['Denoms']._options = None
  _globals['_QUERY'].methods_by_name['Denoms']._serialized_options = b'\202\323\344\223\002\027\022\025/cudosnode/nft/denoms'
  _globals['_QUERY'].methods_by_name['NFT']._options = None
  _globals['_QUERY'].methods_by_name['NFT']._serialized_options = b'\202\323\344\223\002+\022)/cudosnode/nft/nfts/{denom_id}/{token_id}'
  _globals['_QUERY'].methods_by_name['GetApprovalsNFT']._options = None
  _globals['_QUERY'].methods_by_name['GetApprovalsNFT']._serialized_options = b'\202\323\344\223\0020\022./cudosnode/nft/approvals/{denom_id}/{token_id}'
  _globals['_QUERY'].methods_by_name['QueryApprovalsIsApprovedForAll']._options = None
  _globals['_QUERY'].methods_by_name['QueryApprovalsIsApprovedForAll']._serialized_options = b'\202\323\344\223\002-\022+/cudosnode/nft/approvals/{owner}/{operator}'
