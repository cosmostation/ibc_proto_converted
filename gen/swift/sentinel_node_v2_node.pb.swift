...
struct Sentinel_Node_V2_Node {
  ...
  var expiryAt: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _expiryAt ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_expiryAt = newValue}
  }
  /// Returns true if `expiryAt` has been explicitly set.
  var hasExpiryAt: Bool {return self._expiryAt != nil}
  /// Clears the value of `expiryAt`. Subsequent reads from it will return its default value.
  mutating func clearExpiryAt() {self._expiryAt = nil}
  ...
  fileprivate var _expiryAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _statusAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Sentinel_Node_V2_Node: @unchecked Sendable {}
...
extension Sentinel_Node_V2_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._expiryAt) }()
  ...
  static func ==(lhs: Sentinel_Node_V2_Node, rhs: Sentinel_Node_V2_Node) -> Bool {
    ...
    if lhs._expiryAt != rhs._expiryAt {return false}
