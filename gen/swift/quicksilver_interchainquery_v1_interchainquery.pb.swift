...
struct Quicksilver_Interchainquery_V1_Query {
...
struct Quicksilver_Interchainquery_V1_DataPoint {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Quicksilver_Interchainquery_V1_Query: @unchecked Sendable {}
extension Quicksilver_Interchainquery_V1_DataPoint: @unchecked Sendable {}
...
extension Quicksilver_Interchainquery_V1_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_Query, rhs: Quicksilver_Interchainquery_V1_Query) -> Bool {
...
extension Quicksilver_Interchainquery_V1_DataPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Interchainquery_V1_DataPoint, rhs: Quicksilver_Interchainquery_V1_DataPoint) -> Bool {
    if lhs.id != rhs.id {return false}
