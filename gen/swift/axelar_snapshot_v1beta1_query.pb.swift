...
extension Axelar_Snapshot_V1beta1_QueryValidatorsResponse: @unchecked Sendable {}
extension Axelar_Snapshot_V1beta1_QueryValidatorsResponse.TssIllegibilityInfo: @unchecked Sendable {}
extension Axelar_Snapshot_V1beta1_QueryValidatorsResponse.Validator: @unchecked Sendable {}
...
extension Axelar_Snapshot_V1beta1_QueryValidatorsResponse.Validator: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._tssIllegibilityInfo {
