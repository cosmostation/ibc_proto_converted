...
struct Canto_Epochs_V1_EpochInfo {
...
struct Canto_Epochs_V1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Canto_Epochs_V1_EpochInfo: @unchecked Sendable {}
extension Canto_Epochs_V1_GenesisState: @unchecked Sendable {}
...
extension Canto_Epochs_V1_EpochInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Canto_Epochs_V1_EpochInfo, rhs: Canto_Epochs_V1_EpochInfo) -> Bool {
...
extension Canto_Epochs_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Canto_Epochs_V1_GenesisState, rhs: Canto_Epochs_V1_GenesisState) -> Bool {
