...
struct Assetmantle_Modules_Orders_Transactions_Define_Message {
...
extension Assetmantle_Modules_Orders_Transactions_Define_Message: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "assetmantle.modules.orders.transactions.define"

extension Assetmantle_Modules_Orders_Transactions_Define_Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Assetmantle_Modules_Orders_Transactions_Define_Message, rhs: Assetmantle_Modules_Orders_Transactions_Define_Message) -> Bool {
