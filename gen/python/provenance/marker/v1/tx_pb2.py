...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MSGGRANTALLOWANCEREQUEST'].fields_by_name['allowance']._options = None
  _globals['_MSGGRANTALLOWANCEREQUEST'].fields_by_name['allowance']._serialized_options = b'\312\264-\rFeeAllowanceI'
  _globals['_MSGADDMARKERREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGADDMARKERREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGADDMARKERREQUEST'].fields_by_name['access_list']._options = None
  _globals['_MSGADDMARKERREQUEST'].fields_by_name['access_list']._serialized_options = b'\310\336\037\000'
  _globals['_MSGADDMARKERREQUEST']._options = None
  _globals['_MSGADDMARKERREQUEST']._serialized_options = b'\202\347\260*\014from_address'
  _globals['_MSGADDACCESSREQUEST'].fields_by_name['access']._options = None
  _globals['_MSGADDACCESSREQUEST'].fields_by_name['access']._serialized_options = b'\310\336\037\000'
  _globals['_MSGMINTREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGMINTREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGBURNREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGBURNREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGWITHDRAWREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGWITHDRAWREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_MSGTRANSFERREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGTRANSFERREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGIBCTRANSFERREQUEST'].fields_by_name['transfer']._options = None
  _globals['_MSGIBCTRANSFERREQUEST'].fields_by_name['transfer']._serialized_options = b'\310\336\037\000\332\336\037Cgithub.com/cosmos/ibc-go/v6/modules/apps/transfer/types.MsgTransfer'
  _globals['_MSGSETDENOMMETADATAREQUEST'].fields_by_name['metadata']._options = None
  _globals['_MSGSETDENOMMETADATAREQUEST'].fields_by_name['metadata']._serialized_options = b'\310\336\037\000\332\336\0372github.com/cosmos/cosmos-sdk/x/bank/types.Metadata'
  _globals['_MSGADDFINALIZEACTIVATEMARKERREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGADDFINALIZEACTIVATEMARKERREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGADDFINALIZEACTIVATEMARKERREQUEST'].fields_by_name['access_list']._options = None
  _globals['_MSGADDFINALIZEACTIVATEMARKERREQUEST'].fields_by_name['access_list']._serialized_options = b'\310\336\037\000'
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST'].fields_by_name['amount']._options = None
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST'].fields_by_name['amount']._serialized_options = b'\310\336\037\000\332\336\037\'github.com/cosmos/cosmos-sdk/types.Coin'
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST'].fields_by_name['authority']._options = None
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST'].fields_by_name['authority']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST']._options = None
  _globals['_MSGSUPPLYINCREASEPROPOSALREQUEST']._serialized_options = b'\350\240\037\001\202\347\260*\tauthority'
  _globals['_MSGUPDATEREQUIREDATTRIBUTESREQUEST'].fields_by_name['transfer_authority']._options = None
  _globals['_MSGUPDATEREQUIREDATTRIBUTESREQUEST'].fields_by_name['transfer_authority']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_MSGUPDATEREQUIREDATTRIBUTESREQUEST']._options = None
  _globals['_MSGUPDATEREQUIREDATTRIBUTESREQUEST']._serialized_options = b'\350\240\037\001\202\347\260*\022transfer_authority'
  _globals['_MSGUPDATEFORCEDTRANSFERREQUEST'].fields_by_name['authority']._options = None
  _globals['_MSGUPDATEFORCEDTRANSFERREQUEST'].fields_by_name['authority']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_MSGUPDATEFORCEDTRANSFERREQUEST']._options = None
  _globals['_MSGUPDATEFORCEDTRANSFERREQUEST']._serialized_options = b'\350\240\037\001\202\347\260*\tauthority'
  _globals['_MSGSETACCOUNTDATAREQUEST'].fields_by_name['signer']._options = None
  _globals['_MSGSETACCOUNTDATAREQUEST'].fields_by_name['signer']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_MSGSETACCOUNTDATAREQUEST']._options = None
  _globals['_MSGSETACCOUNTDATAREQUEST']._serialized_options = b'\350\240\037\001\202\347\260*\006signer'
