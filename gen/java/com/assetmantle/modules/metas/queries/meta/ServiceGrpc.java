...
@javax.annotation.Generated(
    ...
    comments = "Source: assetmantle/metas/queries/meta/service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ServiceGrpc {

  private ServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "assetmantle.modules.metas.queries.meta.Service";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest,
      com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> getHandleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Handle",
      requestType = com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest.class,
      responseType = com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest,
      com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> getHandleMethod() {
    io.grpc.MethodDescriptor<com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest, com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> getHandleMethod;
    if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getHandleMethod = ServiceGrpc.getHandleMethod) == null) {
          ServiceGrpc.getHandleMethod = getHandleMethod =
              io.grpc.MethodDescriptor.<com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest, com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Handle"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void handle(com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> responseObserver) {
  ...
  public static final class ServiceStub
    ...
    /**
     */
    public void handle(com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest request,
        io.grpc.stub.StreamObserver<com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> responseObserver) {
  ...
  public static final class ServiceBlockingStub
    ...
    /**
     */
    public com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse handle(com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest request) {
  ...
  public static final class ServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse> handle(
        com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HANDLE:
          serviceImpl.handle((com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest) request,
              (io.grpc.stub.StreamObserver<com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.assetmantle.modules.metas.queries.meta.QueryRequestProto.QueryRequest,
              com.assetmantle.modules.metas.queries.meta.QueryResponseProto.QueryResponse>(
  ...
  private static abstract class ServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.assetmantle.modules.metas.queries.meta.ServiceProto.getDescriptor();
    }
