...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MSGSUBMITPROPOSAL'].fields_by_name['pub_proposal']._options = None
  _globals['_MSGSUBMITPROPOSAL'].fields_by_name['pub_proposal']._serialized_options = b'\312\264-\032cosmos.gov.v1beta1.Content'
  _globals['_MSGSUBMITPROPOSAL'].fields_by_name['committee_id']._options = None
  _globals['_MSGSUBMITPROPOSAL'].fields_by_name['committee_id']._serialized_options = b'\342\336\037\013CommitteeID'
  _globals['_MSGSUBMITPROPOSALRESPONSE'].fields_by_name['proposal_id']._options = None
  _globals['_MSGSUBMITPROPOSALRESPONSE'].fields_by_name['proposal_id']._serialized_options = b'\342\336\037\nProposalID'
  _globals['_MSGVOTE'].fields_by_name['proposal_id']._options = None
  _globals['_MSGVOTE'].fields_by_name['proposal_id']._serialized_options = b'\342\336\037\nProposalID'
