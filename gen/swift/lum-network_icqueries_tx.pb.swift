...
struct Lum_Network_Icqueries_MsgSubmitQueryResponse {
...
struct Lum_Network_Icqueries_MsgSubmitQueryResponseResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Lum_Network_Icqueries_MsgSubmitQueryResponse: @unchecked Sendable {}
extension Lum_Network_Icqueries_MsgSubmitQueryResponseResponse: @unchecked Sendable {}
...
extension Lum_Network_Icqueries_MsgSubmitQueryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Lum_Network_Icqueries_MsgSubmitQueryResponse, rhs: Lum_Network_Icqueries_MsgSubmitQueryResponse) -> Bool {
...
extension Lum_Network_Icqueries_MsgSubmitQueryResponseResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Lum_Network_Icqueries_MsgSubmitQueryResponseResponse, rhs: Lum_Network_Icqueries_MsgSubmitQueryResponseResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
