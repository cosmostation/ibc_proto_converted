...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\026com.akash.cert.v1beta3B\tCertProtoP\001Z7github.com/akash-network/akash-api/go/node/cert/v1beta3\242\002\003ACX\252\002\022Akash.Cert.V1beta3\312\002\022Akash\\Cert\\V1beta3\342\002\036Akash\\Cert\\V1beta3\\GPBMetadata\352\002\024Akash::Cert::V1beta3'
  _CERTIFICATEID.fields_by_name['owner']._options = None
  _CERTIFICATEID.fields_by_name['owner']._serialized_options = b'\352\336\037\005owner\362\336\037\014yaml:\"owner\"'
  _CERTIFICATEID.fields_by_name['serial']._options = None
  _CERTIFICATEID.fields_by_name['serial']._serialized_options = b'\352\336\037\006serial\362\336\037\ryaml:\"serial\"'
  _CERTIFICATEID._options = None
  _CERTIFICATEID._serialized_options = b'\230\240\037\000\350\240\037\000'
  _CERTIFICATE_STATE._options = None
  _CERTIFICATE_STATE._serialized_options = b'\210\243\036\000'
  _CERTIFICATE_STATE.values_by_name["invalid"]._options = None
  _CERTIFICATE_STATE.values_by_name["invalid"]._serialized_options = b'\212\235 \027CertificateStateInvalid'
  _CERTIFICATE_STATE.values_by_name["valid"]._options = None
  _CERTIFICATE_STATE.values_by_name["valid"]._serialized_options = b'\212\235 \020CertificateValid'
  _CERTIFICATE_STATE.values_by_name["revoked"]._options = None
  _CERTIFICATE_STATE.values_by_name["revoked"]._serialized_options = b'\212\235 \022CertificateRevoked'
  _CERTIFICATE.fields_by_name['state']._options = None
  _CERTIFICATE.fields_by_name['state']._serialized_options = b'\352\336\037\005state\362\336\037\014yaml:\"state\"'
  _CERTIFICATE.fields_by_name['cert']._options = None
  _CERTIFICATE.fields_by_name['cert']._serialized_options = b'\352\336\037\004cert\362\336\037\013yaml:\"cert\"'
  _CERTIFICATE.fields_by_name['pubkey']._options = None
  _CERTIFICATE.fields_by_name['pubkey']._serialized_options = b'\352\336\037\006pubkey\362\336\037\ryaml:\"pubkey\"'
  _CERTIFICATEFILTER.fields_by_name['owner']._options = None
  _CERTIFICATEFILTER.fields_by_name['owner']._serialized_options = b'\352\336\037\005owner\362\336\037\014yaml:\"owner\"'
  _CERTIFICATEFILTER.fields_by_name['serial']._options = None
  _CERTIFICATEFILTER.fields_by_name['serial']._serialized_options = b'\352\336\037\006serial\362\336\037\ryaml:\"serial\"'
  _CERTIFICATEFILTER.fields_by_name['state']._options = None
  _CERTIFICATEFILTER.fields_by_name['state']._serialized_options = b'\352\336\037\005state\362\336\037\014yaml:\"state\"'
  _CERTIFICATEFILTER._options = None
  _CERTIFICATEFILTER._serialized_options = b'\350\240\037\000'
  _MSGCREATECERTIFICATE.fields_by_name['owner']._options = None
  _MSGCREATECERTIFICATE.fields_by_name['owner']._serialized_options = b'\352\336\037\005owner\362\336\037\014yaml:\"owner\"'
  _MSGCREATECERTIFICATE.fields_by_name['cert']._options = None
  _MSGCREATECERTIFICATE.fields_by_name['cert']._serialized_options = b'\352\336\037\004cert\362\336\037\013yaml:\"cert\"'
  _MSGCREATECERTIFICATE.fields_by_name['pubkey']._options = None
  _MSGCREATECERTIFICATE.fields_by_name['pubkey']._serialized_options = b'\352\336\037\006pubkey\362\336\037\ryaml:\"pubkey\"'
  _MSGCREATECERTIFICATE._options = None
  _MSGCREATECERTIFICATE._serialized_options = b'\350\240\037\000'
  _MSGREVOKECERTIFICATE.fields_by_name['id']._options = None
  _MSGREVOKECERTIFICATE.fields_by_name['id']._serialized_options = b'\310\336\037\000\342\336\037\002ID\352\336\037\002id\362\336\037\tyaml:\"id\"'
  _MSGREVOKECERTIFICATE._options = None
  _MSGREVOKECERTIFICATE._serialized_options = b'\350\240\037\000'
