...
var shentu_gov_v1alpha1_query_pb = require('../../../shentu/gov/v1alpha1/query_pb.js');
var gogoproto_gogo_pb = require('../../../gogoproto/gogo_pb.js');
var google_api_annotations_pb = require('../../../google/api/annotations_pb.js');
var cosmos_gov_v1beta1_gov_pb = require('../../../cosmos/gov/v1beta1/gov_pb.js');
var cosmos_gov_v1beta1_query_pb = require('../../../cosmos/gov/v1beta1/query_pb.js');
var shentu_gov_v1alpha1_gov_pb = require('../../../shentu/gov/v1alpha1/gov_pb.js');
...
function serialize_shentu_gov_v1alpha1_QueryCertVotedRequest(arg) {
  if (!(arg instanceof shentu_gov_v1alpha1_query_pb.QueryCertVotedRequest)) {
    throw new Error('Expected argument of type shentu.gov.v1alpha1.QueryCertVotedRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_shentu_gov_v1alpha1_QueryCertVotedRequest(buffer_arg) {
  return shentu_gov_v1alpha1_query_pb.QueryCertVotedRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shentu_gov_v1alpha1_QueryCertVotedResponse(arg) {
  if (!(arg instanceof shentu_gov_v1alpha1_query_pb.QueryCertVotedResponse)) {
    throw new Error('Expected argument of type shentu.gov.v1alpha1.QueryCertVotedResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_shentu_gov_v1alpha1_QueryCertVotedResponse(buffer_arg) {
  return shentu_gov_v1alpha1_query_pb.QueryCertVotedResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shentu_gov_v1alpha1_QueryParamsResponse(arg) {
  if (!(arg instanceof shentu_gov_v1alpha1_query_pb.QueryParamsResponse)) {
    throw new Error('Expected argument of type shentu.gov.v1alpha1.QueryParamsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_shentu_gov_v1alpha1_QueryParamsResponse(buffer_arg) {
  return shentu_gov_v1alpha1_query_pb.QueryParamsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
params: {
    ...
    responseType: shentu_gov_v1alpha1_query_pb.QueryParamsResponse,
    ...
    responseSerialize: serialize_shentu_gov_v1alpha1_QueryParamsResponse,
    responseDeserialize: deserialize_shentu_gov_v1alpha1_QueryParamsResponse,
  },
...
tallyResult: {
  ...
  // Proposal queries proposal details based on ProposalID.
certVoted: {
    path: '/shentu.gov.v1alpha1.Query/CertVoted',
    requestStream: false,
    responseStream: false,
    requestType: shentu_gov_v1alpha1_query_pb.QueryCertVotedRequest,
    responseType: shentu_gov_v1alpha1_query_pb.QueryCertVotedResponse,
    requestSerialize: serialize_shentu_gov_v1alpha1_QueryCertVotedRequest,
    requestDeserialize: deserialize_shentu_gov_v1alpha1_QueryCertVotedRequest,
    responseSerialize: serialize_shentu_gov_v1alpha1_QueryCertVotedResponse,
    responseDeserialize: deserialize_shentu_gov_v1alpha1_QueryCertVotedResponse,
  },
};
