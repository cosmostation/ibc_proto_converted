...
struct Akash_Base_V1beta3_GPU {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var units: Akash_Base_V1beta3_ResourceValue {
    get {return _units ?? Akash_Base_V1beta3_ResourceValue()}
    set {_units = newValue}
  }
  ...
  fileprivate var _units: Akash_Base_V1beta3_ResourceValue? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Akash_Base_V1beta3_GPU: @unchecked Sendable {}
...
extension Akash_Base_V1beta3_GPU: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GPU"
  ...
  static func ==(lhs: Akash_Base_V1beta3_GPU, rhs: Akash_Base_V1beta3_GPU) -> Bool {
