...
goog.provide('proto.ibc.applications.transfer.v1.GenesisState');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.base.v1beta1.Coin');
goog.require('proto.ibc.applications.transfer.v1.DenomTrace');
goog.require('proto.ibc.applications.transfer.v1.Params');
 ...
 * @const
 */
proto.ibc.applications.transfer.v1.GenesisState.repeatedFields_ = [2,4];
...
proto.ibc.applications.transfer.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.ibc.applications.transfer.v1.DenomTrace.toObject, includeInstance),
    params: (f = msg.getParams()) && proto.ibc.applications.transfer.v1.Params.toObject(includeInstance, f),
    totalEscrowedList: jspb.Message.toObjectList(msg.getTotalEscrowedList(),
...
proto.ibc.applications.transfer.v1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.ibc.applications.transfer.v1.DenomTrace;
      reader.readMessage(value,proto.ibc.applications.transfer.v1.DenomTrace.deserializeBinaryFromReader);
      msg.addDenomTraces(value);
      break;
    case 3:
      var value = new proto.ibc.applications.transfer.v1.Params;
      reader.readMessage(value,proto.ibc.applications.transfer.v1.Params.deserializeBinaryFromReader);
      msg.setParams(value);
      break;
    case 4:
      var value = new proto.cosmos.base.v1beta1.Coin;
      reader.readMessage(value,proto.cosmos.base.v1beta1.Coin.deserializeBinaryFromReader);
      msg.addTotalEscrowed(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.ibc.applications.transfer.v1.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.ibc.applications.transfer.v1.DenomTrace.serializeBinaryToWriter
    );
  }
  f = message.getParams();
  if (f != null) {
...
proto.ibc.applications.transfer.v1.GenesisState.prototype.getDenomTracesList = function() {
  return /** @type{!Array<!proto.ibc.applications.transfer.v1.DenomTrace>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ibc.applications.transfer.v1.DenomTrace, 2));
};
...
proto.ibc.applications.transfer.v1.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.ibc.applications.transfer.v1.Params} */ (
    jspb.Message.getWrapperField(this, proto.ibc.applications.transfer.v1.Params, 3));
};
 ...
 */
proto.ibc.applications.transfer.v1.GenesisState.prototype.getTotalEscrowedList = function() {
 ...
 * @return {!proto.ibc.applications.transfer.v1.GenesisState} returns this
*/
proto.ibc.applications.transfer.v1.GenesisState.prototype.setTotalEscrowedList = function(value) {
 ...
 */
proto.ibc.applications.transfer.v1.GenesisState.prototype.addTotalEscrowed = function(opt_value, opt_index) {
 ...
 * @return {!proto.ibc.applications.transfer.v1.GenesisState} returns this
 */
proto.ibc.applications.transfer.v1.GenesisState.prototype.clearTotalEscrowedList = function() {
  return this.setTotalEscrowedList([]);
};
