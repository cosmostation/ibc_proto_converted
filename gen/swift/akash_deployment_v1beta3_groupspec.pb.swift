...
struct Akash_Deployment_V1beta3_GroupSpec {
  ...
  var requirements: Akash_Base_V1beta3_PlacementRequirements {
    get {return _requirements ?? Akash_Base_V1beta3_PlacementRequirements()}
  ...
  var resources: [Akash_Deployment_V1beta3_Resource] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _requirements: Akash_Base_V1beta3_PlacementRequirements? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Akash_Deployment_V1beta3_GroupSpec: @unchecked Sendable {}
...
extension Akash_Deployment_V1beta3_GroupSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Akash_Deployment_V1beta3_GroupSpec, rhs: Akash_Deployment_V1beta3_GroupSpec) -> Bool {
