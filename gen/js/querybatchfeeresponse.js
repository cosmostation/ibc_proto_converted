...
goog.provide('proto.injective.peggy.v1.QueryBatchFeeResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.peggy.v1.BatchFees');
...
proto.injective.peggy.v1.QueryBatchFeeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.injective.peggy.v1.BatchFees.toObject, includeInstance)
  };
...
proto.injective.peggy.v1.QueryBatchFeeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.injective.peggy.v1.BatchFees;
      reader.readMessage(value,proto.injective.peggy.v1.BatchFees.deserializeBinaryFromReader);
...
proto.injective.peggy.v1.QueryBatchFeeResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.injective.peggy.v1.BatchFees.serializeBinaryToWriter
    );
  }
};
...
proto.injective.peggy.v1.QueryBatchFeeResponse.prototype.getBatchfeesList = function() {
  return /** @type{!Array<!proto.injective.peggy.v1.BatchFees>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.injective.peggy.v1.BatchFees, 1));
};
