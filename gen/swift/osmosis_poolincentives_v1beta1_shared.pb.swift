...
struct Osmosis_Poolincentives_V1beta1_MigrationRecords {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var balancerToConcentratedPoolLinks: [Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink] = []
...
/// This is copied over from the gamm proto file in order to circumnavigate
/// the circular dependency between the two modules.
struct Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Poolincentives_V1beta1_MigrationRecords: @unchecked Sendable {}
extension Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink: @unchecked Sendable {}
...
extension Osmosis_Poolincentives_V1beta1_MigrationRecords: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Osmosis_Poolincentives_V1beta1_MigrationRecords, rhs: Osmosis_Poolincentives_V1beta1_MigrationRecords) -> Bool {
...
extension Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink, rhs: Osmosis_Poolincentives_V1beta1_BalancerToConcentratedPoolLink) -> Bool {
