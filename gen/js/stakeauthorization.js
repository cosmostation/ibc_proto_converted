...
goog.provide('proto.cosmos.staking.v1beta1.StakeAuthorization');
goog.provide('proto.cosmos.staking.v1beta1.StakeAuthorization.Validators');
goog.provide('proto.cosmos.staking.v1beta1.StakeAuthorization.ValidatorsCase');
...
goog.forwardDeclare('proto.cosmos.staking.v1beta1.AuthorizationType');
/**
...
proto.cosmos.staking.v1beta1.StakeAuthorization.toObject = function(includeInstance, msg) {
  var f, obj = {
    maxTokens: (f = msg.getMaxTokens()) && proto.cosmos.base.v1beta1.Coin.toObject(includeInstance, f),
