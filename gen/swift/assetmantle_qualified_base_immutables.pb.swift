...
struct Assetmantle_Schema_Qualified_Base_Immutables {
...
extension Assetmantle_Schema_Qualified_Base_Immutables: @unchecked Sendable {}
...
extension Assetmantle_Schema_Qualified_Base_Immutables: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Immutables"
  ...
  static func ==(lhs: Assetmantle_Schema_Qualified_Base_Immutables, rhs: Assetmantle_Schema_Qualified_Base_Immutables) -> Bool {
