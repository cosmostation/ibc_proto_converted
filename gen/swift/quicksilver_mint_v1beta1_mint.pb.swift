...
struct Quicksilver_Mint_V1beta1_Minter {
...
struct Quicksilver_Mint_V1beta1_DistributionProportions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var participationRewards: String = String()
...
struct Quicksilver_Mint_V1beta1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var distributionProportions: Quicksilver_Mint_V1beta1_DistributionProportions {
    get {return _distributionProportions ?? Quicksilver_Mint_V1beta1_DistributionProportions()}
  ...
  fileprivate var _distributionProportions: Quicksilver_Mint_V1beta1_DistributionProportions? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Quicksilver_Mint_V1beta1_Minter: @unchecked Sendable {}
extension Quicksilver_Mint_V1beta1_DistributionProportions: @unchecked Sendable {}
extension Quicksilver_Mint_V1beta1_Params: @unchecked Sendable {}
...
extension Quicksilver_Mint_V1beta1_Minter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Mint_V1beta1_Minter, rhs: Quicksilver_Mint_V1beta1_Minter) -> Bool {
...
extension Quicksilver_Mint_V1beta1_DistributionProportions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "participation_rewards"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.participationRewards) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.participationRewards.isEmpty {
      try visitor.visitSingularStringField(value: self.participationRewards, fieldNumber: 3)
    }
  ...
  static func ==(lhs: Quicksilver_Mint_V1beta1_DistributionProportions, rhs: Quicksilver_Mint_V1beta1_DistributionProportions) -> Bool {
    if lhs.staking != rhs.staking {return false}
    if lhs.poolIncentives != rhs.poolIncentives {return false}
    if lhs.participationRewards != rhs.participationRewards {return false}
...
extension Quicksilver_Mint_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Quicksilver_Mint_V1beta1_Params, rhs: Quicksilver_Mint_V1beta1_Params) -> Bool {
