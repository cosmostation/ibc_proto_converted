...
struct Lum_Network_Airdrop_GenesisState {
  ...
  var claimRecords: [Lum_Network_Airdrop_ClaimRecord] = []
...
extension Lum_Network_Airdrop_GenesisState: @unchecked Sendable {}
...
extension Lum_Network_Airdrop_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Lum_Network_Airdrop_GenesisState, rhs: Lum_Network_Airdrop_GenesisState) -> Bool {
