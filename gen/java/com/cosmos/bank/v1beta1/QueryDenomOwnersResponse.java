...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.cosmos.bank.v1beta1.QueryProto.internal_static_cosmos_bank_v1beta1_QueryDenomOwnersResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.cosmos.bank.v1beta1.QueryDenomOwnersResponse.class, com.cosmos.bank.v1beta1.QueryDenomOwnersResponse.Builder.class);
  }

  public static final int DENOM_OWNERS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.cosmos.bank.v1beta1.DenomOwner> denomOwners_;
  /**
   * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
   */
  @java.lang.Override
  public java.util.List<com.cosmos.bank.v1beta1.DenomOwner> getDenomOwnersList() {
    return denomOwners_;
  }
  /**
   * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
   */
  @java.lang.Override
  public java.util.List<? extends com.cosmos.bank.v1beta1.DenomOwnerOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.cosmos.bank.v1beta1.DenomOwner getDenomOwners(int index) {
   ...
   */
  @java.lang.Override
  public com.cosmos.bank.v1beta1.DenomOwnerOrBuilder getDenomOwnersOrBuilder(
      int index) {
    return denomOwners_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.cosmos.bank.v1beta1.QueryDenomOwnersResponse)) {
      return super.equals(obj);
    }
    com.cosmos.bank.v1beta1.QueryDenomOwnersResponse other = (com.cosmos.bank.v1beta1.QueryDenomOwnersResponse) obj;
  ...
  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseFrom(
  ...
  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseFrom(
  ...
  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.cosmos.bank.v1beta1.QueryDenomOwnersResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.cosmos.bank.v1beta1.QueryDenomOwnersResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.cosmos.bank.v1beta1.QueryProto.internal_static_cosmos_bank_v1beta1_QueryDenomOwnersResponse_descriptor;
    }
    ...
    // Construct using com.cosmos.bank.v1beta1.QueryDenomOwnersResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.cosmos.bank.v1beta1.QueryDenomOwnersResponse getDefaultInstanceForType() {
      return com.cosmos.bank.v1beta1.QueryDenomOwnersResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.cosmos.bank.v1beta1.QueryDenomOwnersResponse build() {
      com.cosmos.bank.v1beta1.QueryDenomOwnersResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.cosmos.bank.v1beta1.QueryDenomOwnersResponse buildPartial() {
      com.cosmos.bank.v1beta1.QueryDenomOwnersResponse result = new com.cosmos.bank.v1beta1.QueryDenomOwnersResponse(this);
    ...
    private void buildPartialRepeatedFields(com.cosmos.bank.v1beta1.QueryDenomOwnersResponse result) {
      if (denomOwnersBuilder_ == null) {
    ...
    private void buildPartial0(com.cosmos.bank.v1beta1.QueryDenomOwnersResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.cosmos.bank.v1beta1.QueryDenomOwnersResponse) {
        return mergeFrom((com.cosmos.bank.v1beta1.QueryDenomOwnersResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.cosmos.bank.v1beta1.QueryDenomOwnersResponse other) {
      if (other == com.cosmos.bank.v1beta1.QueryDenomOwnersResponse.getDefaultInstance()) return this;
      if (denomOwnersBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.cosmos.bank.v1beta1.DenomOwner m =
                  input.readMessage(
                      com.cosmos.bank.v1beta1.DenomOwner.parser(),
                      extensionRegistry);
              if (denomOwnersBuilder_ == null) {
                ensureDenomOwnersIsMutable();
                denomOwners_.add(m);
    ...
    private void ensureDenomOwnersIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        denomOwners_ = new java.util.ArrayList<com.cosmos.bank.v1beta1.DenomOwner>(denomOwners_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.cosmos.bank.v1beta1.DenomOwner, com.cosmos.bank.v1beta1.DenomOwner.Builder, com.cosmos.bank.v1beta1.DenomOwnerOrBuilder> denomOwnersBuilder_;
    ...
    public Builder setDenomOwners(
        int index, com.cosmos.bank.v1beta1.DenomOwner value) {
      if (denomOwnersBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setDenomOwners(
        int index, com.cosmos.bank.v1beta1.DenomOwner.Builder builderForValue) {
      if (denomOwnersBuilder_ == null) {
        ensureDenomOwnersIsMutable();
     ...
     * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
     */
    public Builder addDenomOwners(com.cosmos.bank.v1beta1.DenomOwner value) {
      if (denomOwnersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addDenomOwners(
        com.cosmos.bank.v1beta1.DenomOwner.Builder builderForValue) {
      if (denomOwnersBuilder_ == null) {
        ensureDenomOwnersIsMutable();
    ...
    public Builder addAllDenomOwners(
        java.lang.Iterable<? extends com.cosmos.bank.v1beta1.DenomOwner> values) {
      if (denomOwnersBuilder_ == null) {
        ensureDenomOwnersIsMutable();
     ...
     * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
     */
    public com.cosmos.bank.v1beta1.DenomOwner.Builder getDenomOwnersBuilder(
        int index) {
     ...
     * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
     */
    public com.cosmos.bank.v1beta1.DenomOwner.Builder addDenomOwnersBuilder() {
      return getDenomOwnersFieldBuilder().addBuilder(
          com.cosmos.bank.v1beta1.DenomOwner.getDefaultInstance());
    }
    /**
     * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
     */
    public com.cosmos.bank.v1beta1.DenomOwner.Builder addDenomOwnersBuilder(
        int index) {
      return getDenomOwnersFieldBuilder().addBuilder(
          index, com.cosmos.bank.v1beta1.DenomOwner.getDefaultInstance());
    }
    /**
     * <code>repeated .cosmos.bank.v1beta1.DenomOwner denom_owners = 1 [json_name = "denomOwners"];</code>
     */
    public java.util.List<com.cosmos.bank.v1beta1.DenomOwner.Builder> 
         getDenomOwnersBuilderList() {
      return getDenomOwnersFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.cosmos.bank.v1beta1.DenomOwner, com.cosmos.bank.v1beta1.DenomOwner.Builder, com.cosmos.bank.v1beta1.DenomOwnerOrBuilder> 
  ...
  private static final com.cosmos.bank.v1beta1.QueryDenomOwnersResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.cosmos.bank.v1beta1.QueryDenomOwnersResponse();
  }

  public static com.cosmos.bank.v1beta1.QueryDenomOwnersResponse getDefaultInstance() {
