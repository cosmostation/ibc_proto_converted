...
public final class MsgCreatorGrpc {
  ...
  public static final String SERVICE_NAME = "osmosis.concentratedliquidity.v1beta1.model.MsgCreator";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool,
      com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> getCreateConcentratedPoolMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateConcentratedPool",
      requestType = com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool.class,
      responseType = com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool,
      com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> getCreateConcentratedPoolMethod() {
    io.grpc.MethodDescriptor<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool, com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> getCreateConcentratedPoolMethod;
      ...
      synchronized (MsgCreatorGrpc.class) {
        if ((getCreateConcentratedPoolMethod = MsgCreatorGrpc.getCreateConcentratedPoolMethod) == null) {
          MsgCreatorGrpc.getCreateConcentratedPoolMethod = getCreateConcentratedPoolMethod =
              io.grpc.MethodDescriptor.<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool, com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateConcentratedPool"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createConcentratedPool(com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool request,
        io.grpc.stub.StreamObserver<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> responseObserver) {
  ...
  public static final class MsgCreatorStub
    ...
    /**
     */
    public void createConcentratedPool(com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool request,
        io.grpc.stub.StreamObserver<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> responseObserver) {
  ...
  public static final class MsgCreatorBlockingStub
    ...
    /**
     */
    public com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse createConcentratedPool(com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool request) {
  ...
  public static final class MsgCreatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse> createConcentratedPool(
        com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_CONCENTRATED_POOL:
          serviceImpl.createConcentratedPool((com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool) request,
              (io.grpc.stub.StreamObserver<com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPool,
              com.osmosis.concentratedliquidity.v1beta1.model.MsgCreateConcentratedPoolResponse>(
