...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PARAMS'].fields_by_name['swappable']._options = None
  _globals['_PARAMS'].fields_by_name['swappable']._serialized_options = b'\362\336\037\020yaml:\"swappable\"'
  _globals['_PARAMS'].fields_by_name['signer']._options = None
  _globals['_PARAMS'].fields_by_name['signer']._serialized_options = b'\362\336\037\ryaml:\"signer\"'
  _globals['_PARAMS'].fields_by_name['limit']._options = None
  _globals['_PARAMS'].fields_by_name['limit']._serialized_options = b'\362\336\037\014yaml:\"limit\"'
