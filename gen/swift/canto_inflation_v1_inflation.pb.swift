...
/// 0.5333333         = 40%           / (1 - 25%)
struct Canto_Inflation_V1_InflationDistribution {
...
struct Canto_Inflation_V1_ExponentialCalculation {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Canto_Inflation_V1_InflationDistribution: @unchecked Sendable {}
extension Canto_Inflation_V1_ExponentialCalculation: @unchecked Sendable {}
...
extension Canto_Inflation_V1_InflationDistribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Canto_Inflation_V1_InflationDistribution, rhs: Canto_Inflation_V1_InflationDistribution) -> Bool {
...
extension Canto_Inflation_V1_ExponentialCalculation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Canto_Inflation_V1_ExponentialCalculation, rhs: Canto_Inflation_V1_ExponentialCalculation) -> Bool {
