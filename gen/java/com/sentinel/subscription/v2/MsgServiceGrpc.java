...
public final class MsgServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgCancelRequest,
      com.sentinel.subscription.v2.MsgCancelResponse> getMsgCancelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgCancel",
      requestType = com.sentinel.subscription.v2.MsgCancelRequest.class,
      responseType = com.sentinel.subscription.v2.MsgCancelResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgCancelRequest,
      com.sentinel.subscription.v2.MsgCancelResponse> getMsgCancelMethod() {
    io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgCancelRequest, com.sentinel.subscription.v2.MsgCancelResponse> getMsgCancelMethod;
      ...
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgCancelMethod = MsgServiceGrpc.getMsgCancelMethod) == null) {
          MsgServiceGrpc.getMsgCancelMethod = getMsgCancelMethod =
              io.grpc.MethodDescriptor.<com.sentinel.subscription.v2.MsgCancelRequest, com.sentinel.subscription.v2.MsgCancelResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgCancel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.subscription.v2.MsgCancelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.subscription.v2.MsgCancelResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgAllocateRequest,
      com.sentinel.subscription.v2.MsgAllocateResponse> getMsgAllocateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MsgAllocate",
      requestType = com.sentinel.subscription.v2.MsgAllocateRequest.class,
      responseType = com.sentinel.subscription.v2.MsgAllocateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgAllocateRequest,
      com.sentinel.subscription.v2.MsgAllocateResponse> getMsgAllocateMethod() {
    io.grpc.MethodDescriptor<com.sentinel.subscription.v2.MsgAllocateRequest, com.sentinel.subscription.v2.MsgAllocateResponse> getMsgAllocateMethod;
    if ((getMsgAllocateMethod = MsgServiceGrpc.getMsgAllocateMethod) == null) {
      synchronized (MsgServiceGrpc.class) {
        if ((getMsgAllocateMethod = MsgServiceGrpc.getMsgAllocateMethod) == null) {
          MsgServiceGrpc.getMsgAllocateMethod = getMsgAllocateMethod =
              io.grpc.MethodDescriptor.<com.sentinel.subscription.v2.MsgAllocateRequest, com.sentinel.subscription.v2.MsgAllocateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MsgAllocate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.subscription.v2.MsgAllocateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sentinel.subscription.v2.MsgAllocateResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void msgCancel(com.sentinel.subscription.v2.MsgCancelRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgCancelResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMsgCancelMethod(), responseObserver);
    }

    /**
     */
    default void msgAllocate(com.sentinel.subscription.v2.MsgAllocateRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgAllocateResponse> responseObserver) {
  ...
  public static final class MsgServiceStub
    ...
    /**
     */
    public void msgCancel(com.sentinel.subscription.v2.MsgCancelRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgCancelResponse> responseObserver) {
    ...
    /**
     */
    public void msgAllocate(com.sentinel.subscription.v2.MsgAllocateRequest request,
        io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgAllocateResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgServiceBlockingStub
    ...
    /**
     */
    public com.sentinel.subscription.v2.MsgCancelResponse msgCancel(com.sentinel.subscription.v2.MsgCancelRequest request) {
    ...
    /**
     */
    public com.sentinel.subscription.v2.MsgAllocateResponse msgAllocate(com.sentinel.subscription.v2.MsgAllocateRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.subscription.v2.MsgCancelResponse> msgCancel(
        com.sentinel.subscription.v2.MsgCancelRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sentinel.subscription.v2.MsgAllocateResponse> msgAllocate(
        com.sentinel.subscription.v2.MsgAllocateRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MSG_CANCEL:
          serviceImpl.msgCancel((com.sentinel.subscription.v2.MsgCancelRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgCancelResponse>) responseObserver);
          break;
        case METHODID_MSG_ALLOCATE:
          serviceImpl.msgAllocate((com.sentinel.subscription.v2.MsgAllocateRequest) request,
              (io.grpc.stub.StreamObserver<com.sentinel.subscription.v2.MsgAllocateResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.subscription.v2.MsgCancelRequest,
              com.sentinel.subscription.v2.MsgCancelResponse>(
                service, METHODID_MSG_CANCEL)))
        .addMethod(
          getMsgAllocateMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.sentinel.subscription.v2.MsgAllocateRequest,
              com.sentinel.subscription.v2.MsgAllocateResponse>(
