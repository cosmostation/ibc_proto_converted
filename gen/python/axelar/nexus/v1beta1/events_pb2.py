...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\030com.axelar.nexus.v1beta1B\013EventsProtoP\001Z2github.com/axelarnetwork/axelar-core/x/nexus/types\242\002\003ANX\252\002\024Axelar.Nexus.V1beta1\312\002\024Axelar\\Nexus\\V1beta1\342\002 Axelar\\Nexus\\V1beta1\\GPBMetadata\352\002\026Axelar::Nexus::V1beta1\310\343\036\001'
  _FEEDEDUCTED.fields_by_name['transfer_id']._options = None
  _FEEDEDUCTED.fields_by_name['transfer_id']._serialized_options = b'\342\336\037\nTransferID\372\336\037@github.com/axelarnetwork/axelar-core/x/nexus/exported.TransferID'
  _FEEDEDUCTED.fields_by_name['recipient_chain']._options = None
  _FEEDEDUCTED.fields_by_name['recipient_chain']._serialized_options = b'\372\336\037?github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName'
  _FEEDEDUCTED.fields_by_name['amount']._options = None
  _FEEDEDUCTED.fields_by_name['amount']._serialized_options = b'\310\336\037\000'
  _FEEDEDUCTED.fields_by_name['fee']._options = None
  _FEEDEDUCTED.fields_by_name['fee']._serialized_options = b'\310\336\037\000'
  _INSUFFICIENTFEE.fields_by_name['transfer_id']._options = None
  _INSUFFICIENTFEE.fields_by_name['transfer_id']._serialized_options = b'\342\336\037\nTransferID\372\336\037@github.com/axelarnetwork/axelar-core/x/nexus/exported.TransferID'
  _INSUFFICIENTFEE.fields_by_name['recipient_chain']._options = None
  _INSUFFICIENTFEE.fields_by_name['recipient_chain']._serialized_options = b'\372\336\037?github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName'
  _INSUFFICIENTFEE.fields_by_name['amount']._options = None
  _INSUFFICIENTFEE.fields_by_name['amount']._serialized_options = b'\310\336\037\000'
  _INSUFFICIENTFEE.fields_by_name['fee']._options = None
  _INSUFFICIENTFEE.fields_by_name['fee']._serialized_options = b'\310\336\037\000'
  _RATELIMITUPDATED.fields_by_name['chain']._options = None
  _RATELIMITUPDATED.fields_by_name['chain']._serialized_options = b'\372\336\037?github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName'
  _RATELIMITUPDATED.fields_by_name['limit']._options = None
  _RATELIMITUPDATED.fields_by_name['limit']._serialized_options = b'\310\336\037\000'
  _RATELIMITUPDATED.fields_by_name['window']._options = None
  _RATELIMITUPDATED.fields_by_name['window']._serialized_options = b'\310\336\037\000\230\337\037\001'
  _MESSAGERECEIVED.fields_by_name['id']._options = None
  _MESSAGERECEIVED.fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
  _MESSAGERECEIVED.fields_by_name['sender']._options = None
  _MESSAGERECEIVED.fields_by_name['sender']._serialized_options = b'\310\336\037\000'
  _MESSAGERECEIVED.fields_by_name['recipient']._options = None
  _MESSAGERECEIVED.fields_by_name['recipient']._serialized_options = b'\310\336\037\000'
  _MESSAGEPROCESSING.fields_by_name['id']._options = None
  _MESSAGEPROCESSING.fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
  _MESSAGEEXECUTED.fields_by_name['id']._options = None
  _MESSAGEEXECUTED.fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
  _MESSAGEFAILED.fields_by_name['id']._options = None
  _MESSAGEFAILED.fields_by_name['id']._serialized_options = b'\342\336\037\002ID'
