...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PARAMS'].fields_by_name['private_plan_creation_fee']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_PARAMS'].fields_by_name['max_block_duration']._options = None
  _globals['_PARAMS'].fields_by_name['max_block_duration']._serialized_options = b'\310\336\037\000\230\337\037\001'
  _globals['_PLAN'].fields_by_name['reward_allocations']._options = None
  _globals['_PLAN'].fields_by_name['reward_allocations']._serialized_options = b'\310\336\037\000'
  _globals['_PLAN'].fields_by_name['start_time']._options = None
  _globals['_PLAN'].fields_by_name['start_time']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_PLAN'].fields_by_name['end_time']._options = None
  _globals['_PLAN'].fields_by_name['end_time']._serialized_options = b'\310\336\037\000\220\337\037\001'
  _globals['_REWARDALLOCATION'].fields_by_name['rewards_per_day']._options = None
  _globals['_REWARDALLOCATION'].fields_by_name['rewards_per_day']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_FARM'].fields_by_name['total_farming_amount']._options = None
  _globals['_FARM'].fields_by_name['total_farming_amount']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int'
  _globals['_FARM'].fields_by_name['current_rewards']._options = None
  _globals['_FARM'].fields_by_name['current_rewards']._serialized_options = b'\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
  _globals['_FARM'].fields_by_name['outstanding_rewards']._options = None
  _globals['_FARM'].fields_by_name['outstanding_rewards']._serialized_options = b'\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
  _globals['_FARM'].fields_by_name['previous_share']._options = None
  _globals['_FARM'].fields_by_name['previous_share']._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _globals['_POSITION'].fields_by_name['farming_amount']._options = None
  _globals['_POSITION'].fields_by_name['farming_amount']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int'
  _globals['_HISTORICALREWARDS'].fields_by_name['cumulative_unit_rewards']._options = None
  _globals['_HISTORICALREWARDS'].fields_by_name['cumulative_unit_rewards']._serialized_options = b'\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
