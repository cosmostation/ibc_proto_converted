...
goog.provide('proto.injective.oracle.v1beta1.QueryModuleStateResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.injective.oracle.v1beta1.GenesisState');
...
proto.injective.oracle.v1beta1.QueryModuleStateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    state: (f = msg.getState()) && proto.injective.oracle.v1beta1.GenesisState.toObject(includeInstance, f)
  };
...
proto.injective.oracle.v1beta1.QueryModuleStateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.injective.oracle.v1beta1.GenesisState;
      reader.readMessage(value,proto.injective.oracle.v1beta1.GenesisState.deserializeBinaryFromReader);
      msg.setState(value);
      break;
    default:
      reader.skipField();
...
proto.injective.oracle.v1beta1.QueryModuleStateResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.injective.oracle.v1beta1.GenesisState.serializeBinaryToWriter
    );
  }
};
...
proto.injective.oracle.v1beta1.QueryModuleStateResponse.prototype.getState = function() {
  return /** @type{?proto.injective.oracle.v1beta1.GenesisState} */ (
    jspb.Message.getWrapperField(this, proto.injective.oracle.v1beta1.GenesisState, 1));
};
