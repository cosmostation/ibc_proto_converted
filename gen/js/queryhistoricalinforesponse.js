...
goog.provide('proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.staking.v1beta1.HistoricalInfo');
goog.require('proto.cosmos.staking.v1beta1.HistoricalRecord');
...
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    hist: (f = msg.getHist()) && proto.cosmos.staking.v1beta1.HistoricalInfo.toObject(includeInstance, f),
    historicalRecord: (f = msg.getHistoricalRecord()) && proto.cosmos.staking.v1beta1.HistoricalRecord.toObject(includeInstance, f)
  };
...
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.staking.v1beta1.HistoricalInfo;
      reader.readMessage(value,proto.cosmos.staking.v1beta1.HistoricalInfo.deserializeBinaryFromReader);
      msg.setHist(value);
      break;
    case 2:
      var value = new proto.cosmos.staking.v1beta1.HistoricalRecord;
      reader.readMessage(value,proto.cosmos.staking.v1beta1.HistoricalRecord.deserializeBinaryFromReader);
      msg.setHistoricalRecord(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.cosmos.staking.v1beta1.HistoricalInfo.serializeBinaryToWriter
    );
  }
  f = message.getHistoricalRecord();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.cosmos.staking.v1beta1.HistoricalRecord.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.prototype.getHist = function() {
  return /** @type{?proto.cosmos.staking.v1beta1.HistoricalInfo} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.staking.v1beta1.HistoricalInfo, 1));
};
...
/**
 * optional HistoricalRecord historical_record = 2;
 * @return {?proto.cosmos.staking.v1beta1.HistoricalRecord}
 */
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.prototype.getHistoricalRecord = function() {
  return /** @type{?proto.cosmos.staking.v1beta1.HistoricalRecord} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.staking.v1beta1.HistoricalRecord, 2));
};


/**
 * @param {?proto.cosmos.staking.v1beta1.HistoricalRecord|undefined} value
 * @return {!proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse} returns this
*/
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.prototype.setHistoricalRecord = function(value) {
 ...
 * @return {!proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse} returns this
 */
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.prototype.clearHistoricalRecord = function() {
  return this.setHistoricalRecord(undefined);
};
 ...
 * @return {boolean}
 */
proto.cosmos.staking.v1beta1.QueryHistoricalInfoResponse.prototype.hasHistoricalRecord = function() {
