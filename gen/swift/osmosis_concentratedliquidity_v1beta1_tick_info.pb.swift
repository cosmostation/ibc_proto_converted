...
struct Osmosis_Concentratedliquidity_V1beta1_TickInfo {
  ...
  var uptimeTrackers: Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers {
    get {return _uptimeTrackers ?? Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers()}
    set {_uptimeTrackers = newValue}
  }
  /// Returns true if `uptimeTrackers` has been explicitly set.
  var hasUptimeTrackers: Bool {return self._uptimeTrackers != nil}
  /// Clears the value of `uptimeTrackers`. Subsequent reads from it will return its default value.
  mutating func clearUptimeTrackers() {self._uptimeTrackers = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _uptimeTrackers: Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers? = nil
}

struct Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var list: [Osmosis_Concentratedliquidity_V1beta1_UptimeTracker] = []
...
extension Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers: @unchecked Sendable {}
...
extension Osmosis_Concentratedliquidity_V1beta1_TickInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._uptimeTrackers) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._uptimeTrackers {
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_TickInfo, rhs: Osmosis_Concentratedliquidity_V1beta1_TickInfo) -> Bool {
    ...
    if lhs._uptimeTrackers != rhs._uptimeTrackers {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UptimeTrackers"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "list"),
  ]
  ...
  static func ==(lhs: Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers, rhs: Osmosis_Concentratedliquidity_V1beta1_UptimeTrackers) -> Bool {
