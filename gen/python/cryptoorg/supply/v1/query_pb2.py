...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SUPPLYRESPONSE'].fields_by_name['supply']._options = None
  _globals['_SUPPLYRESPONSE'].fields_by_name['supply']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_QUERY']._options = None
  _globals['_QUERY']._serialized_options = b'\210\002\001'
  _globals['_QUERY'].methods_by_name['TotalSupply']._options = None
  _globals['_QUERY'].methods_by_name['TotalSupply']._serialized_options = b'\202\323\344\223\002\034\022\032/chainmain/supply/v1/total'
  _globals['_QUERY'].methods_by_name['LiquidSupply']._options = None
  _globals['_QUERY'].methods_by_name['LiquidSupply']._serialized_options = b'\202\323\344\223\002\035\022\033/chainmain/supply/v1/liquid'
