...
public final class QueryServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "stride.interchainquery.v1.QueryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest,
      com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PendingQueries",
      requestType = com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest.class,
      responseType = com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest,
      com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod() {
    io.grpc.MethodDescriptor<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest, com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> getPendingQueriesMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getPendingQueriesMethod = QueryServiceGrpc.getPendingQueriesMethod) == null) {
          QueryServiceGrpc.getPendingQueriesMethod = getPendingQueriesMethod =
              io.grpc.MethodDescriptor.<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest, com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PendingQueries"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void pendingQueries(com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest request,
        io.grpc.stub.StreamObserver<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> responseObserver) {
  ...
  public static final class QueryServiceStub
    ...
    /**
     */
    public void pendingQueries(com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest request,
        io.grpc.stub.StreamObserver<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> responseObserver) {
  ...
  public static final class QueryServiceBlockingStub
    ...
    /**
     */
    public com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse pendingQueries(com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest request) {
  ...
  public static final class QueryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse> pendingQueries(
        com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PENDING_QUERIES:
          serviceImpl.pendingQueries((com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest) request,
              (io.grpc.stub.StreamObserver<com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesRequest,
              com.stride.interchainquery.v1.QueryProto.QueryPendingQueriesResponse>(
