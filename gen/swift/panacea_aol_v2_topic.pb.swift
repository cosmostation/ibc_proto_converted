...
extension Panacea_Aol_V2_Topic: @unchecked Sendable {}
...
extension Panacea_Aol_V2_Topic: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.totalRecords) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.totalWriters) }()
      default: break
      }
    }
  }
