...
struct Assetmantle_Schema_Ids_Base_IdentityID {
...
extension Assetmantle_Schema_Ids_Base_IdentityID: @unchecked Sendable {}
...
extension Assetmantle_Schema_Ids_Base_IdentityID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".IdentityID"
  ...
  static func ==(lhs: Assetmantle_Schema_Ids_Base_IdentityID, rhs: Assetmantle_Schema_Ids_Base_IdentityID) -> Bool {
