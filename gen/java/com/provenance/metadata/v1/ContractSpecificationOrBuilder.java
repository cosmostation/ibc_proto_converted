...
public interface ContractSpecificationOrBuilder extends
   ...
   */
  com.provenance.metadata.v1.Description getDescription();
  /**
   * <pre>
   * Description information for this contract specification
   * </pre>
   ...
   * <code>.provenance.metadata.v1.Description description = 2 [json_name = "description"];</code>
   */
  com.provenance.metadata.v1.DescriptionOrBuilder getDescriptionOrBuilder();
   ...
   */
  java.util.List<com.provenance.metadata.v1.PartyType> getPartiesInvolvedList();
  /**
   * <pre>
   * a list of party roles that must be fullfilled when signing a transaction for this contract specification
   * </pre>
   ...
   */
  com.provenance.metadata.v1.PartyType getPartiesInvolved(int index);
  /**
   * <pre>
   * a list of party roles that must be fullfilled when signing a transaction for this contract specification
   * </pre>
  ...
  com.provenance.metadata.v1.ContractSpecification.SourceCase getSourceCase();
}
