...
struct Shentu_Shield_V1alpha1_QueryDistrParamsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Shentu_Shield_V1alpha1_QueryDistrParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var params: Shentu_Shield_V1alpha1_DistributionParams {
    get {return _params ?? Shentu_Shield_V1alpha1_DistributionParams()}
    set {_params = newValue}
  }
  /// Returns true if `params` has been explicitly set.
  var hasParams: Bool {return self._params != nil}
  ...
  fileprivate var _params: Shentu_Shield_V1alpha1_DistributionParams? = nil
}
...
struct Shentu_Shield_V1alpha1_QueryShieldStatusResponse {
  ...
  var currentServiceFees: [Cosmos_Base_V1beta1_DecCoin] = []
...
extension Shentu_Shield_V1alpha1_QueryPoolRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPoolResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QuerySponsorRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QuerySponsorResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPoolsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPoolsResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPoolPurchaseListsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchaseListsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchaseListsResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchaseListRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchaseListResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchasesRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPurchasesResponse: @unchecked Sendable {}
...
extension Shentu_Shield_V1alpha1_QueryPoolParamsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryPoolParamsResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryClaimParamsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryClaimParamsResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryDistrParamsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryDistrParamsResponse: @unchecked Sendable {}
...
extension Shentu_Shield_V1alpha1_QueryShieldStakingRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryShieldStakingResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryShieldStakingRateRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryShieldStakingRateResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryReimbursementRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryReimbursementResponse: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryReimbursementsRequest: @unchecked Sendable {}
extension Shentu_Shield_V1alpha1_QueryReimbursementsResponse: @unchecked Sendable {}
...
extension Shentu_Shield_V1alpha1_QueryPurchaseListResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._purchaseList {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Shentu_Shield_V1alpha1_QueryDistrParamsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryDistrParamsRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Shentu_Shield_V1alpha1_QueryDistrParamsRequest, rhs: Shentu_Shield_V1alpha1_QueryDistrParamsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Shentu_Shield_V1alpha1_QueryDistrParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryDistrParamsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "params"),
  ]
  ...
  static func ==(lhs: Shentu_Shield_V1alpha1_QueryDistrParamsResponse, rhs: Shentu_Shield_V1alpha1_QueryDistrParamsResponse) -> Bool {
    if lhs._params != rhs._params {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Shentu_Shield_V1alpha1_QueryShieldStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.currentServiceFees) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.remainingServiceFees) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.currentServiceFees.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.currentServiceFees, fieldNumber: 4)
    }
    if !self.remainingServiceFees.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.remainingServiceFees, fieldNumber: 5)
    }
  ...
  static func ==(lhs: Shentu_Shield_V1alpha1_QueryShieldStatusResponse, rhs: Shentu_Shield_V1alpha1_QueryShieldStatusResponse) -> Bool {
    ...
    if lhs.currentServiceFees != rhs.currentServiceFees {return false}
...
extension Shentu_Shield_V1alpha1_QueryShieldStakingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._shieldStaking {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
