...
goog.provide('proto.irismod.htlc.QueryHTLCResponse');
...
proto.irismod.htlc.QueryHTLCResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    htlc: (f = msg.getHtlc()) && proto.irismod.htlc.HTLC.toObject(includeInstance, f)
  };
...
proto.irismod.htlc.QueryHTLCResponse.prototype.getHtlc = function() {
  return /** @type{?proto.irismod.htlc.HTLC} */ (
    jspb.Message.getWrapperField(this, proto.irismod.htlc.HTLC, 1));
};
