...
struct Shentu_Oracle_V1alpha1_TxTask {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Shentu_Oracle_V1alpha1_TaskStatus: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_Withdraw: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_Task: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_Response: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_Operator: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_TaskParams: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_LockedPoolParams: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_TaskID: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_TaskIDs: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_CoinsProto: @unchecked Sendable {}
extension Shentu_Oracle_V1alpha1_TxTask: @unchecked Sendable {}
...
extension Shentu_Oracle_V1alpha1_Task: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .same(proto: "result"),
    10: .standard(proto: "expire_height"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularInt64Field(value: &self.expireHeight) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.expireHeight != 0 {
      try visitor.visitSingularInt64Field(value: self.expireHeight, fieldNumber: 10)
    }
...
extension Shentu_Oracle_V1alpha1_TaskParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "shortcut_quorum"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularBytesField(value: &self.shortcutQuorum) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._expirationDuration {
    ...
    if !self.shortcutQuorum.isEmpty {
      try visitor.visitSingularBytesField(value: self.shortcutQuorum, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_TaskParams, rhs: Shentu_Oracle_V1alpha1_TaskParams) -> Bool {
    ...
    if lhs.shortcutQuorum != rhs.shortcutQuorum {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Shentu_Oracle_V1alpha1_TaskID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.tid) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.tid.isEmpty {
      try visitor.visitSingularBytesField(value: self.tid, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Shentu_Oracle_V1alpha1_TxTask: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TxTask"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._validTime) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._expiration) }()
      case 6: try { try decoder.decodeRepeatedMessageField(value: &self.responses) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.score) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.responses.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.responses, fieldNumber: 6)
    }
    if self.score != 0 {
      try visitor.visitSingularInt64Field(value: self.score, fieldNumber: 7)
    }
    if self.status != .unspecified {
  ...
  static func ==(lhs: Shentu_Oracle_V1alpha1_TxTask, rhs: Shentu_Oracle_V1alpha1_TxTask) -> Bool {
