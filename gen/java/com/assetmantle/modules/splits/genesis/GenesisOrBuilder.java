...
public interface GenesisOrBuilder extends
   ...
   * <code>repeated .assetmantle.modules.splits.mappable.Mappable mappables = 1 [json_name = "mappables"];</code>
   */
  com.assetmantle.modules.splits.mappable.Mappable getMappables(int index);
  /**
   * <code>repeated .assetmantle.modules.splits.mappable.Mappable mappables = 1 [json_name = "mappables"];</code>
   */
   ...
   * <code>repeated .assetmantle.modules.splits.mappable.Mappable mappables = 1 [json_name = "mappables"];</code>
   */
  com.assetmantle.modules.splits.mappable.MappableOrBuilder getMappablesOrBuilder(
      int index);
