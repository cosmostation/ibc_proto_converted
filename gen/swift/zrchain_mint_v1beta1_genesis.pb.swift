...
struct Zrchain_Mint_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// minter is a space for holding current inflation information.
  var minter: Zrchain_Mint_V1beta1_Minter {
    get {return _minter ?? Zrchain_Mint_V1beta1_Minter()}
  ...
  fileprivate var _minter: Zrchain_Mint_V1beta1_Minter? = nil
  fileprivate var _params: Zrchain_Mint_V1beta1_Params? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Zrchain_Mint_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Zrchain_Mint_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Zrchain_Mint_V1beta1_GenesisState, rhs: Zrchain_Mint_V1beta1_GenesisState) -> Bool {
