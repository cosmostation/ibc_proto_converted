...
goog.provide('proto.cosmos.upgrade.v1beta1.QueryModuleVersionsResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.upgrade.v1beta1.ModuleVersion');
...
proto.cosmos.upgrade.v1beta1.QueryModuleVersionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cosmos.upgrade.v1beta1.ModuleVersion.toObject, includeInstance)
  };
...
proto.cosmos.upgrade.v1beta1.QueryModuleVersionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.upgrade.v1beta1.ModuleVersion;
      reader.readMessage(value,proto.cosmos.upgrade.v1beta1.ModuleVersion.deserializeBinaryFromReader);
...
proto.cosmos.upgrade.v1beta1.QueryModuleVersionsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.cosmos.upgrade.v1beta1.ModuleVersion.serializeBinaryToWriter
    );
  }
};
...
proto.cosmos.upgrade.v1beta1.QueryModuleVersionsResponse.prototype.getModuleVersionsList = function() {
  return /** @type{!Array<!proto.cosmos.upgrade.v1beta1.ModuleVersion>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cosmos.upgrade.v1beta1.ModuleVersion, 1));
};
