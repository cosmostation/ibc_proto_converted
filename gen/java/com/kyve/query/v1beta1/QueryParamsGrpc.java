...
public final class QueryParamsGrpc {
  ...
  public static final String SERVICE_NAME = "kyve.query.v1beta1.QueryParams";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.kyve.query.v1beta1.QueryParamsRequest,
      com.kyve.query.v1beta1.QueryParamsResponse> getParamsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Params",
      requestType = com.kyve.query.v1beta1.QueryParamsRequest.class,
      responseType = com.kyve.query.v1beta1.QueryParamsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kyve.query.v1beta1.QueryParamsRequest,
      com.kyve.query.v1beta1.QueryParamsResponse> getParamsMethod() {
    io.grpc.MethodDescriptor<com.kyve.query.v1beta1.QueryParamsRequest, com.kyve.query.v1beta1.QueryParamsResponse> getParamsMethod;
      ...
      synchronized (QueryParamsGrpc.class) {
        if ((getParamsMethod = QueryParamsGrpc.getParamsMethod) == null) {
          QueryParamsGrpc.getParamsMethod = getParamsMethod =
              io.grpc.MethodDescriptor.<com.kyve.query.v1beta1.QueryParamsRequest, com.kyve.query.v1beta1.QueryParamsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Params"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.QueryParamsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kyve.query.v1beta1.QueryParamsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void params(com.kyve.query.v1beta1.QueryParamsRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.QueryParamsResponse> responseObserver) {
  ...
  public static final class QueryParamsStub
     ...
     * </pre>
     */
    public void params(com.kyve.query.v1beta1.QueryParamsRequest request,
        io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.QueryParamsResponse> responseObserver) {
  ...
  public static final class QueryParamsBlockingStub
     ...
     * </pre>
     */
    public com.kyve.query.v1beta1.QueryParamsResponse params(com.kyve.query.v1beta1.QueryParamsRequest request) {
  ...
  public static final class QueryParamsFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kyve.query.v1beta1.QueryParamsResponse> params(
        com.kyve.query.v1beta1.QueryParamsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PARAMS:
          serviceImpl.params((com.kyve.query.v1beta1.QueryParamsRequest) request,
              (io.grpc.stub.StreamObserver<com.kyve.query.v1beta1.QueryParamsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kyve.query.v1beta1.QueryParamsRequest,
              com.kyve.query.v1beta1.QueryParamsResponse>(
  ...
  private static final class QueryParamsMethodDescriptorSupplier
    ...
    QueryParamsMethodDescriptorSupplier(String methodName) {
