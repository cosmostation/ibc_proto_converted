...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MINTER'].fields_by_name['mint_remainder']._options = None
  _globals['_MINTER'].fields_by_name['mint_remainder']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _globals['_MINTER'].fields_by_name['norm_time_passed']._options = None
  _globals['_MINTER'].fields_by_name['norm_time_passed']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _globals['_PARAMS'].fields_by_name['increment_modifier']._options = None
  _globals['_PARAMS'].fields_by_name['increment_modifier']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Int'
