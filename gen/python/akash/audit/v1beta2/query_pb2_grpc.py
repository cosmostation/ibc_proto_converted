...
class Query(object):
    ...
    def ProviderAttributes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/akash.audit.v1beta2.Query/ProviderAttributes',
    ...
    def AuditorAttributes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/akash.audit.v1beta2.Query/AuditorAttributes',
