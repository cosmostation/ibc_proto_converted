...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\034com.bitsong.fantoken.v1beta1B\013EventsProtoZ6github.com/bitsongofficial/go-bitsong/x/fantoken/types\242\002\003BFX\252\002\030Bitsong.Fantoken.V1beta1\312\002\030Bitsong\\Fantoken\\V1beta1\342\002$Bitsong\\Fantoken\\V1beta1\\GPBMetadata\352\002\032Bitsong::Fantoken::V1beta1'
  _globals['_EVENTSETAUTHORITY'].fields_by_name['old_authority']._options = None
  _globals['_EVENTSETAUTHORITY'].fields_by_name['old_authority']._serialized_options = b'\362\336\037\024yaml:\"old_authority\"'
  _globals['_EVENTSETAUTHORITY'].fields_by_name['new_authority']._options = None
  _globals['_EVENTSETAUTHORITY'].fields_by_name['new_authority']._serialized_options = b'\362\336\037\024yaml:\"new_authority\"'
  _globals['_EVENTSETMINTER'].fields_by_name['old_minter']._options = None
  _globals['_EVENTSETMINTER'].fields_by_name['old_minter']._serialized_options = b'\362\336\037\021yaml:\"old_minter\"'
  _globals['_EVENTSETMINTER'].fields_by_name['new_minter']._options = None
  _globals['_EVENTSETMINTER'].fields_by_name['new_minter']._serialized_options = b'\362\336\037\021yaml:\"new_minter\"'
