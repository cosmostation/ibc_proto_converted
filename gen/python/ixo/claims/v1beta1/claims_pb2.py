...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\026com.ixo.claims.v1beta1B\013ClaimsProtoP\001Z6github.com/ixofoundation/ixo-blockchain/x/claims/types\242\002\003ICX\252\002\022Ixo.Claims.V1beta1\312\002\022Ixo\\Claims\\V1beta1\342\002\036Ixo\\Claims\\V1beta1\\GPBMetadata\352\002\024Ixo::Claims::V1beta1'
  _COLLECTIONSTATE.values_by_name["OPEN"]._options = None
  _COLLECTIONSTATE.values_by_name["OPEN"]._serialized_options = b'\212\235 \004open'
  _COLLECTIONSTATE.values_by_name["PAUSED"]._options = None
  _COLLECTIONSTATE.values_by_name["PAUSED"]._serialized_options = b'\212\235 \006paused'
  _COLLECTIONSTATE.values_by_name["CLOSED"]._options = None
  _COLLECTIONSTATE.values_by_name["CLOSED"]._serialized_options = b'\212\235 \006closed'
  _EVALUATIONSTATUS.values_by_name["PENDING"]._options = None
  _EVALUATIONSTATUS.values_by_name["PENDING"]._serialized_options = b'\212\235 \007pending'
  _EVALUATIONSTATUS.values_by_name["APPROVED"]._options = None
  _EVALUATIONSTATUS.values_by_name["APPROVED"]._serialized_options = b'\212\235 \010approved'
  _EVALUATIONSTATUS.values_by_name["REJECTED"]._options = None
  _EVALUATIONSTATUS.values_by_name["REJECTED"]._serialized_options = b'\212\235 \010rejected'
  _EVALUATIONSTATUS.values_by_name["EvaluationStatus_DISPUTED"]._options = None
  _EVALUATIONSTATUS.values_by_name["EvaluationStatus_DISPUTED"]._serialized_options = b'\212\235 \010disputed'
  _PAYMENTTYPE.values_by_name["SUBMISSION"]._options = None
  _PAYMENTTYPE.values_by_name["SUBMISSION"]._serialized_options = b'\212\235 \nsubmission'
  _PAYMENTTYPE.values_by_name["APPROVAL"]._options = None
  _PAYMENTTYPE.values_by_name["APPROVAL"]._serialized_options = b'\212\235 \010approval'
  _PAYMENTTYPE.values_by_name["EVALUATION"]._options = None
  _PAYMENTTYPE.values_by_name["EVALUATION"]._serialized_options = b'\212\235 \nevaluation'
  _PAYMENTTYPE.values_by_name["REJECTION"]._options = None
  _PAYMENTTYPE.values_by_name["REJECTION"]._serialized_options = b'\212\235 \trejection'
  _PAYMENTSTATUS.values_by_name["NO_PAYMENT"]._options = None
  _PAYMENTSTATUS.values_by_name["NO_PAYMENT"]._serialized_options = b'\212\235 \nno_payment'
  _PAYMENTSTATUS.values_by_name["PROMISED"]._options = None
  _PAYMENTSTATUS.values_by_name["PROMISED"]._serialized_options = b'\212\235 \010promised'
  _PAYMENTSTATUS.values_by_name["AUTHORIZED"]._options = None
  _PAYMENTSTATUS.values_by_name["AUTHORIZED"]._serialized_options = b'\212\235 \nauthorized'
  _PAYMENTSTATUS.values_by_name["GAURANTEED"]._options = None
  _PAYMENTSTATUS.values_by_name["GAURANTEED"]._serialized_options = b'\212\235 \ngauranteed'
  _PAYMENTSTATUS.values_by_name["PAID"]._options = None
  _PAYMENTSTATUS.values_by_name["PAID"]._serialized_options = b'\212\235 \004paid'
  _PAYMENTSTATUS.values_by_name["FAILED"]._options = None
  _PAYMENTSTATUS.values_by_name["FAILED"]._serialized_options = b'\212\235 \006failed'
  _PAYMENTSTATUS.values_by_name["PaymentStatus_DISPUTED"]._options = None
  _PAYMENTSTATUS.values_by_name["PaymentStatus_DISPUTED"]._serialized_options = b'\212\235 \010disputed'
  _PARAMS.fields_by_name['network_fee_percentage']._options = None
  _PARAMS.fields_by_name['network_fee_percentage']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _PARAMS.fields_by_name['node_fee_percentage']._options = None
  _PARAMS.fields_by_name['node_fee_percentage']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
  _COLLECTION.fields_by_name['start_date']._options = None
  _COLLECTION.fields_by_name['start_date']._serialized_options = b'\220\337\037\001'
  _COLLECTION.fields_by_name['end_date']._options = None
  _COLLECTION.fields_by_name['end_date']._serialized_options = b'\220\337\037\001'
  _PAYMENT.fields_by_name['amount']._options = None
  _PAYMENT.fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _PAYMENT.fields_by_name['timeout_ns']._options = None
  _PAYMENT.fields_by_name['timeout_ns']._serialized_options = b'\310\336\037\000\230\337\037\001'
  _CONTRACT1155PAYMENT._options = None
  _CONTRACT1155PAYMENT._serialized_options = b'\350\240\037\001'
  _CLAIM.fields_by_name['submission_date']._options = None
  _CLAIM.fields_by_name['submission_date']._serialized_options = b'\220\337\037\001'
  _EVALUATION.fields_by_name['evaluation_date']._options = None
  _EVALUATION.fields_by_name['evaluation_date']._serialized_options = b'\220\337\037\001'
  _EVALUATION.fields_by_name['amount']._options = None
  _EVALUATION.fields_by_name['amount']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
