...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\025com.desmos.reports.v1B\tMsgsProtoP\001Z0github.com/desmos-labs/desmos/v5/x/reports/types\242\002\003DRX\252\002\021Desmos.Reports.V1\312\002\021Desmos\\Reports\\V1\342\002\035Desmos\\Reports\\V1\\GPBMetadata\352\002\023Desmos::Reports::V1'
  _MSGCREATEREPORT.fields_by_name['subspace_id']._options = None
  _MSGCREATEREPORT.fields_by_name['subspace_id']._serialized_options = b'\342\336\037\nSubspaceID\362\336\037\022yaml:\"subspace_id\"'
  _MSGCREATEREPORT.fields_by_name['reasons_ids']._options = None
  _MSGCREATEREPORT.fields_by_name['reasons_ids']._serialized_options = b'\342\336\037\nReasonsIDs\362\336\037\022yaml:\"reasons_ids\"'
  _MSGCREATEREPORT.fields_by_name['message']._options = None
  _MSGCREATEREPORT.fields_by_name['message']._serialized_options = b'\362\336\037\016yaml:\"message\"'
  _MSGCREATEREPORT.fields_by_name['reporter']._options = None
  _MSGCREATEREPORT.fields_by_name['reporter']._serialized_options = b'\362\336\037\017yaml:\"reporter\"'
  _MSGCREATEREPORT.fields_by_name['target']._options = None
  _MSGCREATEREPORT.fields_by_name['target']._serialized_options = b'\362\336\037\ryaml:\"target\"\312\264-\036desmos.reports.v1.ReportTarget'
  _MSGCREATEREPORTRESPONSE.fields_by_name['report_id']._options = None
  _MSGCREATEREPORTRESPONSE.fields_by_name['report_id']._serialized_options = b'\342\336\037\010ReportID\362\336\037\020yaml:\"report_id\"'
  _MSGCREATEREPORTRESPONSE.fields_by_name['creation_date']._options = None
  _MSGCREATEREPORTRESPONSE.fields_by_name['creation_date']._serialized_options = b'\310\336\037\000\362\336\037\024yaml:\"creation_date\"\220\337\037\001'
  _MSGDELETEREPORT.fields_by_name['subspace_id']._options = None
  _MSGDELETEREPORT.fields_by_name['subspace_id']._serialized_options = b'\342\336\037\nSubspaceID\362\336\037\022yaml:\"subspace_id\"'
  _MSGDELETEREPORT.fields_by_name['report_id']._options = None
  _MSGDELETEREPORT.fields_by_name['report_id']._serialized_options = b'\342\336\037\010ReportID\362\336\037\020yaml:\"report_id\"'
  _MSGDELETEREPORT.fields_by_name['signer']._options = None
  _MSGDELETEREPORT.fields_by_name['signer']._serialized_options = b'\362\336\037\ryaml:\"signer\"'
  _MSGSUPPORTSTANDARDREASON.fields_by_name['subspace_id']._options = None
  _MSGSUPPORTSTANDARDREASON.fields_by_name['subspace_id']._serialized_options = b'\342\336\037\nSubspaceID\362\336\037\022yaml:\"subspace_id\"'
  _MSGSUPPORTSTANDARDREASON.fields_by_name['standard_reason_id']._options = None
  _MSGSUPPORTSTANDARDREASON.fields_by_name['standard_reason_id']._serialized_options = b'\342\336\037\020StandardReasonID\362\336\037\031yaml:\"standard_reason_id\"'
  _MSGSUPPORTSTANDARDREASON.fields_by_name['signer']._options = None
  _MSGSUPPORTSTANDARDREASON.fields_by_name['signer']._serialized_options = b'\362\336\037\ryaml:\"signer\"'
  _MSGSUPPORTSTANDARDREASONRESPONSE.fields_by_name['reasons_ids']._options = None
  _MSGSUPPORTSTANDARDREASONRESPONSE.fields_by_name['reasons_ids']._serialized_options = b'\342\336\037\tReasonsID\362\336\037\022yaml:\"reasons_ids\"'
  _MSGADDREASON.fields_by_name['subspace_id']._options = None
  _MSGADDREASON.fields_by_name['subspace_id']._serialized_options = b'\342\336\037\nSubspaceID\362\336\037\022yaml:\"subspace_id\"'
  _MSGADDREASON.fields_by_name['title']._options = None
  _MSGADDREASON.fields_by_name['title']._serialized_options = b'\362\336\037\014yaml:\"title\"'
  _MSGADDREASON.fields_by_name['description']._options = None
  _MSGADDREASON.fields_by_name['description']._serialized_options = b'\362\336\037\022yaml:\"description\"'
  _MSGADDREASON.fields_by_name['signer']._options = None
  _MSGADDREASON.fields_by_name['signer']._serialized_options = b'\362\336\037\ryaml:\"signer\"'
  _MSGADDREASONRESPONSE.fields_by_name['reason_id']._options = None
  _MSGADDREASONRESPONSE.fields_by_name['reason_id']._serialized_options = b'\342\336\037\010ReasonID\362\336\037\020yaml:\"reason_id\"'
  _MSGREMOVEREASON.fields_by_name['subspace_id']._options = None
  _MSGREMOVEREASON.fields_by_name['subspace_id']._serialized_options = b'\342\336\037\nSubspaceID\362\336\037\022yaml:\"subspace_id\"'
  _MSGREMOVEREASON.fields_by_name['reason_id']._options = None
  _MSGREMOVEREASON.fields_by_name['reason_id']._serialized_options = b'\342\336\037\010ReasonID\362\336\037\020yaml:\"reason_id\"'
  _MSGREMOVEREASON.fields_by_name['signer']._options = None
  _MSGREMOVEREASON.fields_by_name['signer']._serialized_options = b'\362\336\037\ryaml:\"signer\"'
