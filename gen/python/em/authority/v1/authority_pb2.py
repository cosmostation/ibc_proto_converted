...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _AUTHORITY.fields_by_name['former_address']._serialized_options = b'\362\336\037\025yaml:\"former_address\"'
  _AUTHORITY.fields_by_name['last_modified']._options = None
  _AUTHORITY.fields_by_name['last_modified']._serialized_options = b'\310\336\037\000\362\336\037\024yaml:\"last_modified\"\220\337\037\001'
  _GASPRICES.fields_by_name['minimum']._options = None
  _GASPRICES.fields_by_name['minimum']._serialized_options = b'\310\336\037\000\362\336\037\016yaml:\"minimum\"\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
