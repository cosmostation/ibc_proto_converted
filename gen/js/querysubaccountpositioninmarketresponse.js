...
goog.provide('proto.injective.exchange.v1beta1.QuerySubaccountPositionInMarketResponse');
...
proto.injective.exchange.v1beta1.QuerySubaccountPositionInMarketResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    state: (f = msg.getState()) && proto.injective.exchange.v1beta1.Position.toObject(includeInstance, f)
  };
