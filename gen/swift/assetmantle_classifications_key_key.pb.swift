...
struct Assetmantle_Modules_Classifications_Key_Key {
...
extension Assetmantle_Modules_Classifications_Key_Key: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "assetmantle.modules.classifications.key"

extension Assetmantle_Modules_Classifications_Key_Key: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Assetmantle_Modules_Classifications_Key_Key, rhs: Assetmantle_Modules_Classifications_Key_Key) -> Bool {
