...
struct Akash_Escrow_V1beta3_AccountID {
...
struct Akash_Escrow_V1beta3_Account {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// unique identifier for this escrow account
  var id: Akash_Escrow_V1beta3_AccountID {
    get {return _id ?? Akash_Escrow_V1beta3_AccountID()}
    set {_id = newValue}
  }
  ...
  var state: Akash_Escrow_V1beta3_Account.State = .invalid

  /// unspent coins received from the owner's wallet
  var balance: Cosmos_Base_V1beta1_DecCoin {
    get {return _balance ?? Cosmos_Base_V1beta1_DecCoin()}
  ...
  var transferred: Cosmos_Base_V1beta1_DecCoin {
    get {return _transferred ?? Cosmos_Base_V1beta1_DecCoin()}
  ...
  var funds: Cosmos_Base_V1beta1_DecCoin {
    get {return _funds ?? Cosmos_Base_V1beta1_DecCoin()}
    set {_funds = newValue}
  }
  /// Returns true if `funds` has been explicitly set.
  var hasFunds: Bool {return self._funds != nil}
  /// Clears the value of `funds`. Subsequent reads from it will return its default value.
  mutating func clearFunds() {self._funds = nil}
  ...
  fileprivate var _id: Akash_Escrow_V1beta3_AccountID? = nil
  fileprivate var _balance: Cosmos_Base_V1beta1_DecCoin? = nil
  fileprivate var _transferred: Cosmos_Base_V1beta1_DecCoin? = nil
  fileprivate var _funds: Cosmos_Base_V1beta1_DecCoin? = nil
}

#if swift(>=4.2)

extension Akash_Escrow_V1beta3_Account.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Akash_Escrow_V1beta3_Account.State] = [
    .invalid,
    .open,
    .closed,
    .overdrawn,
...
struct Akash_Escrow_V1beta3_FractionalPayment {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var accountID: Akash_Escrow_V1beta3_AccountID {
    get {return _accountID ?? Akash_Escrow_V1beta3_AccountID()}
  ...
  var state: Akash_Escrow_V1beta3_FractionalPayment.State = .invalid

  var rate: Cosmos_Base_V1beta1_DecCoin {
    get {return _rate ?? Cosmos_Base_V1beta1_DecCoin()}
    set {_rate = newValue}
  }
  ...
  fileprivate var _accountID: Akash_Escrow_V1beta3_AccountID? = nil
  fileprivate var _rate: Cosmos_Base_V1beta1_DecCoin? = nil
  fileprivate var _balance: Cosmos_Base_V1beta1_DecCoin? = nil
...
extension Akash_Escrow_V1beta3_FractionalPayment.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Akash_Escrow_V1beta3_FractionalPayment.State] = [
    .invalid,
    .open,
    .closed,
    .overdrawn,
...
extension Akash_Escrow_V1beta3_AccountID: @unchecked Sendable {}
extension Akash_Escrow_V1beta3_Account: @unchecked Sendable {}
extension Akash_Escrow_V1beta3_Account.State: @unchecked Sendable {}
extension Akash_Escrow_V1beta3_FractionalPayment: @unchecked Sendable {}
extension Akash_Escrow_V1beta3_FractionalPayment.State: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "akash.escrow.v1beta3"

extension Akash_Escrow_V1beta3_AccountID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.xid) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Akash_Escrow_V1beta3_AccountID, rhs: Akash_Escrow_V1beta3_AccountID) -> Bool {
...
extension Akash_Escrow_V1beta3_Account: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._transferred) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.settledAt) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.depositor) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._funds) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._transferred {
    ...
    if !self.depositor.isEmpty {
      try visitor.visitSingularStringField(value: self.depositor, fieldNumber: 7)
    }
    try { if let v = self._funds {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Akash_Escrow_V1beta3_Account, rhs: Akash_Escrow_V1beta3_Account) -> Bool {
    ...
    if lhs._funds != rhs._funds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Akash_Escrow_V1beta3_Account.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Akash_Escrow_V1beta3_FractionalPayment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FractionalPayment"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularMessageField(value: &self._withdrawn) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Akash_Escrow_V1beta3_FractionalPayment, rhs: Akash_Escrow_V1beta3_FractionalPayment) -> Bool {
...
extension Akash_Escrow_V1beta3_FractionalPayment.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "invalid"),
    1: .same(proto: "open"),
    2: .same(proto: "closed"),
