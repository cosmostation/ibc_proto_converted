...
struct Assetmantle_Schema_Data_Base_AnyListableData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var impl: Assetmantle_Schema_Data_Base_AnyListableData.OneOf_Impl? = nil
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Assetmantle_Schema_Data_Base_AnyListableData.OneOf_Impl, rhs: Assetmantle_Schema_Data_Base_AnyListableData.OneOf_Impl) -> Bool {
...
extension Assetmantle_Schema_Data_Base_AnyListableData: @unchecked Sendable {}
extension Assetmantle_Schema_Data_Base_AnyListableData.OneOf_Impl: @unchecked Sendable {}
...
extension Assetmantle_Schema_Data_Base_AnyListableData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AnyListableData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "number_data"),
    7: .standard(proto: "string_data"),
  ]
  ...
  static func ==(lhs: Assetmantle_Schema_Data_Base_AnyListableData, rhs: Assetmantle_Schema_Data_Base_AnyListableData) -> Bool {
