...
goog.provide('proto.provenance.metadata.v1.MsgWriteP8eContractSpecRequest');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.provenance.metadata.v1.p8e.ContractSpec');
...
proto.provenance.metadata.v1.MsgWriteP8eContractSpecRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    contractspec: (f = msg.getContractspec()) && proto.provenance.metadata.v1.p8e.ContractSpec.toObject(includeInstance, f),
...
proto.provenance.metadata.v1.MsgWriteP8eContractSpecRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.provenance.metadata.v1.p8e.ContractSpec;
      reader.readMessage(value,proto.provenance.metadata.v1.p8e.ContractSpec.deserializeBinaryFromReader);
...
proto.provenance.metadata.v1.MsgWriteP8eContractSpecRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.provenance.metadata.v1.p8e.ContractSpec.serializeBinaryToWriter
    );
  }
...
proto.provenance.metadata.v1.MsgWriteP8eContractSpecRequest.prototype.getContractspec = function() {
  return /** @type{?proto.provenance.metadata.v1.p8e.ContractSpec} */ (
    jspb.Message.getWrapperField(this, proto.provenance.metadata.v1.p8e.ContractSpec, 1));
};
