...
struct Dymensionxyz_Dymension_Sequencer_Description {
...
extension Dymensionxyz_Dymension_Sequencer_Description: @unchecked Sendable {}
...
extension Dymensionxyz_Dymension_Sequencer_Description: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Description"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "moniker"),
    2: .same(proto: "identity"),
    3: .same(proto: "website"),
    4: .same(proto: "securityContact"),
  ...
  static func ==(lhs: Dymensionxyz_Dymension_Sequencer_Description, rhs: Dymensionxyz_Dymension_Sequencer_Description) -> Bool {
