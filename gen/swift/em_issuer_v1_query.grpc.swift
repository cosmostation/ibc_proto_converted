...
extension Em_Issuer_V1_QueryClientProtocol {
  ...
  internal func issuers(
    ...
    return self.makeUnaryCall(
      path: Em_Issuer_V1_QueryClientMetadata.Methods.issuers.path,
      request: request,
...
extension Em_Issuer_V1_QueryClient: @unchecked Sendable {}

@available(*, deprecated, renamed: "Em_Issuer_V1_QueryNIOClient")
internal final class Em_Issuer_V1_QueryClient: Em_Issuer_V1_QueryClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  private var _interceptors: Em_Issuer_V1_QueryClientInterceptorFactoryProtocol?
...
internal struct Em_Issuer_V1_QueryNIOClient: Em_Issuer_V1_QueryClientProtocol {
...
internal protocol Em_Issuer_V1_QueryAsyncClientProtocol: GRPCClient {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Em_Issuer_V1_QueryClientInterceptorFactoryProtocol? { get }

  func makeIssuersCall(
    _ request: Em_Issuer_V1_QueryIssuersRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Em_Issuer_V1_QueryIssuersRequest, Em_Issuer_V1_QueryIssuersResponse>
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Em_Issuer_V1_QueryAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Em_Issuer_V1_QueryClientMetadata.serviceDescriptor
  }
...
extension Em_Issuer_V1_QueryAsyncClientProtocol {
  internal func issuers(
    _ request: Em_Issuer_V1_QueryIssuersRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Em_Issuer_V1_QueryIssuersResponse {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Em_Issuer_V1_QueryAsyncClient: Em_Issuer_V1_QueryAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Em_Issuer_V1_QueryClientInterceptorFactoryProtocol?
...
internal protocol Em_Issuer_V1_QueryClientInterceptorFactoryProtocol: Sendable {
...
internal enum Em_Issuer_V1_QueryClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "em.issuer.v1.Query",
    methods: [
      Em_Issuer_V1_QueryClientMetadata.Methods.issuers,
    ]
  )

  internal enum Methods {
    internal static let issuers = GRPCMethodDescriptor(
      name: "Issuers",
...
extension Em_Issuer_V1_QueryProvider {
  internal var serviceName: Substring {
    return Em_Issuer_V1_QueryServerMetadata.serviceDescriptor.fullName[...]
  }
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Em_Issuer_V1_QueryAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Em_Issuer_V1_QueryServerInterceptorFactoryProtocol? { get }

  @Sendable func issuers(
    request: Em_Issuer_V1_QueryIssuersRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Em_Issuer_V1_QueryIssuersResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Em_Issuer_V1_QueryAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Em_Issuer_V1_QueryServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Em_Issuer_V1_QueryServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "Issuers":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Em_Issuer_V1_QueryIssuersResponse>(),
        interceptors: self.interceptors?.makeIssuersInterceptors() ?? [],
        wrapping: self.issuers(request:context:)
      )
...
internal enum Em_Issuer_V1_QueryServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "em.issuer.v1.Query",
    methods: [
      Em_Issuer_V1_QueryServerMetadata.Methods.issuers,
    ]
  )
