...
struct Provenance_Name_V1_MsgCreateRootNameRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Name_V1_MsgCreateRootNameResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Name_V1_MsgModifyNameRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Provenance_Name_V1_MsgModifyNameResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Provenance_Name_V1_MsgBindNameRequest: @unchecked Sendable {}
extension Provenance_Name_V1_MsgBindNameResponse: @unchecked Sendable {}
extension Provenance_Name_V1_MsgDeleteNameRequest: @unchecked Sendable {}
extension Provenance_Name_V1_MsgDeleteNameResponse: @unchecked Sendable {}
extension Provenance_Name_V1_MsgCreateRootNameRequest: @unchecked Sendable {}
extension Provenance_Name_V1_MsgCreateRootNameResponse: @unchecked Sendable {}
extension Provenance_Name_V1_MsgModifyNameRequest: @unchecked Sendable {}
extension Provenance_Name_V1_MsgModifyNameResponse: @unchecked Sendable {}
...
extension Provenance_Name_V1_MsgCreateRootNameRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgCreateRootNameRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Provenance_Name_V1_MsgCreateRootNameRequest, rhs: Provenance_Name_V1_MsgCreateRootNameRequest) -> Bool {
...
extension Provenance_Name_V1_MsgCreateRootNameResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgCreateRootNameResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Provenance_Name_V1_MsgCreateRootNameResponse, rhs: Provenance_Name_V1_MsgCreateRootNameResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Provenance_Name_V1_MsgModifyNameRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgModifyNameRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "authority"),
    2: .same(proto: "record"),
  ]
  ...
  static func ==(lhs: Provenance_Name_V1_MsgModifyNameRequest, rhs: Provenance_Name_V1_MsgModifyNameRequest) -> Bool {
    if lhs.authority != rhs.authority {return false}
    if lhs._record != rhs._record {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Provenance_Name_V1_MsgModifyNameResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgModifyNameResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Provenance_Name_V1_MsgModifyNameResponse, rhs: Provenance_Name_V1_MsgModifyNameResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
