...
var cosmos_gov_v1beta1_tx_pb = require('../../../cosmos/gov/v1beta1/tx_pb.js');
...
function serialize_cosmos_gov_v1beta1_MsgVoteWeighted(arg) {
  if (!(arg instanceof cosmos_gov_v1beta1_tx_pb.MsgVoteWeighted)) {
    throw new Error('Expected argument of type cosmos.gov.v1beta1.MsgVoteWeighted');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_gov_v1beta1_MsgVoteWeighted(buffer_arg) {
  return cosmos_gov_v1beta1_tx_pb.MsgVoteWeighted.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cosmos_gov_v1beta1_MsgVoteWeightedResponse(arg) {
  if (!(arg instanceof cosmos_gov_v1beta1_tx_pb.MsgVoteWeightedResponse)) {
    throw new Error('Expected argument of type cosmos.gov.v1beta1.MsgVoteWeightedResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cosmos_gov_v1beta1_MsgVoteWeightedResponse(buffer_arg) {
  return cosmos_gov_v1beta1_tx_pb.MsgVoteWeightedResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
voteWeighted: {
    ...
    requestSerialize: serialize_cosmos_gov_v1beta1_MsgVoteWeighted,
    requestDeserialize: deserialize_cosmos_gov_v1beta1_MsgVoteWeighted,
    responseSerialize: serialize_cosmos_gov_v1beta1_MsgVoteWeightedResponse,
    responseDeserialize: deserialize_cosmos_gov_v1beta1_MsgVoteWeightedResponse,
  },
