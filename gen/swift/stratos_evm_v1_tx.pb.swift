...
struct Stratos_Evm_V1_MsgEthereumTx {
...
struct Stratos_Evm_V1_LegacyTx {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_AccessListTx {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var accesses: [Stratos_Evm_V1_AccessTuple] = []
...
struct Stratos_Evm_V1_DynamicFeeTx {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_ExtensionOptionsEthereumTx {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_MsgEthereumTxResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_MsgUpdateParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_MsgUpdateParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_MsgUpdateImplmentationProposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Stratos_Evm_V1_MsgUpdateImplmentationProposalResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Stratos_Evm_V1_MsgEthereumTx: @unchecked Sendable {}
extension Stratos_Evm_V1_LegacyTx: @unchecked Sendable {}
extension Stratos_Evm_V1_AccessListTx: @unchecked Sendable {}
extension Stratos_Evm_V1_DynamicFeeTx: @unchecked Sendable {}
extension Stratos_Evm_V1_ExtensionOptionsEthereumTx: @unchecked Sendable {}
extension Stratos_Evm_V1_MsgEthereumTxResponse: @unchecked Sendable {}
extension Stratos_Evm_V1_MsgUpdateParams: @unchecked Sendable {}
extension Stratos_Evm_V1_MsgUpdateParamsResponse: @unchecked Sendable {}
extension Stratos_Evm_V1_MsgUpdateImplmentationProposal: @unchecked Sendable {}
extension Stratos_Evm_V1_MsgUpdateImplmentationProposalResponse: @unchecked Sendable {}
...
extension Stratos_Evm_V1_MsgEthereumTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgEthereumTx, rhs: Stratos_Evm_V1_MsgEthereumTx) -> Bool {
...
extension Stratos_Evm_V1_LegacyTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_LegacyTx, rhs: Stratos_Evm_V1_LegacyTx) -> Bool {
...
extension Stratos_Evm_V1_AccessListTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_AccessListTx, rhs: Stratos_Evm_V1_AccessListTx) -> Bool {
...
extension Stratos_Evm_V1_DynamicFeeTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_DynamicFeeTx, rhs: Stratos_Evm_V1_DynamicFeeTx) -> Bool {
    if lhs.chainID != rhs.chainID {return false}
    if lhs.nonce != rhs.nonce {return false}
...
extension Stratos_Evm_V1_ExtensionOptionsEthereumTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_ExtensionOptionsEthereumTx, rhs: Stratos_Evm_V1_ExtensionOptionsEthereumTx) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Stratos_Evm_V1_MsgEthereumTxResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgEthereumTxResponse, rhs: Stratos_Evm_V1_MsgEthereumTxResponse) -> Bool {
    if lhs.hash != rhs.hash {return false}
...
extension Stratos_Evm_V1_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgUpdateParams, rhs: Stratos_Evm_V1_MsgUpdateParams) -> Bool {
...
extension Stratos_Evm_V1_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgUpdateParamsResponse, rhs: Stratos_Evm_V1_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Stratos_Evm_V1_MsgUpdateImplmentationProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUpdateImplmentationProposal"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "authority"),
    2: .standard(proto: "proxy_address"),
    3: .standard(proto: "implementation_address"),
    4: .same(proto: "data"),
    5: .same(proto: "value"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.authority) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.proxyAddress) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.implementationAddress) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.proxyAddress.isEmpty {
      try visitor.visitSingularStringField(value: self.proxyAddress, fieldNumber: 2)
    }
    if !self.implementationAddress.isEmpty {
      try visitor.visitSingularStringField(value: self.implementationAddress, fieldNumber: 3)
    }
    if !self.data.isEmpty {
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgUpdateImplmentationProposal, rhs: Stratos_Evm_V1_MsgUpdateImplmentationProposal) -> Bool {
    if lhs.authority != rhs.authority {return false}
...
extension Stratos_Evm_V1_MsgUpdateImplmentationProposalResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MsgUpdateImplmentationProposalResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Stratos_Evm_V1_MsgUpdateImplmentationProposalResponse, rhs: Stratos_Evm_V1_MsgUpdateImplmentationProposalResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
