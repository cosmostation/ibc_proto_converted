...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUERYFEETOKENSRESPONSE'].fields_by_name['fee_tokens']._serialized_options = b'\310\336\037\000\362\336\037\021yaml:\"fee_tokens\"'
  _globals['_QUERYDENOMSPOTPRICEREQUEST'].fields_by_name['denom']._options = None
  _globals['_QUERYDENOMSPOTPRICEREQUEST'].fields_by_name['denom']._serialized_options = b'\362\336\037\014yaml:\"denom\"'
  _globals['_QUERYDENOMSPOTPRICERESPONSE'].fields_by_name['poolID']._options = None
  _globals['_QUERYDENOMSPOTPRICERESPONSE'].fields_by_name['poolID']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_QUERYDENOMSPOTPRICERESPONSE'].fields_by_name['spot_price']._options = None
  _globals['_QUERYDENOMSPOTPRICERESPONSE'].fields_by_name['spot_price']._serialized_options = b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\362\336\037\021yaml:\"spot_price\"'
  _globals['_QUERYDENOMPOOLIDREQUEST'].fields_by_name['denom']._options = None
  _globals['_QUERYDENOMPOOLIDREQUEST'].fields_by_name['denom']._serialized_options = b'\362\336\037\014yaml:\"denom\"'
  _globals['_QUERYDENOMPOOLIDRESPONSE'].fields_by_name['poolID']._options = None
  _globals['_QUERYDENOMPOOLIDRESPONSE'].fields_by_name['poolID']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_QUERYBASEDENOMRESPONSE'].fields_by_name['base_denom']._options = None
  _globals['_QUERYBASEDENOMRESPONSE'].fields_by_name['base_denom']._serialized_options = b'\362\336\037\021yaml:\"base_denom\"'
  _globals['_QUERY'].methods_by_name['FeeTokens']._options = None
  _globals['_QUERY'].methods_by_name['FeeTokens']._serialized_options = b'\202\323\344\223\002$\022\"/osmosis/txfees/v1beta1/fee_tokens'
  _globals['_QUERY'].methods_by_name['DenomSpotPrice']._options = None
  _globals['_QUERY'].methods_by_name['DenomSpotPrice']._serialized_options = b'\202\323\344\223\002-\022+/osmosis/txfees/v1beta1/spot_price_by_denom'
  _globals['_QUERY'].methods_by_name['DenomPoolId']._options = None
  _globals['_QUERY'].methods_by_name['DenomPoolId']._serialized_options = b'\202\323\344\223\002/\022-/osmosis/txfees/v1beta1/denom_pool_id/{denom}'
  _globals['_QUERY'].methods_by_name['BaseDenom']._options = None
  _globals['_QUERY'].methods_by_name['BaseDenom']._serialized_options = b'\202\323\344\223\002$\022\"/osmosis/txfees/v1beta1/base_denom'
